...
{
    class RunGoogleDriveJobByPlan : AbstractApplication
    {
        /// <summary>
        ...
        {
            new RunGoogleDriveJobByPlan().RunAsync().Wait();
        }
        ...
        protected override async Task<string> RunAsync(HttpClient client)
        {
            ...
            var response = await client.PostAsync($"/api/googledrive/plans/{planId}/jobs", content);
