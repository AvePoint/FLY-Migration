...
{
    class GetSlackJob : AbstractApplication
    {
        ...
        {
            var response = await client.GetAsync($"/api/slack/jobs?pageNumber={pageNumber}&pageSize={pageSize}");
