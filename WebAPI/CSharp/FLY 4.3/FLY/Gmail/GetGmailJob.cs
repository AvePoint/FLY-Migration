...
{
    class GetGmailJob : AbstractApplication
    {
        ...
        {
            var response = await client.GetAsync($"/api/gmail/jobs?pageNumber={pageNumber}&pageSize={pageSize}");
