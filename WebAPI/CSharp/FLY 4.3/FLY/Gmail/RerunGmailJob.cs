...
{
    class RerunGmailJob : AbstractApplication
    {
        /// <summary>
        ...
        {
            new RerunGmailJob().RunAsync().Wait();
        }
        ...
        protected override async Task<string> RunAsync(HttpClient client)
        {
            ...
            var model = new GmailJobExecutionModel
            {
            ...
            var response = await client.PostAsync($"/api/gmail/jobs/{jobId}", content);
