...
{
    class FindIMAPPOP3JobByPlan : AbstractApplication
    {
        /// <summary>
        /// <see cref="GetIMAPPOP3Plan"/>
        /// </summary>
        //private readonly string planId = "<plan id>";
        private readonly string planId = "PLAN20190226175236784220";

        static void Main(string[] args)
        {
            new FindIMAPPOP3JobByPlan().RunAsync().Wait();
        }
        ...
        protected override async Task<string> RunAsync(HttpClient client)
        {
            ...
            var response = await client.GetAsync($"/api/imap-pop3/plans/{planId}/jobs");
