...
{
    class RerunMSTeamsJob : AbstractApplication
    {
        /// <summary>
        ...
        {
            new RerunMSTeamsJob().RunAsync().Wait();
        }
        ...
        protected override async Task<string> RunAsync(HttpClient client)
        {
            ...
            var model = new MSTeamsJobExecutionModel
            {
            ...
            var response = await client.PostAsync($"/api/microsoftteams/jobs/{jobId}", content);
