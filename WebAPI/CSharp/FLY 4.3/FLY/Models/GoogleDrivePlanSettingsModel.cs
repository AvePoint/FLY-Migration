...
namespace AvePoint.Migration.Api.Models
{
    ...
    public partial class GoogleDrivePlanSettingsModel
    {
        ...
        public GoogleDrivePlanSettingsModel(PlanNameLabel nameLabel, bool? migrateVersions = default(bool?), string policyId = default(string), string databaseId = default(string), ScheduleModel schedule = default(ScheduleModel), IList<string> planGroups = default(IList<string>))
        {
