...
namespace AvePoint.Migration.Api.Models
{
    ...
    public partial class GmailDistributionGroupMigrationExchangeMailboxModel
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GmailDistributionGroupMigrationExchangeMailboxModel class.
        /// </summary>
        public GmailDistributionGroupMigrationExchangeMailboxModel()
        {
            CustomInit();
        }
        ...
        public GmailDistributionGroupMigrationExchangeMailboxModel(string mailbox, string mailboxType)
        {
            Mailbox = mailbox;
