...
namespace AvePoint.Migration.Api.Models
{
    ...
    public partial class IMAPPOP3JobExecutionModel
    {
        /// <summary>
        /// Initializes a new instance of the IMAPPOP3JobExecutionModel class.
        /// </summary>
        public IMAPPOP3JobExecutionModel()
        {
            CustomInit();
        }
        ...
        public IMAPPOP3JobExecutionModel(string migrationType, System.DateTime? startTime = default(System.DateTime?))
        {
