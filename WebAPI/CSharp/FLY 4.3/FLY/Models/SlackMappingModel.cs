...
namespace AvePoint.Migration.Api.Models
{
    ...
    public partial class SlackMappingModel
    {
        /// <summary>
        /// Initializes a new instance of the SlackMappingModel class.
        /// </summary>
        public SlackMappingModel()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the SlackMappingModel class.
        /// </summary>
        public SlackMappingModel(string sourceConnectionId, string destinationConnectionId, IList<SlackMappingContentModel> contents)
        {
        ...
        public IList<SlackMappingContentModel> Contents { get; set; }
