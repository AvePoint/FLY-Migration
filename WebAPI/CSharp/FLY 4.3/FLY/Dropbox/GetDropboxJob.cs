...
namespace AvePoint.Migration.Samples
{
    ...
    /// </summary>
    class GetDropboxJob : AbstractApplication
    {
        ...
        {
            new GetDropboxJob().RunAsync().Wait();
        }
        ...
        {
            var response = await client.GetAsync($"/api/dropbox/jobs?pageNumber={pageNumber}&pageSize={pageSize}");
