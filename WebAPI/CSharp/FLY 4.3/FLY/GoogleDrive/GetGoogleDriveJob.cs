...
{
    class GetGoogleDriveJob : AbstractApplication
    {
        ...
        {
            new GetGoogleDriveJob().RunAsync().Wait();
        }
        ...
        {
            var response = await client.GetAsync($"/api/googledrive/jobs?pageNumber={pageNumber}&pageSize={pageSize}");
