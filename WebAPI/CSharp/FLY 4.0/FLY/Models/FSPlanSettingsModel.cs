...
namespace AvePoint.Migration.Api.Models
{
    ...
    public partial class FSPlanSettingsModel
    {
        ...
        public FSPlanSettingsModel(PlanNameLabel nameLabel, string policyId = default(string), string databaseId = default(string), string migrationMode = default(string), ScheduleModel schedule = default(ScheduleModel))
        {
            NameLabel = nameLabel;
            PolicyId = policyId;
