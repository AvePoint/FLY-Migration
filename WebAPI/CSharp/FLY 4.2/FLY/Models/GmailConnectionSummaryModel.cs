...
namespace AvePoint.Migration.Api.Models
{
    ...
    public partial class GmailConnectionSummaryModel
    {
        /// <summary>
        /// Initializes a new instance of the GmailConnectionSummaryModel
        /// class.
        /// </summary>
        public GmailConnectionSummaryModel()
        {
            CustomInit();
        }
        ...
        public GmailConnectionSummaryModel(string domainName = default(string), string account = default(string), string id = default(string), string status = default(string))
        {
