...
namespace AvePoint.Migration.Api.Models
{
    ...
    public partial class FSPlanSettingsModel
    {
        ...
        public FSPlanSettingsModel(PlanNameLabel nameLabel, string migrationMode = default(string), string policyId = default(string), string databaseId = default(string), ScheduleModel schedule = default(ScheduleModel))
        {
