...
{
    class GetIMAPPOP3Job : AbstractApplication
    {
        ...
        {
            new GetIMAPPOP3Job().RunAsync().Wait();
        }
        ...
        {
            var response = await client.GetAsync($"/api/imap-pop3/jobs?pageNumber={pageNumber}&pageSize={pageSize}");
