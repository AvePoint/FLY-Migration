...
{
    class FindOffice365GroupJobByPlan : AbstractApplication
    {
        /// <summary>
        ...
        {
            new FindOffice365GroupJobByPlan().RunAsync().Wait();
        }
        ...
        protected override async Task<string> RunAsync(HttpClient client)
        {
            ...
            var response = await client.GetAsync($"/api/office365group/plans/{planId}/jobs");
