...
{
    class FindMSTeamsJobByPlan : AbstractApplication
    {
        /// <summary>
        ...
        {
            new FindMSTeamsJobByPlan().RunAsync().Wait();
        }
        ...
        protected override async Task<string> RunAsync(HttpClient client)
        {
            ...
            var response = await client.GetAsync($"/api/microsoftteams/plans/{planId}/jobs");
