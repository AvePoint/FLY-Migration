...
{
    class RunMSTeamsJobByPlan : AbstractApplication
    {
        /// <summary>
        ...
        {
            new RunMSTeamsJobByPlan().RunAsync().Wait();
        }
        ...
        protected override async Task<string> RunAsync(HttpClient client)
        {
            ...
            var model = new MSTeamsPlanExecutionModel
            {
            ...
            var response = await client.PostAsync($"/api/microsoftteams/plans/{planId}/jobs", content);
