...
{
    class RunOffice365GroupJobByPlan : AbstractApplication
    {
        /// <summary>
        ...
        {
            new RunOffice365GroupJobByPlan().RunAsync().Wait();
        }
        ...
        protected override async Task<string> RunAsync(HttpClient client)
        {
            ...
            var model = new Office365GroupJobExecutionModel
            {
            ...
            var response = await client.PostAsync($"/api/office365group/plans/{planId}/jobs", content);
