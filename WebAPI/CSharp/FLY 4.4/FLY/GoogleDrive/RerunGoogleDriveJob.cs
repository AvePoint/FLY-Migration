...
{
    class RerunGoogleDriveJob : AbstractApplication
    {
        /// <summary>
        ...
        {
            new RerunGoogleDriveJob().RunAsync().Wait();
        }
        ...
        protected override async Task<string> RunAsync(HttpClient client)
        {
            ...
            var response = await client.PostAsync($"/api/googledrive/jobs/{jobId}", content);
