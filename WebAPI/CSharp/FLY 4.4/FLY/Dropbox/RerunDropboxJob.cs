...
namespace AvePoint.Migration.Samples
{
    ...
    /// </summary>
    class RerunDropboxJob : AbstractApplication
    {
        /// <summary>
        ...
        {
            new RerunDropboxJob().RunAsync().Wait();
        }
        ...
        protected override async Task<string> RunAsync(HttpClient client)
        {
            ...
            var model = new DropboxJobExecutionModel
            {
            ...
            var response = await client.PostAsync($"/api/dropbox/jobs/{jobId}", content);
