...
namespace AvePoint.Migration.Api.Models
{
    ...
    public partial class Office365GroupPlanSettingsModel
    {
        ...
        public Office365GroupPlanSettingsModel(PlanNameLabel nameLabel, bool? onlyMigrateDocumentsLibrary = default(bool?), string policyId = default(string), string databaseId = default(string), ScheduleModel schedule = default(ScheduleModel), IList<string> planGroups = default(IList<string>))
        {
