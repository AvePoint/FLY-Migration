...
namespace AvePoint.Migration.Api.Models
{
    ...
    public partial class ExchangeDistributionGroupPlanSettingsModel
    {
        ...
        public ExchangeDistributionGroupPlanSettingsModel(PlanNameLabel nameLabel, string policyId = default(string), string databaseId = default(string), ScheduleModel schedule = default(ScheduleModel), IList<string> planGroups = default(IList<string>))
        {
            NameLabel = nameLabel;
            PolicyId = policyId;
