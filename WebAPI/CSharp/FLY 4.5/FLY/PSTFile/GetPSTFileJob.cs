...
{
    class GetPSTFileJob : AbstractApplication
    {
        ...
        {
            new GetPSTFileJob().RunAsync().Wait();
        }
        ...
        {
            var response = await client.GetAsync($"/api/pstfiles/jobs?pageNumber={pageNumber}&pageSize={pageSize}");
