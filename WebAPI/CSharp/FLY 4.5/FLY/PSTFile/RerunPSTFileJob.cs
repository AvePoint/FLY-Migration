...
{
    class RerunPSTFileJob : AbstractApplication
    {
        /// <summary>
        ...
        {
            new RerunPSTFileJob().RunAsync().Wait();
        }
        ...
        protected override async Task<string> RunAsync(HttpClient client)
        {
            ...
            var model = new PSTFileJobExecutionModel
            {
            ...
            var response = await client.PostAsync($"/api/pstfiles/jobs/{jobId}", content);
