...
{
    class RunPSTFileJobByPlan : AbstractApplication
    {
        /// <summary>
        ...
        {
            new RunPSTFileJobByPlan().RunAsync().Wait();
        }
        ...
        protected override async Task<string> RunAsync(HttpClient client)
        {
            ...
            var response = await client.PostAsync($"/api/pstfiles/plans/{planId}/jobs", content);
