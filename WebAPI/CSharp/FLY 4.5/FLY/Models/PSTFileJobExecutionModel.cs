...
namespace AvePoint.Migration.Api.Models
{
    ...
    public partial class PSTFileJobExecutionModel
    {
        /// <summary>
        /// Initializes a new instance of the PSTFileJobExecutionModel class.
        /// </summary>
        public PSTFileJobExecutionModel()
        {
            CustomInit();
        }
        ...
        public PSTFileJobExecutionModel(string migrationType, System.DateTime? startTime = default(System.DateTime?))
        {
