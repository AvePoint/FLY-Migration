...
namespace AvePoint.Migration.Api.Models
{
    ...
    public partial class SlackPlanSettingsModel
    {
        /// <summary>
        /// Initializes a new instance of the SlackPlanSettingsModel class.
        /// </summary>
        public SlackPlanSettingsModel()
        {
            CustomInit();
        }
        ...
        public SlackPlanSettingsModel(string conversationMessageStyle, PlanNameLabel nameLabel, string policyId = default(string), string databaseId = default(string), SimpleSchedule schedule = default(SimpleSchedule), IList<string> planGroups = default(IList<string>))
        {
        ...
        /// 'HTMLFileAndMessages'
        /// </summary>
        [JsonProperty(PropertyName = "conversationMessageStyle")]
        public string ConversationMessageStyle { get; set; }
        ...
        {
            if (ConversationMessageStyle == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "ConversationMessageStyle");
            }
            if (NameLabel == null)
            {
