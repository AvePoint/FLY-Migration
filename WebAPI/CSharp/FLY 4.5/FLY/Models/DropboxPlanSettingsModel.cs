...
namespace AvePoint.Migration.Api.Models
{
    ...
    public partial class DropboxPlanSettingsModel
    {
        /// <summary>
        /// Initializes a new instance of the DropboxPlanSettingsModel class.
        /// </summary>
        public DropboxPlanSettingsModel()
        {
            CustomInit();
        }
        ...
        public DropboxPlanSettingsModel(PlanNameLabel nameLabel, bool? migrateVersions = default(bool?), string policyId = default(string), string databaseId = default(string), SimpleSchedule schedule = default(SimpleSchedule), IList<string> planGroups = default(IList<string>))
        {
        ...
        /// <summary>
        /// Gets or sets whether to migrate versions of source file in Dropbox
        /// </summary>
