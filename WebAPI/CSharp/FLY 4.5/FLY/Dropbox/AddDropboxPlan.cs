...
namespace AvePoint.Migration.Samples
{
    ...
    /// </summary>
    class AddDropboxPlan : AbstractApplication
    {
        static void Main(string[] args)
        {
            new AddDropboxPlan().RunAsync().Wait();
        }
        ...
        /// <summary>
        /// <see cref="GetDropboxConnection"/>
        /// </summary>
        private readonly string sourceConnectionId = "<dropbox connection id>";
        /// <summary>
        /// <see cref="GetDropboxMigrationPolicy"/>
        /// </summary>
        ...
        protected override async Task<string> RunAsync(HttpClient client)
        {
            ...
            var mappingContent = new DropboxMappingContent
            {
                Source = new DropboxObject
                {
                    Path = "<path>",
                    Level = "Folder"
                },
                Destination = new DropboxMigrationSharePointObject
                {
            ...
            var mappings = new DropboxPlanMappingModel
            {
                SourceConnectionId = sourceConnectionId,
                DestinationCredential = destinationCredential,
                Contents = new List<DropboxMappingContent>
                {
                    mappingContent
                },
            };

            var planSettings = new DropboxPlanSettingsModel
            {
            ...
            var response = await client.PostAsync("/api/dropbox/plans", content);
