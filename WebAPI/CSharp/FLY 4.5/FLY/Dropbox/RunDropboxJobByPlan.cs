...
namespace AvePoint.Migration.Samples
{
    ...
    /// </summary>
    class RunDropboxJobByPlan : AbstractApplication
    {
        /// <summary>
        ...
        {
            new RunDropboxJobByPlan().RunAsync().Wait();
        }
        ...
        protected override async Task<string> RunAsync(HttpClient client)
        {
            ...
            var response = await client.PostAsync($"/api/box/plans/{planId}/jobs", content);
