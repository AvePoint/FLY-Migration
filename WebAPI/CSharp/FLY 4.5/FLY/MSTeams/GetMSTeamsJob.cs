...
{
    class GetMSTeamsJob : AbstractApplication
    {
        ...
        {
            new GetMSTeamsJob().RunAsync().Wait();
        }
        ...
        {
            var response = await client.GetAsync($"/api/microsoftteams/jobs?pageNumber={pageNumber}&pageSize={pageSize}");
