...
{
    class RerunOffice365GroupJob : AbstractApplication
    {
        /// <summary>
        ...
        {
            new RerunOffice365GroupJob().RunAsync().Wait();
        }
        ...
        protected override async Task<string> RunAsync(HttpClient client)
        {
            ...
            var response = await client.PostAsync($"/api/office365group/jobs/{jobId}", content);
