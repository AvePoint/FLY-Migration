...
{
    class FindGoogleDriveJobByPlan : AbstractApplication
    {
        /// <summary>
        ...
        {
            new FindGoogleDriveJobByPlan().RunAsync().Wait();
        }
        ...
        protected override async Task<string> RunAsync(HttpClient client)
        {
            ...
            var response = await client.GetAsync($"/api/googledrive/plans/{planId}/jobs");
