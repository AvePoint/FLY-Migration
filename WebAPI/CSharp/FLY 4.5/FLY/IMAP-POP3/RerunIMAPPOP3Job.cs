...
{
    class RerunIMAPPOP3Job : AbstractApplication
    {
        /// <summary>
        ...
        {
            new RerunIMAPPOP3Job().RunAsync().Wait();
        }
        ...
        protected override async Task<string> RunAsync(HttpClient client)
        {
            ...
            var model = new IMAPPOP3JobExecutionModel
            {
            ...
            var response = await client.PostAsync($"/api/imap-pop3/jobs/{jobId}", content);
