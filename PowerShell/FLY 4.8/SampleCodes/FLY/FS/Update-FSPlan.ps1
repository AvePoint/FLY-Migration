...
try
{
    ...
    # For example:
    # To keep the original 'Migration Mode' setting, delete the '-MigrationMode CSOM' parameter from the New-UpdateFSPlanObject cmdlet.
    $data = New-UpdateFSPlanObject -DisplayName $PlanName  -NewName $NewName -Policy $Policy -PlanGroups $PlanGroup -DisablePlanGroup:$DisablePlanGroup  -Schedule $Schedule -DisableSchedule:$DisableSchedule  -DatabaseId $Database  -DisableMigrationDatabase:$DisableMigrationDatabase  -MigrationMode CSOM
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUv7pRG9+stspIDPZk4QW+/WFh
# 6sKgghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFB27+YBxw0+DKYv3Sgs2EBULFoEIMA0GCSqGSIb3DQEBAQUABIIBALsy
# gLP9AXGm6WeMYE2SwjtApEeooSD9imLgRijVrIEfiD8xIP0tJZ7cLHhwcLwNnf5m
# fFpIMmMIgLkEQI1sVTvu8wyN2T6BCagrrU4BA6XcCISk+UDLv/FB1+J3SNPUqkvO
# okhiTAFkwrKhZuCWEtozwi6b9W5qCbQQr55lN5pAkkQ7385iCV71fJL4huPzP+hz
# GzMmoDeRd9SAyfkOaTJhZwNjvOFDMQv5N0uXCjpc7NpH3UIC2tFFNmSRH9fx6Bzn
# xewR4mJMdOUdTRdlHN2Xz6wRHSpWw63rFMiVZ0D9eSDgTwQVe1n9Dfa29+CkQDZ9
# 8eX/Q0icv5FmjQeG4rOhggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMTEyMzA5MTU1N1owLwYJKoZIhvcNAQkEMSIEIFbFkKGYZfEVha9sNDPdhVMO
# 51Ho/GXWkMmkiGRKWBswMA0GCSqGSIb3DQEBAQUABIIBACn6VGX1GwXg8HRIc0oe
# rfYKyRoEOPOAP832Rl2BmsPEcqeFbU0J8YsZbdu0N98vdOhw+XCElXXzZJaUswd0
# V+QDAhbwoC75dqosvoAvNYistmQxjIxMvG6lhcqMf3xcSOKW5vSKyMhKRCHx6Et7
# XsLDgM6djykMVZ3m2QvWQIv0rntloDJp1jS/n1rm4figpRAkAkzvMxUWDuA+ne2J
# +AL8n5nTFj3p67VtO73N3XYXnBjlghVIB0taL3OMztFshoEN5O93PVEe1ZtNjzX2
# 6O08wU2TVvIlRpNDucde4ZXgKSXwRoW5T507/T1qkA+lYJ2s6U1/utMrdXSy++zQ
# Jyk=
