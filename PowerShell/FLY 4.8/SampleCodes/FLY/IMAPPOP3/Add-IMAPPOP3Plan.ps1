...
try
{
    ...
    # For example: $SourceConnection = New-IMAPPOP3ConnectionObject -Type Gmail/Outlook/Yahoo/Other -ServerName 'service name' -Port 993 -EnableSSL 
    $SourceConnection = New-IMAPPOP3ConnectionObject -Type Outlook -ServerName '' -Port 993 -EnableSSL 
    ...
    # For example: 
    # $SourceMapping1 = New-IMAPPOP3MailBoxObject -Mailbox 'outlook mailbox 1' -Password 'password'
    # $SourceMapping2 = New-IMAPPOP3MailBoxObject -Mailbox 'outlook mailbox 2' -Password 'password'
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUEKFvmV7oyY4ddFPuU2+Ai6mY
# WR2gghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFNapgjYUA2UK0F1jxXP/HjiGuuDcMA0GCSqGSIb3DQEBAQUABIIBAAdp
# X9GniPxKybUmoPtQtR3zDdcg1M40zMlnhbJ1fP49WMq8nuJcp9QPqF+t40k/+K1R
# OrXa+9oVshi1T84uB2aRy6qcpjGmz8S8L2Hlg4aTDZ7Et7n3yo8Q+cXF5Ur9x2w/
# U85KILvG8ybCcZwWtSsrMDJKe2ece8969JDlGhLQ4IjYe0eD3RbWLHU6GN7vEw9M
# D7Q8vV6SFB9KEDRqo18NtHx4V8icPy+tZWEuqZzBaVI+McdPzo+mpkXz0V0fRqIM
# B90xm+2IHEysorhOdkuwL3ROqzQqaC0PXKQwngLRJINJ4GYqX0JRFb2YnLzDqW1G
# 4+V5xPkLkDC0vBrNQrqhggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMTEyMzA5MTYwOVowLwYJKoZIhvcNAQkEMSIEIAvffMLLm72dm1cqef+wA/uK
# Wh00q045Vih2mEpdO0urMA0GCSqGSIb3DQEBAQUABIIBALcE8A+MkW0OuUZAfjn9
# a2TTGQdyzAnKAzB+S6dAe8pooa3U0qcPY9XKUJ9ORoYwbW4TLercLUkblcWh2j3v
# FcwhjD577Ec3SdX4uFwzrKxhbU1mDaiLNK9+t7h/yNKznbGdiA/fzuiJ/5lJSgnl
# wzMw6h3tShgysqx20USwsEVROutvjtl4AZuyLMmWJYT1p+sfD6EAlM4aSDfljfWu
# W+1Clmt9jL5x/wNZDQ6ub0McSvkuKl+rEL8Hfp7iIw2Vg10kdIeJeohl3YxpvS3L
# 240DadDFZ1iWYTxBNAd6Vndz5SiGhV/gtpgPLptbB7Va1IFWy2/ZCc/+3dvaL6nX
# hvo=
