...
try
{
    ...
    # For example: $Settings = New-ExchangePlanExecutionObject -MigrationType DisableForwarding/EnableForward/FailedObjectsOnly/ForwardAndCopy/Full/Incremental
    $Settings = New-ExchangePlanExecutionObject -MigrationType Incremental

    $Response = Start-ExchangeJobByPlan -BaseUri $BaseUri -APIKey $ApiKey -Id $PlanId -Settings $Settings -Type Online
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUTQZ0rG+TGJshUdRE3trKPLxe
# F/WgghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFJpl6+udQpg1e93eE/hrRRMuI2onMA0GCSqGSIb3DQEBAQUABIIBAM4q
# csL9tjZtOdyKzeZvx0TK1Vt8LjzpIwMVZjLsWW/idRLFgLDKsm/sjTkTRoISrNCk
# BVKeMtsZVakzemzRbWTa0jm82ma/tYX3gv/Avn0FeYT+JwBix9sUmupcVGEkFOfF
# PNk8CpDl79a0QFtLOKA2toX2eXWFLpoeNdjTNH/o8qAdI8t5fAYxgHl2FaDdGsIg
# 3CNXjFj5tagiWMQL/CmrvCI46WQ4Me0Enr3EKNKros+zPjWBF1NFan0rR8HMfnid
# FEHji6G3EHDucUTwXLzErm+y5O8/HxGjgxCZqUTlMCWU3qbvggoZY4aDBu/er4Bu
# 1V5+Bm2Zkbhf+NsTBfWhggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMTEyMzA5MTU1MVowLwYJKoZIhvcNAQkEMSIEIGwSsnbMyVUTO4DfXC8KZLA9
# hEpGIsU+VN1qpaHzjb5mMA0GCSqGSIb3DQEBAQUABIIBACf7LRXBhI0Dp4kLHAsi
# VNMqxf3A310nCGqxb445FBO+8TxRScJkrmlbUKFiSNvmwIfs2vhr2tCeu+yjV2lX
# Hv12JThPIAHi5uoZq7c8vWkjljVGTCaQUu2DGPvliTrMe9rlP9cYzorTPRBNCbU6
# egHIZMCbSA5i45K6qBMzOpuRtnpJSOZGVZgQEV6ZxT11Yz6YDgQbSmb98mrSp1nm
# Fq8zykSVetgEF/lCT77e0pttJdBedYc0VRFGNCMuDzEf+71VhCU7Xzv/v5FPWtjb
# BJbH7qNi2Dhf3BEOUG4U/uNEeJv4Myf7FYVmjUbd4TdxDSkWgGJvjF+ayTn7NYoW
# 8B4=
