...
Try{
    ...
    # For example: 
    # $ChannelMapping1 = New-ChannelMappingObject  -SourceChannel 'Channel1' -DestinationChannel 'Channel01'
    # $ChannelMapping2 = New-ChannelMappingObject  -SourceChannel 'Channel2' -DestinationChannel 'Channel02'
    $ChannelMapping1 = New-ChannelMappingObject  -SourceChannel '' -DestinationChannel ''
	$ChannelMapping2 = New-ChannelMappingObject  -SourceChannel '' -DestinationChannel ''
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUekoZFpkx/VyL9o7IQKCPDrd/
# 9MigghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFG8FQYdhwx1NzXBidXY9erOejMzsMA0GCSqGSIb3DQEBAQUABIIBAL/h
# kIFI17AR3cA4C/J2g6BhXOFOzRNdpKckPdf0RMK0hI1DKNv1wcwBwBCyV4pcENMu
# s6GUqPrVVMUPvhOMUmd6ho/4eXvqkfSC6Xq/VKs8oAZSzQZqKUaK6KBIYrD1YGVC
# LJOfQrboBL63jZs2sijEZDnyN4UALvQjakWQxTsJT9BxmPXEGWHZzz5GG1Hq/vyI
# HexxfcY4ieBw2YJkcl6tXdluXY1uJdbZXW4yFpYqTWPur9RlpsrY/ANrggyXLOfC
# 06biE08+gMgZ6L+lmGitckVVZyfCnTmhOkfnoCiaS/2Ze/pGb7GOVUyX5d0rtL0x
# iObvVBQPKxAe3pPUfq2hggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMTEyMzA5MTYxNFowLwYJKoZIhvcNAQkEMSIEIIzXTHCgnONiSuHV21WTl1+V
# qYNMNYwvZ+AF3GV0nQI7MA0GCSqGSIb3DQEBAQUABIIBAKfKrxof/iQrfOe33Flu
# BmlyiotYGtNM8AxGOO/X4yqDhFrz87B++CFONslxQAXIkNpS7Vtcwquo1G5TRoAt
# yDud5xYtc/018O6EuJo4FCh/zc1lPxLBhlqGpXpSUl3a19RCuv1omYRnMTzyjAiq
# rHKpAfdyAjrWf/DM/K0032ZqiCAo/+EMmtmiv7IigraGluPryuirmTNDQFS4zbVJ
# Xho1CDRPKGTjQ+nOBMd7JAaCoShoQ0mMLpEok5WnWbMux2jWReG/mcCqUDzLtyeO
# IVeo6SfuKbULWcc6JgItlFpFk0HQlV9kXe21Qtf0zF6dlNM2zup73r2B8DjbPv1a
# w2M=
