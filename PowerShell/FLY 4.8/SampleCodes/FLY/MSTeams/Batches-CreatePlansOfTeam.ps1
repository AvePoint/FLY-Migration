    ...
    foreach($connection in $connections)
    {
	    ...
	    try{
		    ...
		    foreach($mapping in $mappings)
		    {
                ...
                {
                    $ChannelMapping = New-ChannelMappingObject  -SourceChannel $mapping."Source Channel" -DestinationChannel $mapping."Destination Channel" 
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU2U24yWiolKeJwXKWI8awg7sD
# Cj+gghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFHDz3+wWY7Pe4IpMwfXNJ82lNJzdMA0GCSqGSIb3DQEBAQUABIIBAH8/
# PJC8YI1DQsiDraO8x+69zm9U8JL6gj+F1MQP2SXOz7iGe3Evw1wusv2RQs0c1VdP
# oUVhPTakF4BkcH2nzsOVpfliA5UHpHf6KkZ3NwBhZS/YmtWaxtz2sQrgyl3aydCJ
# ntx9scpHyGJAkM3O6+txc0EhXP9PgOyNNkQlwOO26AMgtrwqUct2N+WAjF8GRT4k
# lKc9pqNdQKBUiHu1H0M/vnIpGQFQ+gtnx/ZPOwdRVWWKMfXUZEWTYeiV5fq7VoEU
# H+YgD6VbjerU7YbPsFDaHeCsWv4pcTO1yz1QqLIUs7Fplo4Edd3PoHF9PbJsyK4e
# figsDHwGm819oQ/dFeKhggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMTEyMzA5MTYxNVowLwYJKoZIhvcNAQkEMSIEIJY9Ks0yeUFdarux/5s3M7qe
# cpbB3xc1Z7Pwawsr91ihMA0GCSqGSIb3DQEBAQUABIIBAAgKk/UX3QBFGTk8oLF0
# kfv+P2VlR8smKH2nI/HA0JlMl6Vg+VY2oi9TRV2htyqpJgC+1UjLfuO0r6QqKWZX
# ealPzDG+Yq0wlt7eEV1z564pO+xVHAFJRAnVHebPPbb1yAGqXo+dBn7rRoz9vIoP
# ykiSKIjH3cY2MMj7i3pBL7WlZvf3k5/01+ATkccLmKHoOuhku7l+gwzVzv+1jhq/
# lTC+A+AlJvVgeYyDRlpXqw212/WwWBcT1g9aLT19NC/25aUzEGYcnMUNZ7rhfZb3
# +sWlgjayauYHQklkdehd5oxX2rjCAH49g5NEudCcRDsdwilB/7QMBHz66ojd0Q/p
# 8B0=
