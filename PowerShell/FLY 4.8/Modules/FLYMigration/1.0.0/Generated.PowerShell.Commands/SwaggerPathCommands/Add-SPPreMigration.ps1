...
<#
.SYNOPSIS
    Create a new file system pre-migration plan

.DESCRIPTION
    Create a new pre-migration plan by passing the plan settings

.PARAMETER ScopeSetting
...
#>
function Add-SPPreMigration
{
    [OutputType([AvePoint.PowerShell.FLYMigration.Models.ServiceResponseStatusResultModel])]
    [CmdletBinding(DefaultParameterSetName='SPPreMigration_Add')]
    param(    
        [Parameter(Mandatory = $true, ParameterSetName = 'SPPreMigration_Add')]
        [AvePoint.PowerShell.FLYMigration.Models.PreScanSPModel]
        $ScopeSetting,
...
'@ 
    ...
    $skippedCount = 0
    $returnedCount = 0
    if ('SPPreMigration_Add' -eq $PsCmdlet.ParameterSetName) {
        Write-Verbose -Message 'Performing operation AddWithHttpMessagesAsync on $FLYAPI.'
        $taskResult = $FLYAPI.SPPreMigration.AddWithHttpMessagesAsync($ScopeSetting)
    } else {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUN+zhrPXMp270o/U9Kw2NzKcX
# f+OgghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFKnU0FlEhPlPY5ZIxXyrDiKOkhZZMA0GCSqGSIb3DQEBAQUABIIBAKyG
# cxryPizjqanW84SXjTGPuz1UcUbLqfNGiRp/wIFkIxZX/Vy8k/AfOFYo7TNYqIel
# MtNTVoLf76zctdGuF1q/vLnbt5UTbB94b3679JRi99OikJ/Opd0bNvc2Z7CeRJy3
# Wl5W+XST/9NzkQ9SnYDHsMBDsTKKXMUVfXrCsgdA5YZMSsQFjroxdPrgckjujy3x
# yhwjPqBYbH3Xd09fHTAIQutswsf+AB+gnYrxWJfgvTE6lXUV48XpnagWI7ooma5R
# rghE/Zd3+nd3UHfifnkvFhsx+miPWBMRHb/v9ZnLhQ0C4yAL2yaXy/5Gj/Z2ipRV
# bXTH0WbCVJuKaM5SGuehggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMTEyMzA5MTQyM1owLwYJKoZIhvcNAQkEMSIEIHlAy+rMqorwi6UzJFI6grQb
# occx/WNnCTDuJqm/4QDpMA0GCSqGSIb3DQEBAQUABIIBACIEZRD2VQhDb63ygw/O
# OVB7FigXjNi6jrsxrcW2sQKdgSu24fhES1iBxbWqZr8b5YjORXm0wjG6jItfGaSQ
# CwyBAkRM99BV5VF5WLYZAocUlbOGXtYeW1Z8q+BsVUrzfjhVrhcd+y6aUk1KiK8D
# I5tESI2HO/SlPkNW+NejE+Qlv3D+ar9PntqtjbaBtRYZHFOEqnzpKJLA5AdNvhGx
# gYwk3AvtQPbHfb3qRYFzUeNRZKZ5bYkHF/ZtF6CXqe4lZL0os8vN8uF9SypGdmMF
# DoJn/iOaXG6gYtzguFWIgbX2Qi7Kq4QF0nNn5hmLGTfVj6ZF+CFKGY9Zmkl4/poR
# ci4=
