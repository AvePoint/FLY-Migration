...
try{
    ...
    foreach($connection in $connections)
    {
	    ...
	    try{
		    ...
		    $PlanSettings = New-MSTeamsPlanSettingsObject -NameLabel $PlanNameLabel -PolicyId $Policy -DatabaseId $Database -Schedule $Schedule -PlanGroups $PlanGoups -OnlyMigrateDocumentsLibrary -MigrateAsHTML -ConversationsMigrationAsHTML $ConversationsAsHTMLObject -MigrateAsMessage  -ConversationsMigrationAsMessages $ConversationASMessageObjct  -MigrateMembers -MigrateGroupPlanner -PlanMode $PlanMode
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUIZ1i+7svY7U8n1wyVPuZuosY
# 6XWgghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFEbV154R1gVSpAAPs7X6VeYpI4j2MA0GCSqGSIb3DQEBAQUABIIBAG2h
# QeWOW4NMcl04GbHTVXBaf6BuO6IHcZXV4DIPZq3UzP0HEi2bDj3raPglK1O92Gus
# nUv2Sg1XIVwo6x2R/n/BeE+M1ejpaJjhYQ4kX0lUPHdHjTV3G9dsdQXQqxy1AVTN
# /MYPW5gdOlrUGSiSobXGXSH1iLzSjLC1Y/q6XGfsWXM9OSECxgv6o40q7aCKAoHo
# emA4RG2T1BQA47TppDxX3+WZfjjelQfsSFqc5j4kjYX1OQyrJcn8fOCUoT4jMT24
# tSDPDE0v4uZbwPu6FXMaEoAPbu00FYhU1AgdRo/sWPUIte+UftFJyWia7N5crM0Z
# LnQvLgI4NODhazGDPaKhggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMDUxMDA0MjcxMVowLwYJKoZIhvcNAQkEMSIEIB45vUYhdrJqAs2Pkax3fOdP
# BisJbRhmUqeYoAIjxvT7MA0GCSqGSIb3DQEBAQUABIIBAFqXimv6OTt/PB5H2H0Q
# KoJGVAlsMXgYfcFY0oRUfpm33QKzKA2HELpVF52x9ki4J/qOTeKma3kJvpY5W8E3
# BTbSs5HPRk4E2BWfHn6RrjjtcGcZGX7z7MKlgRovYhiefeyPqExt/g97Rvx1F2sX
# kPvpZgkw4iwvrJKsPHW5SIVBcvEF+XkvhOgMwfAcgh53798t+/YekPMkJNvybR5N
# maO5dLG1EujzulbY+MF7LgMdVwR40KIDtI4yDApvABDlp9dXnflVeIJKEkGTQljs
# RFnOqwpH6wH6t5y/EtHiR68KFo9C37hE8cahijyWvcW+sYLkE80l8WnK7VNUzRV7
# wHI=
