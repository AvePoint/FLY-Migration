...
try
{
$ServiceAccount = New-SPAccountObject -UserName '<service account name>' -Password '<service account password>'
$ImportMapping = New-TreeObject -ObjectLevel site -ObjectPath '<path>'  -ScanSubsite
$AppProfile = '<app profile name>'
...
$ScopeSetting = New-PreMigrationObject -ScopeName $ScopeName -ServiceAccount $ServiceAccount -ImportMapping ($ImportMapping) -AppProfile $AppProfile -MigrationDB $Database

$response = Add-PreMigration -APIKey $ApiKey -BaseUri $BaseUri -ScopeSetting $ScopeSetting
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUPDTqIrVJJ55DqNOw3GJuy9l5
# Q72gghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFNRfuE1ABanMb3H1+cYqHCjhetjgMA0GCSqGSIb3DQEBAQUABIIBAHc1
# TacEdBYa9gqRn6O8uyYotMQbVLRbeSpcU9Z9vA8/JdLIq9WR1daKYKMU+O413Keu
# 5udL9P7yLVSuC1bGsJI4VCT3Cp13SSJwukvtwqPy6ia6L/6P1eVMx+QuF7xyJ8w5
# E8ULQegbW1olytQ6QyNkeTkirRJligjweEHBrTKVg307vEdZz6W9O2vNY4AFu06c
# LVMK/GjjGKxveJk+ei6OBp5wxv/xcGj8BZJIubkkClADg6j6MSnAdWGhmD6sw/km
# ye5/qh5a94+YHqpj6PkSt0U0E4lDr73TDW90v6w5JkXYpotgcJZcQESr8X8Z05/l
# 2UunBbiAy4hThCAb+M2hggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMDUxMDA0MjczMFowLwYJKoZIhvcNAQkEMSIEIKY5KOsnpZQgiuiF1+HYRMHb
# 5FuZmFvLgIhqp2529egEMA0GCSqGSIb3DQEBAQUABIIBAHQ8EL59UBWhj9Io/VXA
# VUGhB1oSKJej3+Jg17BqAKd030kTXgnu1JEydL57lxb/tfnJtrESOh6a17TdQpo+
# z2ZISdJx/PaALv7uTUAN75i7O2Cow8Zhf5SX27MdKDWJFSRWkPBl8rEZAzqhvLVc
# byETrap9Ac2KwMQCCgPnbPYEQmcYMD0ByYJP+DltSWMfDanUIeFQdj8+8J4bx6fk
# Eev7s0W5mFEEU7uWkFx/+FkdHg0ofZSPrJFn1a7lSVYZ62Jh4pVODSXLOkHOwxp3
# OZ6YUcgMwp46NaCOZzWGcCTduiL/ldhplJkd/hdA9CBqpOoP6soWOmBvZblwPwtv
# wPE=
