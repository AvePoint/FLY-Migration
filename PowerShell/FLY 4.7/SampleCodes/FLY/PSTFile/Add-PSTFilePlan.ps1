...
# If you want to use on-premises connection:
 
# $DestinationConnOption = New-ExchangeOnPremisesConnectionOptionObject -ConnectionId '<exchange On-premises connection id or name>'
# $DestinationConn = New-ExchangeConnectionObject -OnPremisesConnectionOption $DestinationConnOption

# Or Use the On-premises service account and password directly:
# $Credential =  New-BasicCredentialObject -Username '<On-premises service account >' -Password '<On-premises service password>' 
# $VersionOption = New-ExchangeServerOptionObject -Version Exchange2010 -Host '<exchange On-premises server host>'
# $DestinationConnOption = New-ExchangeOnPremisesConnectionOptionObject -BasicCredential $Credential -ExchangeServerOption $VersionOption
# $DestinationConn = New-ExchangeConnectionObject -OnPremisesConnectionOption $DestinationConnOption
...
$Mappings = New-PSTFileMappingObject -PstFileConnection $SourceConnection  -Destination $DestinationConn -Contents @($MappingObject) -VerifyMapping:$VerifyMapping
...
$PlanSettings = New-PSTFilePlanSettingObject -NameLabel $PlanNameLabel -PolicyId $Policy -DatabaseId $Database -Schedule $Schedule -PlanGroups $PlanGroups
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU+5LfD+Z9dkNXbGSWWWg221IU
# 8u6gghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFDaX9Xcb8mL0f2I6uc6PGBVB+t9MMA0GCSqGSIb3DQEBAQUABIIBAGRv
# 9RquOA9BUx6y/MLK1BwHBNytjVH45nyR29bueInmBv6vCruxKraWSPwkj/LP0Ch3
# UFbmY7QFZOBl59zFUJ4le8OBBUzx5732mjyg3evlYaRWpAMiScDMOgakx0LERepI
# 9J+CyB8B5ugrp52uKeUeqr+rDCfoFwsi26BqN+IVnSHoU8ac39wwGaZaAX0q/oMm
# PMMRkoHW/fMqddmnM8mLdr0n/uYC5mDzMEUNXHU3xOwJp0OJ+3qziiqz5J/bG33+
# vKPXtF6CNkIfAVnyljlyjhnxz7hguGjYe4duhiTPCbxGYLjTMa2by9IJAzjDqKYA
# kjxv2Dfn1HICOtvmjEGhggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMDUxMDA0MjczN1owLwYJKoZIhvcNAQkEMSIEIEAyYunnVQyEdx3UzaaHFxYS
# +zUosY/Mz54qgUz1UJ3MMA0GCSqGSIb3DQEBAQUABIIBADTDnZ4txZ6HvjLmr3q7
# jrZrFYCQj1U0uCxn1jO4MduNaWC/ysGkF3qeIIx8dK2gGtglTH9uoIdeGRbNow7j
# QhEweKG6rr95DLKptYqcBwlHZPkhFON5F8QRyrItH80nrUiFbNdvojJMRk0Wsili
# 3rwzfQqimxCOHFlq2b0KMMDjRdTuLF+ghTgDblRydEkAa4nUMZqTkxBBwxVdEYQz
# 4b/Qyn6OnIFYFeGvhdXjSvGuTWLhwNBfjLjs/7Pwru4mfa1eL0BXBuFVS3DZl2rY
# kGZX9LaXLcw4MF65vKlSiSlreAIEs5EHz3phtmwI6SCgYJUSz9OkIXAshBREIxaO
# ZZk=
