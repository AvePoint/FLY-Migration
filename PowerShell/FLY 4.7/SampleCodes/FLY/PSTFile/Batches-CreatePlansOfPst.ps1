...
#Source end is optional.if you need to specify an agent to run this plan, you need to enter the name of the agent.
$ConnAdvancedOption = New-PSTFileConnectionAdvancedSettingsOptionObject -AgentHostName "<agent name>"
	...
	$connections  = Import-Csv -Path $NewFilePath
		...
		foreach($connection in $connections)
		{
			try{
				...
				$SourceConnection = New-PSTFileConnectionOptionObject -BasicCredential $ConnCredential -Path $connection."UNC Path" -AdvancedSettings $ConnAdvancedOption
				$DestinationConnOption = New-ExchangeOnlineConnectionOptionObject -ConnectionId $connection."Destination Connection"
			   ...
			   foreach($csv in $Csvs)
			   {
				...
				$Mappings = New-PSTFileMappingObject -PstFileConnection $SourceConnection  -Destination $DestinationConn -Contents @($mappingList) -VerifyMapping:$VerifyMapping
				...
				$PlanSettings = New-PSTFilePlanSettingObject -NameLabel $PlanNameLabel -PolicyId $Policy -DatabaseId $Database  -PlanGroups $PlanGroups -Schedule $Schedule
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU1c/h0dSsogU56LgNMe/2GaoM
# trugghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFFkKUSEDzBeVotSKCANg1g9sI+BqMA0GCSqGSIb3DQEBAQUABIIBACYz
# WmTxG+mUi82koiCN7Z5psDnpgkFO6XyCqUxMKVdehui69selv2vFc6rNt6aJK7Nj
# Cm2SKpo55UQPw+L2USK3P9VjfAWX02sQys5OJt29WMioUMwrFxHQKHBvDC5D5lyY
# EYGUuPoqqVxSaGYT0p9yYyUiq7n8Cv3OdGtObq0iJldLDOhcUPCYuK0JWe8+faKJ
# cnM7ahmjnM5W20wmikzS2weAXDM7aDgLvbEqvxJJWEassU3l4YA8L5Lqk32hN1iS
# jk66HCK63KGqtt7xi9/Yuys4RRE08MCV24v8iDEsuQjlL0z2/DQL2pd5rhQU+1F5
# jyYdE3s7tiIjYseNohehggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMDUxMDA0MjczMVowLwYJKoZIhvcNAQkEMSIEIO+EUCn/2GY0cTjd3jzLkTnm
# 3YGBVKFvGemuO/wgDH9UMA0GCSqGSIb3DQEBAQUABIIBAJ/eMHxe4Oy3PgyeJDW3
# YPWk23oUs3HB1RPrnt1xxnoEY0UoQMvf7iNb+geUHAikv1AfcIjV1LuPcckCc+bD
# REKG/O2fcYIhCi/X/ed58m+8EUX32cNqKRKBkrT6cwWSnR51uMzJOYWqPgCBN8R/
# k0VC3h2kQ7aDJvKUZlQL1XNw2VrLYlg0EchOJDfDNz6Fm5N83kMMe3PiW7ervOA6
# d90lfV6wg2q2DGy7f4E368F8Mz9/G0gfd7oyuGKYdsSXCcsLaRtfW7by6VcxMwHG
# wHb75yo07AraBKhOzJlKJOCa+qXPYm5a6SSk6b/frSe5ds2rQ6hEScEDVlwTLj/E
# r28=
