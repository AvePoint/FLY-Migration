...
$DropboxConnectionId = '<dropbox connection id or name>'
...
$PlanSettings = New-DropboxPlanSettingsObject -NameLabel $PlanNameLabel -Schedule $Schedule -PolicyId $Policy -DatabaseId $Database  -MigrateVersions -Agent $Agent  -PlanGroups $PlanGoups
...
$MappingContent2 = New-DropboxMappingContentObject -Source $Source2 -Destination $Destination2 -Method Attach
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUdyYChXcY9thUo32iDoutvaYF
# RvqgghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFF/cVlYIRQ7ZDJq7535lIU8VAsR2MA0GCSqGSIb3DQEBAQUABIIBAEOd
# cbb+d5F1Req519BineAw+ecX34qQ9Zv7w8NBmVVoeFSeZO4YcxcH241jGme+JY42
# EMMecsIW93ZUdDKJoTrmp8q4lVioXEg6TGhe7FIgI62VOjheyUhPDsUjntnYRXdh
# KN8uWHvKA1oqcMbRrSDXyqXcYzT1/pK0iOK6wo4aFa6AEOMlC8VUtcwQStt64R+Y
# 5T8wUZmvuEoycV+KuZ10x+7789V6sjPvcQWd0vDa+8ZZLWoi8EYYNzKGcAvvTpWL
# NhMrt5uR51hrAy71JU6UCTIztLpeO7QM/LK2ZRfvJ+YbEyJ0sILziIRjgWCYIiDp
# wmWhf/SVWCZi5ZL8s3ChggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMDUxMDA0MjYxNVowLwYJKoZIhvcNAQkEMSIEIARWE8u/qy8VvzZtG4tbJt+R
# qyE3psBL3pC920KDhZm2MA0GCSqGSIb3DQEBAQUABIIBAFuOeVkQyjwMJ9PinuVi
# CqXTsKuMoxwoKcdM7DppG9HBU1zfKR5IASknE2qe45cwHsMxFzltYcnEcjeIh8jK
# rO4hHanNtWXr6k7+9HlT0zlyCJPjzhgcbYFrjAwyjPcILJW8wJIjmm/w8khZVORb
# xYqZPbsQWSL0l0jwv5dUyCrjYgNUxhlWonSvdn5dN5VzphKr5YDZsnQlqL9DaEAl
# Y8ECI8uYWFtdzQrbkb30o8joiCqC5/YM8U7b+riIP7IVwAPNEXA74y/bF/cS67Gz
# mTVscFLxKDtTQLU3bAgI5nTA+Qj3B3jyYrMUCp7PpZVPsVFO7bgWNt3MK5+0++Xp
# I3A=
