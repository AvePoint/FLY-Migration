...
$PlanSettings = New-GmailPlanSettingsObject -NameLabel $PlanNameLabel -Schedule $Schedule -PolicyId $Policy -DatabaseId $Database -SynchronizeDeletion -MigrateFilters -PlanGroups $PlanGoups

$Destination = New-GmailMigrationExchangeMailboxObject -Mailbox '<exchange mailbox>' -MailboxType UserMailbox

#Verify the mailboxes exist and are available for migration.
$VerifyMapping = $false;

$MappingContent = New-GmailMappingContentObject -Mailbox '<Gmail mailbox>' -MailboxType UserMailbox  -Destination $Destination -MigrateArchiveFolder


$Mappings = New-GmailMappingObject -SourceConnectionId $GmailConnectionId -Destination $DestinationConnection -Contents @($MappingContent) -VerifyMapping:$VerifyMapping
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUOmSH/sa5OTXgRogayulXcJMt
# AjygghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFH8HEF70l1zMVWY1GEgbjpb2YklBMA0GCSqGSIb3DQEBAQUABIIBAL7g
# SaHjI4XbDuuduZ0rmgwRvOtC2u0XljvfW+CVdGtact9tWOCee9Efm/mWYv6w5nPK
# zls3cZIC83OedFbYIR4eU3+ycpMnTRj4DNPIqDRIUmYBShTgBxRkz8ymffAv4fhj
# xVYBcpy6gKBeritNIyAW0abpEGqQRylZXuYp8GHQ+E11gFwHApoV/HJxHLUxmF22
# nG5GF02cKzgOD5R+RRcpWsLpOQq4HcOabXsuo62nTy1ZGMeGwWuTSxM2VJgzhAq9
# gtAGq0WDsTKLJPB2zhbIv9kOvw+pabXgBjTXGKALg/Nff9ilWcMgo6wHv3BpHvOB
# rBihmTkJkti862p2bgyhggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMDUxMDA0MjY0M1owLwYJKoZIhvcNAQkEMSIEIHewUeUU2youBSVFhhoXewUk
# 6uA9ns17EMSEcTYrzG2vMA0GCSqGSIb3DQEBAQUABIIBAKKqN14dcT2t94QggGnX
# J9XkLOulmmIRMBaksepeTtvI2tVHujdsL4BcavMJaio/ZfhMvIi6r7Gxo3bb4yWw
# 3jMEsYUOIdDh5DFUIzyQQXQofvHdMp+pKFpTaQ0d6HULwSKzGOqae9UjQbKM8JiI
# C9La/I8vLNCG8YwAaIoT98e6JnXQ3bfHGwhyv4yoGM+5slF6lAXadTylcKl/lgxD
# CLbpkJT+K0h4wJ1t+H/Bke5S7EffbCxjKTDeDqv8wja6l+/WC8C+sX5ZBDOAVGjA
# DlfER25Rb1+kZJT9V7uW3bwM9gYTOFnQGNxFNGjlqWHucl33cGiolDxjf6cffkiR
# dys=
