...
$GmailConnectionId = '<gmail connection id or name>'
$ExchangeConnectionId = '<exchange Online connection id or name>'
...
try
{
$PlanNameLabel = New-PlanNameLabelObject -BusinessUnit '<business unit>' -Wave '<wavee>' -Name '<name>'
...
$PlanSettings = New-GoogleGroupPlanSettingsObject -NameLabel $PlanNameLabel -Schedule $Schedule -PolicyId $Policy -DatabaseId $Database -PlanGroups $PlanGoups

$Destination = New-GoogleGroupMigrationExchangeMailboxObject -Mailbox '<exchange mailbox>' -MailboxType DistributionGroup 

$MappingContent = New-GoogleGroupMappingContentObject -Mailbox '<gmail mailbox>' -Destination $Destination
...
# exchange online service account example:
...
# $ServerOption = New-ExchangeServerOptionObject -Host '<exchange on-premises server host>' -Version Exchange2010
...
# $DestinationConn = New-ExchangeConnectionObject -OnPremisesConnectionOption BasicCredential

# exchange on-premises connection examole:
# $DestinationConnOption = New-ExchangeOnPremisesConnectionOptionObject -ConnectionId '<exchange on-premises connection id>'
...
$Mappings = New-GoogleGroupMappingObject -SourceConnectionId $GmailConnectionId -Destination $DestinationConn -Contents @($MappingContent) -VerifyMapping:$VerifyMapping
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUwyvFg4TXOgwhYAtPd1+W2Q8b
# TfOgghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFInsQ0spsHielWXWBavPSzbslYdxMA0GCSqGSIb3DQEBAQUABIIBAINA
# MhEXpJm3AW9YhAtxODzATRYx+ntDeM4CBy8iUJI5Gl2xmfwnb+w1+cwo1WyiIm1h
# tQ4hl9tfcRN0jmsyb4jCdxbVaZ/h737chzdsOy3h4tHxHZrDQVPQQoxIYBgPz9eK
# +hpNi7dGuIxnE157jgUjfeefx3WGtaUvLWFTHpOjZsu3v67O56jHg1ljhTthNS9/
# f3YiLRq2+Z3tUuvvvsicMcmrIqFWc7XwRJxFi/PXQlz2aFOdFPbgA2Ywn/+/c0D+
# ZnyYgA5C+jWFXRX+cUGypU9x/kuoNv5epp/Dtiiu5lgERF0c1OMhrrjJwGnF/aqX
# U4/PS9MEKC9k8vpspaahggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMDUxMDA0MjY0NFowLwYJKoZIhvcNAQkEMSIEIFpZiLT7aI4vz9AG6b+aBmH8
# 9RwbTmMizNl8Is+JgculMA0GCSqGSIb3DQEBAQUABIIBAIAU2J69kury6NEnKcuo
# w+heGS8cnkx5rDKN/B+caXTqU2gi/Qq/bx9QlH1YtE7S2DdbwGO/8nIA+loBXosM
# IahI/bFB8cMBNvgevzmNnWnHQz6Ig5dDKpiFmzgs68aK5XGoOLWoqmEub9Al2l9o
# CZDTIfOXqYBoR238NRw0GPZwL8DhmPzs1qj8VFIx8ncJNynI+1S88riRWSO9lP97
# iSnd1by7Ahgiul9cXuDjzwrzutT8k2SLAXAUTCJdFSiu3nGG10JiG+cimPX2zq2h
# ZCjrO6h5FVnRa16xLlatZ8k3ANLc65VW84Bsvq+n3zEpj84y2Iq8ULHcHWqrffvx
# XR4=
