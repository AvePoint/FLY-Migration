...
$PlanSettings = New-IMAPPOP3PlanSettingsObject -NameLabel $PlanNameLabel -Schedule $Schedule -PolicyId $Policy -DatabaseId $Database -SynchronizeDeletion -PlanGroups $PlanGroups
...
$MappingContent1 = New-IMAPPOP3MappingContentObject -Source $Source1 -DestinationMailbox $Dest1
$MappingContent2 = New-IMAPPOP3MappingContentObject -Source $Source2 -DestinationMailbox $Dest2 

#Verify the mailboxes exist and are available for migration.
$VerifyMapping = $false;

$Mappings = New-IMAPPOP3MappingObject -Source $SourceConnection -Destination $DestinationConnection -Contents @($MappingContent1, $MappingContent2) -VerifyMapping:$VerifyMapping
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU7Cn+jYSWLKeJwQBtGqtYTxFg
# zO2gghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFCoLUwyLOKD7mg8gTs9CaYVZJLCSMA0GCSqGSIb3DQEBAQUABIIBADv7
# rC71H3dJrfV3rEcm5FtBqohyPbYoVAtJxI4Xc8P8KZMsCFpXApqTfSQ6i5/YPEwu
# t/JfNR58DlNXuAgF2neVhC6flLQOQhOfoVjXgkqZSNMi9N3GyTU/RQtDZaalpt2W
# 8TahS1hU7gQgyQ0Eae7M2JsB3NIBJtzGXXTC+dlK42rByZj0kA3wo77bJHnt/Gt2
# yAFd7y/+VGK2zx51WcrTN0ZMM/qHzbBjXAK5A1Van4cdddLWLGDfyGHCn7K+T0PU
# XVD6dhM8gbQEjphzWqCm1xXaHSD2fuU5AKoqs3Hc7zJJOTkeWGseLlmASKRDRtPB
# QIplxh3s02AaItS/SqmhggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMDUxMDA0MjcwMlowLwYJKoZIhvcNAQkEMSIEIKQuhmW/2OoJzS6mLHvWAgik
# 0+VevApnnLGp6tdNgZQ6MA0GCSqGSIb3DQEBAQUABIIBAFzoIBPlocKI9uFQr2fU
# H7/kEhhqs73GdORSSSId4pwH9kZrJ6QvIUqhAyGhdbR0iXu1bow6duk1Bm8FzDDI
# jQoxF5ZcfeG6EhWF1M7AuZYFMAW2KPkTiNNCUpjSfNMB3yvg0WjelMJoYS9ierej
# aETl3mfZKk6kUdJrUmTJEZYh+X9VfGm5zkEY9sZTGE3KyDkeBtXkSwqyam6s7z1l
# 4ByHgsZIFyW2/TickMENAGwKYQPPJVv6dH3nN0R2As4phT0fExhak2qlFffSD4Ho
# np8263FOh173PQAK+wtRysVZtGEc74BrenQWESybYmwQqN0vUDNM0NJRGJhlXAB5
# X0s=
