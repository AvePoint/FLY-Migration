	...
	$connections  = Import-Csv -Path $NewFilePath
		...
		try{
		   ...
		   foreach($csv in $Csvs)
		   {
			...
			$Mappings = New-IMAPPOP3MappingObject -Source $SourceConnection -Destination $destConnection -Contents @($mappingList) -VerifyMapping:$VerifyMapping
			...
			$PlanSettings = New-IMAPPOP3PlanSettingsObject -NameLabel $PlanNameLabel -PolicyId $Policy -DatabaseId $Database  -PlanGroups $PlanGroups -SynchronizeDeletion -Schedule $Schedule
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUou5qsAAPQZDG5g1WDrMNa2d1
# 6pCgghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFAc8BT/tr9ul0gUPsZM4GFPfUUDSMA0GCSqGSIb3DQEBAQUABIIBAGjZ
# vFwj19pYGbnA5IfGv6S72WWnUKOiUU3yMpimlfH3UuVmSLcgoakrfoDFoKpZTF2k
# nhP5kpDyWMdr+RNa14bLE/l7RRTobPvXsKTW60sVb4B+JTjGMjGQb4F8rbhvAlet
# ISdFP3wDvzrDsTpsfW2ZdUzuB0SYRu9z3TqVHEDTSKM5D4XaBJ9mNeJoP8afqCpU
# zq5U510VGWqxi9KUFEnZKKyDJaEhWHBlLortVtfd5SgwfYltsF488bc0ClENn2X0
# opvLhoSreCJXTOp0onCGEFcvXKLKeRQrdPHt8NQ0XvlG2BweIrBaNy2UmcYq7pgJ
# +b4cwHtUuHjcawt5TyuhggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMDUxMDA0MjcwMlowLwYJKoZIhvcNAQkEMSIEICThJ3vHJYYkfCs4WRaOmFGH
# l0TnBKtotcjPmw+w7Kb9MA0GCSqGSIb3DQEBAQUABIIBALv2qm/Ma2XHoFX1+JAz
# Q5yQuaQ8EilJDJb1mdmP+AIOqALBFJxUlJFz/uTU205aM3U2FBbrck7Gl8l7NgZc
# gP/lEjkSs1hgorb7MfWQss7nealkJS9rpDfADgLH/V36g41gQfcTzmQdpbeLIp0X
# BQpZDm+1moK0L1aji8RlMUY5GU6XJQYERzYxeTBviV5ev8GPKpRFcAlQNKwyqE8c
# x65hi6HzHCWJr8b6ElaWDx0Sgn1OLTmV06+1XnySgMc6fj4eBWrhnGIbXOqYCpLl
# sCgFkT/P4qS03ZExsw96YBTd/17Q/PTzQozNUTGPRC13XEENTd02qMbDB6Do/Mx0
# Fwk=
