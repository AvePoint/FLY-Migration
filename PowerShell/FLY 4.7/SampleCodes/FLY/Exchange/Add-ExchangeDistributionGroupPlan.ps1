...
try
{
$Source = New-ExchangeConnectionObject -OnPremisesConnectionOption (New-ExchangeOnPremisesConnectionOptionObject -ConnectionId '<exchange On-Premises connection id or name>')

$Destination  = New-ExchangeConnectionObject -OnlineConnectionOption (New-ExchangeOnlineConnectionOptionObject -BasicCredential (New-BasicCredentialObject -Username '<exchange Online username>' -Password 'exchange Online password'))
# exchange on-premises connection examole:
# $Destination = New-ExchangeConnectionObject -OnlineConnectionOption ( New-ExchangeOnPremisesConnectionOptionObject -ConnectionId '<exchange On-Premises connection id or name>')
...
#If you need to Verify the mailboxes exist and are available for migration,refer to the following example:
#$VerifyMapping = $true;
$VerifyMapping = $false;

$Mappings = New-ExchangeDistributionGroupMappingObject -Source $Source -Destination $Destination -Contents @($MappingContent) -VerifyMapping:$VerifyMapping
...
$PlanSettings = New-ExchangeDistributionGroupPlanSettingsObject -NameLabel $PlanNameLabel -PolicyId $Policy -DatabaseId $Database -Schedule $Schedule -PlanGroups $PlanGroups -DistributionPermissions
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUY9HNNdQIe1V8arZea1/qccDN
# 82mgghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFCU8kVFE1u0aOmHjhyu15sA1qKkSMA0GCSqGSIb3DQEBAQUABIIBAHmP
# c/dJgiSFRyizw02FEkMKcZSoZbEIysrrKqIhPSQwrJxyrSWhR2iSAECdXQ9rzrq2
# f8GLBxcnHVV77f+e8xn0iggBETKkfi2k1al1cFYazmrVZS9xngrWEg5WOw0mnJc8
# NNi0Ib6fQxXYXKElyBQAD/2rWBWUohO/OabseSguvlqqF9BPAbvUbxwtv/6re9y2
# ze41zKSRGh+hsYu/EHrDqNB0KrYQYz1Jb4Bb1ZvcAvyTdredp0k+I8Vn1fUzaGBX
# mpOdnvHvlYNFFaNAw8LBpZOdhqDxXqf2/mfgYUeE7OBdx3+fqnhL+EAMuXz0uaje
# I4402QteSQckqeWxpHChggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMDUxMDA0MjYyNFowLwYJKoZIhvcNAQkEMSIEIPL2AedA5i2F9zrIPVZI/Lbg
# 2s4tf9kDJs5iqm4tyP1wMA0GCSqGSIb3DQEBAQUABIIBAAzShmTSVxk0fEVESB/Z
# j21NgMkY3Zm3brEaUsFp2OleJBQTeCLLP+jRVYCctsDpM3B8wAfpuphhIpjNBTVb
# wQdhPGAXYc8zG0x0NgNoPv9t6ISe6ZB34cSSZ3Ee+IPZ5gF8Fbv1w7DobCkPNwTa
# BcfT/FAbHXGURh2zmwm5V6y6F8mKiPVDDVkA7ILph5Lkyje3G7ASw6stCuhRAxa8
# VoUWjWNg/5pLiKOu4jaxWjO7Ct8qgwAT7Ofkt5XxockFHQSE8iZArL3nYKBpwZ9U
# BDWIPfuNYIZE/xLOYI2ThJkcGNZrWV6vQmO2p1s7WjTyaZVFDeWP8ih8LtiQWRJp
# xRY=
