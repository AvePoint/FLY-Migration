		...
		foreach($connection in $connections)
		{
			try{
			   ...
			   foreach($csv in $Csvs)
			   {
				...
				{
					$Destination = New-DistributionGroupMigrationExchangeMailboxObject -Mailbox $mapping."Destination Email Address" -MailboxType $mapping."Destination Type"
				   
					$MappingContent = New-ExchangeDistributionGroupMappingContentObject -Mailbox $mapping."Source Email Address" -Destination $Destination
				...
				$PlanSettings = New-ExchangeDistributionGroupPlanSettingsObject -NameLabel $PlanNameLabel -PolicyId $Policy -DatabaseId $Database  -PlanGroups $PlanGroups -Schedule $Schedule -DistributionPermissions
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU5yNdQjEXqN9YGkA8GlGWI8tN
# ILKgghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFNMHkdogAxEFpGGeLy0Dk1IDeLPLMA0GCSqGSIb3DQEBAQUABIIBAHfv
# UxcyK2bayTrnjmS+WiQrVlhKczQ2EDmVkBK0JmQA3iEUfRotRQLVt1PvfYAdVPK1
# 2/uVhyt0gA5f9jxrGKhikgICnkk7olfC+Pi1rSYfFOf9v5fdKqiQ3Yscmm3shY9w
# a9FWTbVQlE78vljuI2KqwrC2SnI8j1TYNKjFdP9ABZuEp+X4vF7mN4Qc9TrFGKKx
# BX07cYCLjyny6IyvcEMG55XMTTTQeTNmLQOzB1Iq+TvDmGUcj9lk29RuirYHri+e
# cVMOLdrvtXY8xpRVhTaFFJ+zAVe/7OGAYm5uQTtV59D+UITOo1JIEVvgm/hsKqwO
# bdFVmaMRvq2XhHm0rGqhggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMDUxMDA0MjYyN1owLwYJKoZIhvcNAQkEMSIEIHRszxavgh6C+TCgtWDRCZxY
# MMzxeLUbswb9jSvT3O4FMA0GCSqGSIb3DQEBAQUABIIBAJAdSosPTiJ5xQ5cxSqv
# ffDy6/UDs8F8iIFriAzZQ4KGraisDS7xtpZ88E0cfNmpZSO9EcpM2Ve5i4Nq0iTx
# rZKBZGeKr6SviMuLlEd6UmMSMTsWyBVs4lzkM5SzBmZkjrRK8/435gbrHCd9o1sp
# oHho3soznAm3QqbLWgnd784zY3SWvk7TfmunGX3WC183JYRAmKu/wUwA4/kcf/Ul
# NkGY/1kYS5lKOSmPYTMOPfTKR11R9OTAE+QQGjFMc/wScdaeAdXBRdeee8iv0Jfd
# p1SLo4z227TAf/InW8t0iUS8x5DGzsKNgdTHv0srlogByoVE1YnvlVqEh2iMaFB0
# /QU=
