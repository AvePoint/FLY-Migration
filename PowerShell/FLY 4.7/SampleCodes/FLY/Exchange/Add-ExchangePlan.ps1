...
$SourceBasicCredential = New-BasicCredentialObject -Username '<exchange On-Premises Username>' -Password '<exchange On-Premises Password>'
...
$MappingContent = New-ExchangeMappingContentObject -Source $Source -Destination $Destination -ConvertToSharedMailbox -MigrateArchiveMailbox -MigrateDeletonsFolder

#Verify the mailboxes exist and are available for migration.
$VerifyMapping = $false;

$Mappings = New-ExchangeMappingObject -Source $SourceConn -Destination $DestinationConn -Contents @($MappingContent) -VerifyMapping:$VerifyMapping
...
$PlanSettings = New-ExchangePlanSettingsObject -NameLabel $PlanNameLabel -PolicyId $Policy -DatabaseId $Database -Schedule $Schedule -PlanGroups $PlanGoups -MigrateMailboxRules -SynchronizeDeletion -MigrateMailboxPermissions -MigrateContacts -MigrateAutoCompleteList 
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUAyGiZF8bWHmjoikRZuJLpV+9
# AyigghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFAJNRoLTuUI6P2KZPxfz6dssrj3+MA0GCSqGSIb3DQEBAQUABIIBACbU
# 7vbnWErkPjD5PgalPhGq08BOMLbnyh0b8A3BiijP5dZ8hRCxkuRL2Dwocrr07ruj
# DUlftprbuo4Fp8Dhz0MphR1ZkiIjxDtNgbNMkE2DSoa0GvHluV3OQeGDuXL7Wl99
# 32MgsoAotkV6N6CmxUcVrHAroF5Yerp1dVIetsa13jgHzXlX9igPOSHHJQHfoD1Q
# 4FmkL/lVhqh9Z/1P3NC8U2MJpADju6I6B617SV5N6B3J1MbkxWbBocTEDypFOY8S
# IOHJs3z6+4GIvlQuLnOmsLyDkwykovGRY+denkzdehEzXiL4HRQSK1xZoqXE9/ml
# i2OOPM2hIFX8iIcIOzGhggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMDUxMDA0MjYyOVowLwYJKoZIhvcNAQkEMSIEIJc6u9rjsnh9SvIRss3QAOT4
# hq5Q27rknqFOc3GkZYLMMA0GCSqGSIb3DQEBAQUABIIBAJHXq3695trVB0DB+pIc
# zfAbWm7LXzmlRf3huWrVaDwyGXzCq53yVdde+mD82KwS93nGEZhKkgbTHQB35wNn
# Cf2Z4XIu4v+HLkCKpyeMgKjUjdvKTG+fvVoIvWImm/chX5lFkenN6DFTGpglUb9f
# UcH3Bl6S2/xPIfmyqhzyoAJekHXY5gNFA6txCfb3IJbm96rC3sX731hD33+RZoUe
# 3D7s7sXy/UUczq1ervObVj32ps9IRvYRdY4qVPbHQrDKCpkzQPrGRbWvwZcCFpTk
# EblCGCIJC1s40VEOyr0zMo+llJwhSUsfNyzacfXxxrLi19c+k5qqgO+J5/eYRqJZ
# GXY=
