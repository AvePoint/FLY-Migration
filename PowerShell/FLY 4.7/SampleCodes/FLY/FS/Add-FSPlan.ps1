...
$SourceServiceAccount = '<source service account name>'

try
{
$DestinationCredential = New-SharePointCredentialObject -AccountName '<destination account name>' -AppProfileName '<app profile name>'
...
$MappingContent = New-FSMappingContentObject -Source  $Source -Destination $Destination -Method Attach

$Mappings = New-FSMappingObject -SourceConnectionId $SourceServiceAccount -DestinationCredential $DestinationCredential -Contents @($MappingContent)
...
$PlanSettings = New-FSPlanSettingsObject -MigrationMode HighSpeed -DatabaseId $Database -PolicyId $Policy -Schedule $Schedule -NameLabel $PlanNameLabel -Agent $Agent -PlanGroups $PlanGoups
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUebPnzcR1Mbgii++0G+40Kgc4
# aBSgghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFFdqIphX0A5UafWxGKgSMx7CxUUvMA0GCSqGSIb3DQEBAQUABIIBAB+A
# GlmugUUo3T0NyHqq5bA99J81w7x1+t3JXKbCqpU+oUnoFUVcPjPULlvhvLPdHMU6
# OvRlD7I5q8uQAFngzjABgtQJ2GlhXdhIf89Bnpz/g4ljpQ3WoZxeEdl7hswiyr0o
# Z7jNeYA8sI6BGER4UkH+OmsJm43uj7DjeQRmKtwZSsU4Nt/iN30lUFaqO4d5fzO3
# H48ojMMntw5y1G4sIgjBMIVSMaDkxR422WvOE3ZQMmfafA3RDsH2Qwjb5qwmnuXJ
# 1CxTLbgsvqXby0M5NRCPma17hd5onhGlJFZvHzHXCLk47IPBv1cqJcRX8w7mS9A9
# 4CI1yC6/YXd0OBZ3x1+hggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMDUxMDA0MjYzNlowLwYJKoZIhvcNAQkEMSIEILvKDdJUnD6nQsPbKM1GVxJH
# y1P2/t6499rLTBJbkAfFMA0GCSqGSIb3DQEBAQUABIIBAGtZlsXjme01wvWR4d3N
# eNdiqVtSxopV12QWqkMq55ZZ4aa29rDIjCiEqk0uA+Z7oX9Iqo0YKyXO2P3q8Ctu
# qBnVLwSfvh/CbfSipCwrUw0G6rOl+4bmBlSCvafEmzCET090r3VtbNNR4P6P00xX
# wgRzbrR+bw0w/NrxC7NueyQiD9Xf1tWyi2UqIZdChOBzh0hrjDYAxxGxRdSvFsIJ
# A8AWeuQKF5QUXj44L8OC1eTjmyTPgcH9mwFnHNWtp2pQpiOMgcxItpgTPLMmq1qa
# +gIezo8okUPlhUBekaMS3EEXrkiuou0pDbTgHbPG4NHB96DRVQ864wUJ17mZKyFk
# XO8=
