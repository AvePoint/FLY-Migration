...
try{
	...
	try{
		...
		foreach($csv in $Csvs)
		{
				...
				$Mappings = New-FSMappingObject -SourceConnectionId $sourceConnectionID -DestinationCredential $DestinationCredential -Contents $mappingList
				...
				$PlanSettings = New-FSPlanSettingsObject -MigrationMode HighSpeed -DatabaseId $Database -PolicyId $Policy -NameLabel $PlanNameLabel -Schedule $Schedule -PlanGroups $PlanGoups -Agent $Agent
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU7KRE6TiD6qhR0C6zi/y/sX5X
# K0mgghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFK8PIl8pFHMDOUDHdnDFU8IB+2PBMA0GCSqGSIb3DQEBAQUABIIBAHc4
# FPI/1QRx63xpZnC7hKWRmYw8LMAR1lo/uT7r8rPbiMJ0VhsBeyfE20bbkwDvk9l5
# slE7xjyaVBrMh1hTh/vORePV/VJLFWuVfcwamFw2HTDuORaYJeCMSuFrHlo6TTFr
# pSi1xQYrRtwOATNupGSCiYzcRVXaugjxF6+h4aKl2OLFeL5+mQKszKZJE6ywuOS5
# 4ZCD4S6yeKsUTuh/YKEUsQyn5eumM/cmEf0x12cosqBBDarw9c3fzgnm21SjJ3r2
# EVTootZKuc5ErAKnN4nyK7NJQvMpii8p2UUmpmXLKtFd90JIwTlyapUItdP2Pqhc
# MuFcAzAsKM1btf2WQjmhggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMDUxMDA0MjYzN1owLwYJKoZIhvcNAQkEMSIEICpbx/kAh9SKBydLDnm3iWXQ
# gsqZskRgrVSpXKXlT5+7MA0GCSqGSIb3DQEBAQUABIIBACFOss8ayMZFxTnEu+tI
# h7nllMsfEpmlYMdHdrLq+5nILjutMVsnBqaXWSWku0tMF5tC/TsUcUpRHDof08/2
# vM+OqxCGG/Rzhwu2ztGMtZfh3DBUKIhcZCTY3sCNswt+2klPc7rdrvqddyokTxw0
# cShxB+2nADIzpW4WCYoTWqT2fUbJpCq8eOwpwaIVsbWo/lsvTvTRXVMVWzbhL/it
# 83glGWMs9ayoLGYfp7nXdvCMG5i/LPjpuHKDWS2xNhuQ/92c9WWAfw7DsFdZzGRA
# IvhKEZvyNlNu1czEOkLedH7A8sNFT6siX8RDJHSY4NzWXiaHauxGWS/GXYdIasoI
# JK8=
