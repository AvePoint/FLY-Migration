...
$ConnectionSiteUrl = '<site url>'
$AppProfile = '<app profile name>'
$ServiceAccount = '<service account name>'
$NewServiceAccount = New-SharePointCredentialObject -AppProfileName $AppProfile -AccountName $ServiceAccount

$ServiceAccount = New-SharePointConnectionUpdateObject -SiteUrl $ConnectionSiteUrl -NewCredential $NewServiceAccount

try
{
	$response = Update-SPConnection -APIKey $ApiKey -BaseUri $BaseUri -Data $ServiceAccount
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUDyKnbmBxo+a6sYkV2g9EGS8Z
# OFqgghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFDmvbPBeO1z28JcYT4mX24KdTSNJMA0GCSqGSIb3DQEBAQUABIIBANX1
# 4iC+uj5i1DJYaDK0uOWP7gExjzXwAIDxEhbLExxnnpWtGIxqTvTXuNp5eDarHxh0
# YFBNAuHFuNjWNEbfcJMgah7xKXoROyqufH4rtLogorHgyF16vblVp4AeNgCiuCxp
# 4qA38SAZlm379XHJeYm6A0fVpLyXtzJss9utOy3rjCd0NkTnjiZzwrRkou1F/WyR
# 4X2E76Jot0f7Oydczg0hXIJuGWMcuxRhN8UFVvrU3cKHPHe2cqHm5gkEJr8RDX/z
# t1vfhPGx4Bubs43ULxnHjQ2Gm1r0co3icuVliQJy3wffve4pM1pHlNFH7j3H/CrB
# QKOI9/m4KtJF2OAgdj6hggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMDUxMDA0MjgwN1owLwYJKoZIhvcNAQkEMSIEIArn0Zo30KVRct6CLSqIo87X
# PHG66X+jsQKyFwrtPrk2MA0GCSqGSIb3DQEBAQUABIIBAJeq/eJWNTE1BKM3dB+E
# Ak/e47dnazjfr+x3jVazb2Oy/VS7L6qBRvJfryuh2YMEQqA9tzdldm+Z/IxS9/W5
# N7a7MYYfNAcAEplpFtlVBqyco3uL6J2gboUa0fliNtihZ9GOLxFYZ4GEzMKrb2Oh
# rvuAWuFAlYuPnv4IxVd5KGLPn+lPT4yy0XZeAU3mj1eya/UOLy5fcw9NLC465xfo
# n8cFEpZeZocSUX5U3QkKygFNelSzLszx9a0pjyCHMT3ePn8s/yGNhrCQR/FW4EhZ
# EEIZb0Ek8irRu1zJksLKlSekDsRyBvES/IwXhdJ+/u0I0VdAywSM3KbatRn3NYji
# VLI=
