...
$ApiKey = '<ApiKey>'
$BaseUri = '<BaseUri>'
$plan = '<Plan id or name>'
$Policy = '<Policy id or name>'

#For axample:$Database = 'database id' or $Database = 'fly(xxx.xxx.xxx.xxx)'
# The Database is an optional parameter
$Database='<database id or Database Name(Database Server)>'

$data = New-SharePointUpdateObject -Policy $Policy -PlanName $plan -MigrationDB $Database

try
{
	$response = Update-SPPlan -APIKey $ApiKey -BaseUri $BaseUri -PlanSettings $data
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUul/iKkjgu48g7CksocSFcAwJ
# pTagghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFNXwNL2AqK8CJFy0EhASkTVADwR3MA0GCSqGSIb3DQEBAQUABIIBACOG
# sROLHrmieaeFuv3MMuDhIVJk98CCdneUPhg+Oxk/jn6RuEkAZLCOXIFZ01L+wy1l
# Rv62kfWs2bwf2fXTMrZfR8HGsVc2jKV/hIC6eYBavlS0GNm9eqZSAnC3QkY8H05l
# wZsFun+e15KGLwRbcx4CeCmEwlWstwTrAAR59R49mJBM2RgPZoAxqUnKhgVVHpPZ
# mYUR6GweZepvdtG3FICU5p22KbTg5tscVQzxQikHtB0m1kk/wwMmB3JvH9a3s0ww
# uSctLrxiP78fxUZZI3sVGckLAKbV9If6QbwQ/FFqTzjQpmHt2mG9pCvx8/ja8CcI
# 16XpXtCNXoGpicGbIFChggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMDUxMDA0MjgwNlowLwYJKoZIhvcNAQkEMSIEIAu6aYcUeU/hPolwvWkqHXHM
# WTm97rWp0fxzmLDe4tQ8MA0GCSqGSIb3DQEBAQUABIIBAIfHdvOynUsPuAklpSRk
# wsC/lVc6jWZVuC+amLR9+uKK73rfFJq7h6vEbBDuOeVP+4X8vQvw6St4Mw6GVtaU
# 9EqK1wF/wUOrFUgNFRbUjQJf6pAnfEfmQJTOuEZl409OV99yqhXlVvpM4mQcSnU9
# +F0tkyG43u5q9CAyXOFC60LioqpSYvcRQITGzJcIdQvJc/Q5kFIeutCDCO3Irkv7
# JId0NwmAdZtNyUbC1zMt8me51aBzcWrJhDlbV5DP/2BjC4VmeExuwD6i3laP0sep
# 4s2COfdMbg+EkxPGRHq9cTf5zq5pxW95QJ4TkF561mGC56brA9vSsZDH3/hTwCp1
# r3E=
