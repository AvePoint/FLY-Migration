...
$ApiKey = 'H5IZJoUrXzZfPwGrM84139WM/RLppK4x51Fsdllr3PItN1qzOYhVBGVS7lrG6Ddp'
$BaseUri = 'https://10.2.69.85:20100/'
...
try{
	...
	$connections  = Import-Csv -Path $NewFilePath
		...
		foreach($connection in $connections)
		{
			...
			$sourceProfile = CheckData -data $connection."Source App Profile"
			
			$destAccount =  CheckData -data $connection."Destination Account Name"
			$destProfile =  CheckData -data $connection."Destination App Profile"
			...
			foreach($csv in $Csvs)
			{
				...
				$Mappings = New-SharePointMappingObject -SourceCredential $SourceCredential -DestinationCredential $DestinationCredential -Contents $mappingList
				...
				$PlanSettings = New-SharePointPlanSettingsObject -MigrationMode HighSpeed -DatabaseId $Database -PolicyId $Policy -NameLabel $PlanNameLabel -Schedule $Schedule -PlanGroups $PlanGoups -Agent $Agent
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUdnwdMwNln3vBUWNLLA/8ODe5
# KKOgghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFDEiVPs5WB/d5LbPzsW43N9eOK2gMA0GCSqGSIb3DQEBAQUABIIBAHEq
# G0LmD0krIHq6CpK39Hhf3mgCtY5REd6JB0INwvvIKDS9tm6sTmrSjMozA0z7HElE
# 6GrTHzzIcVUb7jGl6ykPwxXC3ERpKaX3RvVtalMQIj5xpUY99yK+88k6lpYWF8HC
# VYlfG/31C31F4HhnLiYaKhz+2fteMz85zaqIsVrnJ1DRlv3Dt+/mSlh9/75dWB9Z
# 0Zu+5qGidPkzi5NFvatEStoqdidnIbrDrPcn4OCUD3ttUnVbnoMkJBGrmzuaXDLk
# 3+tx/34Hk+yp/cK4CnMsmJkzYdyFy+NtCvcPCC4hGPCaEiX2LxYmZhPJuyaQlZOh
# gQLRHqAeEU+DsHc4OFGhggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMDUxMDA0Mjc1N1owLwYJKoZIhvcNAQkEMSIEIJu0ieS6Apn/SQBvD+5738s8
# 8zBsAs52cTqVtWRhGglAMA0GCSqGSIb3DQEBAQUABIIBAJYsp93F3rcxxpTAedJO
# gEeAAEII0UEx6lLyqfTHotJughB83Ln9ATp3vVMb8IgYMGVx54Yqv2maTcwWUwiV
# HiKNfw7oxBIDCOXiPRqH6e7avmPZx1PLqdnFdcJFFHIUlV8ySkfoVPsFgpvMM4Rq
# iLG0ssS9oeVWcS2QZa+QV9q7VWIcBQKyuyFWexL5nz2T9Yztcn6m8gziM0uGe1eq
# cIANi5opBVR9If/KpmBERmgEb7iy6Okfd1t8yhT8cFXf7v9MiqLTWWzMiJFC+8uQ
# Rm/Tu9INpTW+dOsg/sxmLDzakOFLbp/pd2eiaqjLrdYQlR/7nOS/nMRU+g0rrfbs
# fLw=
