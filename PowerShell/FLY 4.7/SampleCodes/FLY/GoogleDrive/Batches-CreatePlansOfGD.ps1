...
try{
	...
	try{
		...
		foreach($csv in $Csvs)
		{
			...
			$Mappings = New-GoogleDriveMappingObject -SourceConnectionId $sourceConnectionID -DestinationCredential $DestinationCredential -Contents $mappingList
			...
			$PlanSettings = New-GoogleDrivePlanSettingsObject -DatabaseId $Database -PolicyId $Policy -NameLabel $PlanNameLabel -Schedule $Schedule -PlanGroups $PlanGoups -Agent $Agent -MigrateVersions
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUkVEoP+pb419nFwGPzYuGF2jS
# xlegghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFGLm7Pawt58wK2qUMUq1GRC6XwY+MA0GCSqGSIb3DQEBAQUABIIBAH1J
# GPrTtrR3Vg4WtQDzyPnC6jec0RehXal2wJv5wwQRCYkGuYPFWedhr7wit6qSGtTx
# vHzOkjlBIiffqYWMY6yQhQNJWYP47TS6zCBGKobboI/PcsiltyFohSXchkdw7idJ
# 9cbF5K8zUfwX/Y6pmuwZNcZ6FS4z+dC4qoN9P+RAU/C20do2qMOOVBJZbnv8075q
# hVgQ6i+0RLxAGP3WR+nHPZARa4nqhnJ8rm3NmXaiTMyEHE2nOJYS7VXMXBbb+T0w
# TF5WSdafo2Phb/TXb5Ap3IsJT/xR/O8t+FbY7WY88Mq+Pf+W31WBQufYPpH26ob1
# 0s1zSxMmuc4ho4rV76OhggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMDUxMDA0MjY1N1owLwYJKoZIhvcNAQkEMSIEIEcH0tJD75+zJ2mPQRbXNQ9G
# kSkn0aVR8WnptFg20SWaMA0GCSqGSIb3DQEBAQUABIIBAI7HJEFQyhjZalYHMmVK
# 6GgVebD48c6tlvvPOvt0p/EZoHatCFn8XEBMmBbi/Dfo+frU3w5b0Fo9YNJscsV6
# THI6lOG+4s3Jcba+OTFDcIsDHET451qL76UA8e7LPcCiik+69MsSHXPY1G6d1Bg/
# nhd2C5ioYzTVH5yBkGXwO9Oow2A01kzj2cz0peOzuRYBJ3GSUSLV+ko/A5Ykl1Tn
# jazFQzJLNtigxH7ewzajQ9sJGF51HFljRwhOIcuT76YU5xRjct6W9vFbCO7DUmRI
# JNorSgE+mkKS5fuiYJHylrxRlKxnFMWEJwWybhv5oehFHglkaHR8M+yNG3TR8eTs
# 3zQ=
