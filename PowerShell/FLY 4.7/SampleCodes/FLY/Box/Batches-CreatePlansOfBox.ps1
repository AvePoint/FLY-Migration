...
try{
	...
	foreach($connection in $connections)
	{
		...
		foreach($csv in $Csvs)
		{
			...
			$Mappings = New-BoxPlanMappingObject -DestinationCredential $DestinationCredential -Contents $mappingList -SourceConnectionId $connection."Source Connection"
			...
			$PlanSettings = New-BoxPlanSettingsObject -DatabaseId $Database -PolicyId $Policy -NameLabel $PlanNameLabel -Schedule $Schedule -PlanGroups $PlanGroups -MigrateVersions -Agent $Agent
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUXkHTHGE8ZQE9xJPQ9s+ggY2r
# rHqgghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFCCwXp7oKGj3ox7Neq0r/3DQwV9XMA0GCSqGSIb3DQEBAQUABIIBALJ0
# xlZpYjbyAwm7WG4NMdjdnQBXkQgZyNlEOsPqCa1+A9JCKAaLzvoQ9mrldIC4qsPe
# DtMvnHApE3wrAuLrGShlGgvogkxk0xaRJZhpfGWW6BgTTZ8NnFUypQ4K9v+LV3tK
# AM/v5F0UakC++zDa/9adLBveJlpMni5p1W9zIIFOboOroY4//O7NRDwy2S00pDGK
# rm8oHJrNg8mhcYgdaxTJKn+vt5tdavRag5oX8hHLzeiEHtnJ+YpyYY3VgjJNhAL1
# xfdTyQ5833s6k7s8S3i4SjODHevhm5w5lSf2/FJkEkymxsMgGeWIPI99dx2X1BVG
# 1Lwz9L4fFC6daIgTJmmhggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMDUxMDA0MjYwNFowLwYJKoZIhvcNAQkEMSIEILU0HLe30F8OLuTq9or8xf1y
# QTDcVvhEWudx9fCjdjhZMA0GCSqGSIb3DQEBAQUABIIBAJwVKWr9Q6gog5fbWf6H
# Ru8KG4Rq9GWBkl9N4s15fx84To0YMaHtm9QeqhcTkryoacBt1f5TW/cWbmYuWzP9
# KWAfWHgbPaquMzeQDr7Husd4ns3DjwjEHh3LLs1YDIccZFxbe7UdYjVCH33W0Api
# AZmkujViobM8EaTaEgAj6A0CStyurz7GuyXT9N+7idsAOAYsbIJbFMnkK/J9Jex5
# SqxeB1itgxB8tDk5lk1twKzD9o7/eRZSyOOOK8hmnZC+THhtepAmzALZSrs8A87U
# 5Vzn6rsJd9FiyT43Rgpapd5IAyUUFNw+IVYHZfFxiMwwU6+36thUPsN6GEdN9mjv
# OqE=
