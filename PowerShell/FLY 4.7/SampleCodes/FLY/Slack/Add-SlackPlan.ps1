...
$SourceConnectionId = '<slack connection id or name>'
...
$Destination1 = New-SlackMigrationMSTeamsObject -Mailbox '<teams mailbox>' -Name '<teams name>' -Channel 'General' -DestinationChannelType Public
$Destination2 = New-SlackMigrationMSTeamsObject -Mailbox '<teams mailbox>' -Name '<teams name>' -Channel 'General' -DestinationChannelType Public
...
$Mappings = New-SlackMappingObject -SourceConnectionId $SourceConnectionId -DestinationConnectionId $DestinationConnectionId -Contents @($MappingContent1, $MappingContent2) -VerifyMapping:$false
...
$PlanSettings = New-SlackPlanSettingsObject -NameLabel $PlanNameLabel -PolicyId $Policy -DatabaseId $Database -Schedule $Schedule -PlanGroups $PlanGroups -MigrateAsHTML -ConversationsMigrationAsHTML $ConversationsAsHTMLObject -MigrateAsMessage  -ConversationsMigrationAsMessages $ConversationAsMessageObjct -MigrateMembers -PlanMode $PlanMode
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU+KAWxX7jMbWMg3l8JmQV7+6i
# Pz2gghnUMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# AQkEMRYEFFs8UYeDoeHveUXeL0sYKoLHuM8UMA0GCSqGSIb3DQEBAQUABIIBACFM
# YMg+EApUil76AGtTAAzsZc5skrC8UDAnPxbaWZu0lPN4yNt+1Ko/sZzXIzmvVMnA
# oHKLs41fwfgY5nU3KFCTPtaT4HyeoOpNIN4UsvIVn7O1/HrFm+H4TW43OFQ+Kf7j
# GEaqJGFpPilSrIR5pLciG4GqnxVfB927vwvw5LyqYWQg6DQ6NqOdkhs+PXqZohpl
# OoPMk5/kkqyyCRHWi7SkDb8xCis8L3z3UKYP5wFUjQulFN/dlEKWOIxU9EzrEil/
# Y3WN2R406n16t5b/hcSwqT3rOB7u6/Ud6u03vynU8x8yIPnjSKk/vskgnd0CNNXH
# PceaX2P25XfHgXQ+oK+hggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYw
# cjELMAkGA1UEBhMCVVMxFTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQ
# d3d3LmRpZ2ljZXJ0LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVk
# IElEIFRpbWVzdGFtcGluZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIxMDUxMDA0Mjc0OFowLwYJKoZIhvcNAQkEMSIEIC0L8Q8daIP/15r/+NXh26OC
# sz3UwchHQGcGOdcmKtXUMA0GCSqGSIb3DQEBAQUABIIBACWz6X1uW4CsrTE9b1MR
# 7WfgOjAbZ3IZ1xlBxW0LTb0w50TTFw2B2WMr6aUEa/EaBXVNEfhd0X6QYI0xEkTE
# mJf7t9B8ckS2W67f3sHKbx1F1yQLcDhsNbDak12S1Kc+pCbxl6dkOhRWJcaLi8V5
# DMdB4pR3Go8U4AJOTZG24HWfjKX+ICXPasWF+scqJEYOxnvm6G6WSOzGv2ufDxZY
# 4fx/abCX+dGHDAotI2Su6lQ3pm39ypTc2Aki3FlHiXTW7pEdg2HlY8n7reNKbgaD
# JMjoIKR/hCcaB4L2q/2KBsCdYFU50wuZSPfX9qVsQ0bYfdx/CaelwTpUY1kGUv2Z
# xcU=
