...
$PlanSettings = New-GmailDistributionGroupPlanSettingsObject -NameLabel $PlanNameLabel -Schedule $Schedule -PolicyId $PolicyId -DatabaseId $DatabseId

$Destination1 = New-GmailDistributionGroupMigrationExchangeMailboxObject -Mailbox '<exchange mailbox>' -MailboxType DistributionGroup 

$Destination2 = New-GmailDistributionGroupMigrationExchangeMailboxObject -Mailbox '<exchange mailbox>' -MailboxType GroupMailbox

$MappingContent1 = New-GmailDistributionGroupMappingContentObject -Mailbox '<gmail mailbox>' -Destination $Destination1

$MappingContent2 = New-GmailDistributionGroupMappingContentObject -Mailbox '<gmail mailbox>' -Destination $Destination2

$Mappings = New-GmailDistributionGroupMappingObject -SourceConnectionId $GmailConnectionId -DestinationConnectionId $ExchangeConnectionId -Contents @($MappingContent1, $MappingContent2)

$Plan = New-GmailDistributionGroupPlanObject -Settings $PlanSettings -Mappings $Mappings

$Response = Add-GmailDistributionGroupPlan -APIKey $ApiKey -BaseUri $BaseUri -Plan $Plan

$Response.Content
# SIG # Begin signature block
# MIIfPgYJKoZIhvcNAQcCoIIfLzCCHysCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUmwkN/h5fww2DS7vqScl1QoE+
# ydqgghlsMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# hkiG9w0BCQQxFgQUyLRAJvzhHHpwLWB72lKUbpNe56QwDQYJKoZIhvcNAQEBBQAE
# ggIAO9UFUl3+Xm/961gR5/3r0AhQz56ZO8PZWEKop9RJBjLe4vKSyM/RlqOF/lMJ
# ra6Hh8I2xTDg4Ka3Ff46FyxHAwQcu+JnKMr1jsPAxVEiqD0ojyA7Uo37D4TN+l4s
# 3iY1xJk0SDA4QAFzhE687jmj3HKr9wtgIC1sHcWxxBh4AAWjgGmpzYXJfDIvfa8x
# kNTcMZsZ85HvIwiAXj2al+aL+48tSJtIflst1QrGqWjwQ329Y3WPqbPx/a2SQQbk
# 8f3lh8dbNUW8iQ1VAWSszHzpcQoaDmPT8BQX2x0K6ukweyGRd7zV/ilDL0rDDWKf
# r5JiXVpxVy7LbJV9wijnYGx8STfUdYH88DiXRym6VJr0DOspFup5LP8NgsYS/o21
# 81i/kFkPgg2Cjefqd8vEbhifjcPLvXO0L9wSVwwou1A9XSnFXF5B/KAJxQFppnzv
# VgmnCab37BV1SgBxx0u5jnWmcjCvD3bChB059ksj1O/o7D0rIDcZ5PPX+OZ/+YJp
# wG+rCxGhqx9KtxqxtKHlrLClgSLL1YWuuHos+qPRcq/gsBY33X9j3+VENj+a45Cc
# N94f4+5wviS3Box0PyigZ0NAdMrQZvT+D9mmkHQmpplWliZxa2tJ28+RNg4P5i4H
# S0euzq5+C/GehnIxi51yoAqK1KJtLUeuoTEnKgGwEu5gKFKhggILMIICBwYJKoZI
...
# OTEzMDMxMDE2WjAjBgkqhkiG9w0BCQQxFgQU/ljOGk9B0+JbIOD/lCJKtNRDE0ww
# DQYJKoZIhvcNAQEBBQAEggEAnYoI3h3aBCWrz+SfqPjJ0QTjoqnLKsZ8M0OjEjM5
# oJOsCnn7xa93lW7xxhofxLcoqRDbfOYJyDqM4jQH48Eh6+lBLrQrIkGt7EGTL3qT
# 9Z2BdByvHFW6XdTf6JGmz2z72k+/dsMH8AAkHLdUOL6so/MzzGTQTcNLGY8WTYEU
# TBmFXEDFkNeIo5slMs04d+xerEQVdVQolK4O0wb1GEoIpHFh8yUMhMGCyhn6bD+p
# LuaBhW1UlyEKr51WhdCN+GPnxcxP6ZVInmUqg7+xbZTagVlmj44D6LJUzNKDnSFr
# X/gcwTv3AffFW6t/htnDS2pfaNgr69tSjc1o5bv/hcsuTA==
