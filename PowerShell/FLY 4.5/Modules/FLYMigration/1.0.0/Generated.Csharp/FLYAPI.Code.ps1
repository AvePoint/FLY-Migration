...
namespace AvePoint.PowerShell.FLYMigration
{
    ...
    public partial class FLYAPI : ServiceClient<FLYAPI>, IFLYAPI
    {
        ...
        /// </summary>
        public virtual IDropboxConnection DropboxConnection { get; private set; }

        /// <summary>
        /// Gets the IDropboxJobs.
        /// </summary>
        public virtual IDropboxJobs DropboxJobs { get; private set; }

        /// <summary>
        /// Gets the IDropboxJob.
        /// </summary>
        public virtual IDropboxJob DropboxJob { get; private set; }

        /// <summary>
        /// Gets the IDropboxPlan.
        /// </summary>
        public virtual IDropboxPlan DropboxPlan { get; private set; }

        /// <summary>
        /// Gets the IDropboxJobsByPlan.
        /// </summary>
        public virtual IDropboxJobsByPlan DropboxJobsByPlan { get; private set; }

        /// <summary>
        /// Gets the IDropboxJobByPlan.
        /// </summary>
        public virtual IDropboxJobByPlan DropboxJobByPlan { get; private set; }

        /// <summary>
        /// Gets the IDropboxPolicy.
        /// </summary>
        public virtual IDropboxPolicy DropboxPolicy { get; private set; }
        ...
        /// </summary>
        public virtual IExchangeDistributionGroupPlan ExchangeDistributionGroupPlan { get; private set; }
        ...
        /// </summary>
        public virtual IExchangeServiceProvider ExchangeServiceProvider { get; private set; }
        ...
        /// </summary>
        public virtual IGoogleGroupPlan GoogleGroupPlan { get; private set; }
        ...
        /// </summary>
        public virtual IPSTFileJobs PSTFileJobs { get; private set; }

        /// <summary>
        /// Gets the IPSTFileJob.
        /// </summary>
        public virtual IPSTFileJob PSTFileJob { get; private set; }

        /// <summary>
        /// Gets the IPSTFilePlans.
        /// </summary>
        public virtual IPSTFilePlans PSTFilePlans { get; private set; }

        /// <summary>
        /// Gets the IPSTFilePlan.
        /// </summary>
        public virtual IPSTFilePlan PSTFilePlan { get; private set; }

        /// <summary>
        /// Gets the IPSTFileJobsByPlan.
        /// </summary>
        public virtual IPSTFileJobsByPlan PSTFileJobsByPlan { get; private set; }

        /// <summary>
        /// Gets the IPSTFileJobByPlan.
        /// </summary>
        public virtual IPSTFileJobByPlan PSTFileJobByPlan { get; private set; }

        /// <summary>
        /// Gets the IPSTFilePolicies.
        /// </summary>
        public virtual IPSTFilePolicies PSTFilePolicies { get; private set; }

        /// <summary>
        /// Gets the ISPConnection.
        /// </summary>
        public virtual ISPConnection SPConnection { get; private set; }
        ...
        /// </summary>
        public virtual IPlanGroups PlanGroups { get; private set; }

        /// <summary>
        /// Gets the IPlanGroup.
        /// </summary>
        public virtual IPlanGroup PlanGroup { get; private set; }

        /// <summary>
        /// Gets the IPlanGroupById.
        /// </summary>
        public virtual IPlanGroupById PlanGroupById { get; private set; }

        /// <summary>
        /// Gets the IJobsByPlanGroup.
        /// </summary>
        public virtual IJobsByPlanGroup JobsByPlanGroup { get; private set; }
        ...
        private void Initialize()
        {
            ...
            DropboxConnection = new DropboxConnection(this);
            DropboxJobs = new DropboxJobs(this);
            DropboxJob = new DropboxJob(this);
            DropboxPlan = new DropboxPlan(this);
            DropboxJobsByPlan = new DropboxJobsByPlan(this);
            DropboxJobByPlan = new DropboxJobByPlan(this);
            DropboxPolicy = new DropboxPolicy(this);
            ...
            ExchangeDistributionGroupPlan = new ExchangeDistributionGroupPlan(this);
            ExchangePolicies = new ExchangePolicies(this);
            ExchangeServiceProvider = new ExchangeServiceProvider(this);
            ...
            GoogleGroupPlan = new GoogleGroupPlan(this);
            ...
            PSTFileJobs = new PSTFileJobs(this);
            PSTFileJob = new PSTFileJob(this);
            PSTFilePlans = new PSTFilePlans(this);
            PSTFilePlan = new PSTFilePlan(this);
            PSTFileJobsByPlan = new PSTFileJobsByPlan(this);
            PSTFileJobByPlan = new PSTFileJobByPlan(this);
            PSTFilePolicies = new PSTFilePolicies(this);
            SPConnection = new SPConnection(this);
            ...
            PlanGroups = new PlanGroups(this);
            PlanGroup = new PlanGroup(this);
            PlanGroupById = new PlanGroupById(this);
            JobsByPlanGroup = new JobsByPlanGroup(this);
