...
namespace AvePoint.PowerShell.FLYMigration
{
    ...
    /// </summary>
    public partial interface IExchangeJob
    {
        /// <summary>
        ...
        /// </exception>
        Task<HttpOperationResponse<ServiceResponseString>> RestartWithHttpMessagesAsync(string id, ExchangeJobExecutionModel settings, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
