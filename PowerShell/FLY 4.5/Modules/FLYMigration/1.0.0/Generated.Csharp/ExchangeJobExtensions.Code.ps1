...
namespace AvePoint.PowerShell.FLYMigration
{
    ...
    public static partial class ExchangeJobExtensions
    {
            ...
            /// </param>
            public static ServiceResponseStatusResultModel Remove(this IExchangeJob operations, string id)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ServiceResponseStatusResultModel> RemoveAsync(this IExchangeJob operations, string id, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static ServiceResponseStatusResultModel Stop(this IExchangeJob operations, string id)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ServiceResponseStatusResultModel> StopAsync(this IExchangeJob operations, string id, CancellationToken cancellationToken = default(CancellationToken))
            {
