...
namespace AvePoint.PowerShell.FLYMigration
{
    ...
    /// BoxJob operations.
    /// </summary>
    public partial interface IBoxJob
    {
        /// <summary>
        ...
        /// </exception>
        Task<HttpOperationResponse<ServiceResponseString>> RestartWithHttpMessagesAsync(string id, BoxJobExecutionModel setting, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
