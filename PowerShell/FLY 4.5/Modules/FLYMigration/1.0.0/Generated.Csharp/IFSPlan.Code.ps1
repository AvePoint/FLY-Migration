...
namespace AvePoint.PowerShell.FLYMigration
{
    ...
    /// FSPlan operations.
    /// </summary>
    public partial interface IFSPlan
    {
        /// <summary>
        /// Create a new plan
        /// </summary>
        ...
        /// </exception>
        Task<HttpOperationResponse<ServiceResponsePlanSummaryModel>> AddWithHttpMessagesAsync(FSPlanModel planSettings, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
