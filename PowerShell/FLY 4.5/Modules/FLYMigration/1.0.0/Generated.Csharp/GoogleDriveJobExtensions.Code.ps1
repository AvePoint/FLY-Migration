...
namespace AvePoint.PowerShell.FLYMigration
{
    ...
    public static partial class GoogleDriveJobExtensions
    {
            ...
            /// </param>
            public static ServiceResponseString Restart(this IGoogleDriveJob operations, string id, GoogleDriveJobExecutionModel setting)
            {
            ...
            /// </param>
            public static async Task<ServiceResponseString> RestartAsync(this IGoogleDriveJob operations, string id, GoogleDriveJobExecutionModel setting, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static ServiceResponseStatusResultModel Remove(this IGoogleDriveJob operations, string id)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ServiceResponseStatusResultModel> RemoveAsync(this IGoogleDriveJob operations, string id, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static ServiceResponseStatusResultModel Stop(this IGoogleDriveJob operations, string id)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ServiceResponseStatusResultModel> StopAsync(this IGoogleDriveJob operations, string id, CancellationToken cancellationToken = default(CancellationToken))
            {
