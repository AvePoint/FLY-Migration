...
namespace AvePoint.PowerShell.FLYMigration
{
    ...
    public static partial class Office365GroupPlanExtensions
    {
            ...
            /// </param>
            public static ServiceResponseStatusResultModel Remove(this IOffice365GroupPlan operations, string id)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ServiceResponseStatusResultModel> RemoveAsync(this IOffice365GroupPlan operations, string id, CancellationToken cancellationToken = default(CancellationToken))
            {
