...
namespace AvePoint.PowerShell.FLYMigration
{
    ...
    /// </summary>
    public partial interface ISlackPlan
    {
        /// <summary>
        /// Get all plans
        /// </summary>
        ...
        /// </exception>
        Task<HttpOperationResponse<ServiceResponsePlanSummaryModel>> AddWithHttpMessagesAsync(SlackPlanModel plan, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
