...
namespace AvePoint.PowerShell.FLYMigration
{
    ...
    /// SlackJob operations.
    /// </summary>
    public partial interface ISlackJob
    {
        /// <summary>
        ...
        /// </exception>
        Task<HttpOperationResponse<ServiceResponseString>> RestartWithHttpMessagesAsync(string id, SlackJobExecutionModel settings, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
