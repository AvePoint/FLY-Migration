...
namespace AvePoint.PowerShell.FLYMigration
{
    ...
    /// </summary>
    public partial interface IPSTFileJob
    {
        /// <summary>
        ...
        /// </exception>
        Task<HttpOperationResponse<ServiceResponseString>> RestartWithHttpMessagesAsync(string id, PSTFileJobExecutionModel settings, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
