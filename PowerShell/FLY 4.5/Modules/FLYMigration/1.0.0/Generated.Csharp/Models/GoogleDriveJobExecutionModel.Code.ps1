...
namespace AvePoint.PowerShell.FLYMigration.Models
{
    ...
    public partial class GoogleDriveJobExecutionModel
    {
        /// <summary>
        /// Initializes a new instance of the GoogleDriveJobExecutionModel
        /// class.
        /// </summary>
        public GoogleDriveJobExecutionModel()
        {
            CustomInit();
        }
        ...
        public GoogleDriveJobExecutionModel(string migrationType, System.DateTime? startTime = default(System.DateTime?))
        {
