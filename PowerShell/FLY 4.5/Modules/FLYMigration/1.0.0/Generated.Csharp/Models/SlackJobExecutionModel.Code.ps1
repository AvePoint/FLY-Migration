...
namespace AvePoint.PowerShell.FLYMigration.Models
{
    ...
    public partial class SlackJobExecutionModel
    {
        /// <summary>
        /// Initializes a new instance of the SlackJobExecutionModel class.
        /// </summary>
        public SlackJobExecutionModel()
        {
            CustomInit();
        }
        ...
        public SlackJobExecutionModel(string migrationType, System.DateTime? startTime = default(System.DateTime?))
        {
