...
namespace AvePoint.PowerShell.FLYMigration.Models
{
    ...
    public partial class ScheduleDetailsModel
    {
        /// <summary>
        /// Initializes a new instance of the ScheduleDetailsModel class.
        /// </summary>
        ...
        /// 2018-11-01T13:15:30Z corresponds the same instant and "Z" reprents
        /// time in UTC(Coordinated Universal Time)</param>
        public ScheduleDetailsModel(string intervalType, string startTime, int? interval = default(int?), string endType = default(string), int? occurrencesValue = default(int?), string endTime = default(string))
        {
