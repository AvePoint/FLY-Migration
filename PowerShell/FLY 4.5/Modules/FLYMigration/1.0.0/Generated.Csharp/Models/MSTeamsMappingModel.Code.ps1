...
namespace AvePoint.PowerShell.FLYMigration.Models
{
    ...
    public partial class MSTeamsMappingModel
    {
        /// <summary>
        /// Initializes a new instance of the MSTeamsMappingModel class.
        /// </summary>
        public MSTeamsMappingModel()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the MSTeamsMappingModel class.
        /// </summary>
        public MSTeamsMappingModel(string sourceConnectionId, string destinationConnectionId, IList<MSTeamsMappingContentModel> contents)
        {
        ...
        public IList<MSTeamsMappingContentModel> Contents { get; set; }
