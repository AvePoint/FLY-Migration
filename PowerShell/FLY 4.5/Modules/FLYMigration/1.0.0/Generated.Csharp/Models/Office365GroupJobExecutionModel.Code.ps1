...
namespace AvePoint.PowerShell.FLYMigration.Models
{
    ...
    public partial class Office365GroupJobExecutionModel
    {
        /// <summary>
        /// Initializes a new instance of the Office365GroupJobExecutionModel
        /// class.
        /// </summary>
        public Office365GroupJobExecutionModel()
        {
            CustomInit();
        }
        ...
        /// "GroupsOnly" : Migrate Groups without their mailboxes and
        /// SharePoint data. Possible values include: 'Incremental', 'Full',
        /// 'GroupsOnly'</param>
        ...
        public Office365GroupJobExecutionModel(string migrationType, System.DateTime? startTime = default(System.DateTime?))
        {
