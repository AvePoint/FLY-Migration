...
namespace AvePoint.PowerShell.FLYMigration.Models
{
    ...
    public partial class GoogleGroupPlanSettingsModel
    {
        /// <summary>
        /// Initializes a new instance of the GoogleGroupPlanSettingsModel
        /// class.
        /// </summary>
        public GoogleGroupPlanSettingsModel()
        {
            CustomInit();
        }
        ...
        public GoogleGroupPlanSettingsModel(PlanNameLabel nameLabel, string policyId = default(string), string databaseId = default(string), SimpleSchedule schedule = default(SimpleSchedule), IList<string> planGroups = default(IList<string>))
        {
            NameLabel = nameLabel;
            PolicyId = policyId;
