...
namespace AvePoint.PowerShell.FLYMigration.Models
{
    ...
    public partial class BoxJobExecutionModel
    {
        /// <summary>
        /// Initializes a new instance of the BoxJobExecutionModel class.
        /// </summary>
        public BoxJobExecutionModel()
        {
            CustomInit();
        }
        ...
        public BoxJobExecutionModel(string migrationType, System.DateTime? startTime = default(System.DateTime?))
        {
