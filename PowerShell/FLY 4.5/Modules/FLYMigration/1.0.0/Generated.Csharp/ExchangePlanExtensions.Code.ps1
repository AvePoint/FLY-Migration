...
namespace AvePoint.PowerShell.FLYMigration
{
    ...
    public static partial class ExchangePlanExtensions
    {
            ...
            /// </param>
            public static ServiceResponseStatusResultModel Remove(this IExchangePlan operations, string id)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ServiceResponseStatusResultModel> RemoveAsync(this IExchangePlan operations, string id, CancellationToken cancellationToken = default(CancellationToken))
            {
