...
namespace AvePoint.PowerShell.FLYMigration
{
    ...
    public static partial class SPJobExtensions
    {
            ...
            /// </param>
            public static ServiceResponseString Restart(this ISPJob operations, string id, SharePointJobExecutionModel settings)
            {
            ...
            /// </param>
            public static async Task<ServiceResponseString> RestartAsync(this ISPJob operations, string id, SharePointJobExecutionModel settings, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static ServiceResponseStatusResultModel Remove(this ISPJob operations, string id)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ServiceResponseStatusResultModel> RemoveAsync(this ISPJob operations, string id, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static ServiceResponseStatusResultModel Stop(this ISPJob operations, string id)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ServiceResponseStatusResultModel> StopAsync(this ISPJob operations, string id, CancellationToken cancellationToken = default(CancellationToken))
            {
