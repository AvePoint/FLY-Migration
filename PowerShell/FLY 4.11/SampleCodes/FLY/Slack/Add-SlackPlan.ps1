...
Try
{
    ...
    # For example: 
	# $DestinationMapping1 = New-SlackMigrationMSTeamsObject -Mailbox 'Team01@contoso.onmicrosoft.com' -Name 'teams name1' -Channel 'General' -DestinationChannelType Public
	# $DestinationMapping2 = New-SlackMigrationMSTeamsObject -Mailbox 'Team02@contoso.onmicrosoft.com' -Name 'teams name2' -Channel 'Channel 03' -DestinationChannelType Private
# $DestinationMapping2 = New-SlackMigrationMSTeamsObject -Mailbox 'Team02@contoso.onmicrosoft.com' -Name 'teams name2' -Channel 'Channel 04' -DestinationChannelType Shared
    $DestinationMapping1 = New-SlackMigrationMSTeamsObject -Mailbox '' -Name '' -Channel 'General' -DestinationChannelType Public
	$DestinationMapping2 = New-SlackMigrationMSTeamsObject -Mailbox '' -Name '' -Channel 'Channel 03' -DestinationChannelType Private
    $DestinationMapping3 = New-SlackMigrationMSTeamsObject -Mailbox '' -Name '' -Channel 'Channel 04' -DestinationChannelType Shared
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU31FO0KI5P0g+bOfj3hI0mhAY
# u4aggiKkMIIFLTCCBBWgAwIBAgIQAybM8QJy2GqRSHGucYhV3TANBgkqhkiG9w0B
...
# AQkEMRYEFJRDePtmDqnEBx7DtwXh48lW7BHrMA0GCSqGSIb3DQEBAQUABIIBAK1D
# +KEkKr9fT0bw6RHVrscm/OXIl/rxzdJ+02x2Yzqs3d8jAzM4jnzfSHfGilr/lFXk
# W2uy/wZ5bF26Lw0VNraMpviStlGOwk8DMEAVzWQI3Xz3b94NcC1czsAc5TjT3vNR
# TaVrNc/SRhYPHV1zVtgd50Ndwz03YINNq59m96VPA0nIBmWGJL6nfMWcnn5RAkd5
# gGNgB48pkAubixEjKLs5u5H4d2Fh0/geJGEE+YeAHjVs74iyBx5dsPTd806q9sMM
# QRJK1Sz6QRvece/jf8plqwT1hFgcIVrZmOxYugkNBuTtIQ67Qm28IbMUJJfpJZdJ
# llDpnkkNqdv4a1tZ6tahggMgMIIDHAYJKoZIhvcNAQkGMYIDDTCCAwkCAQEwdzBj
# MQswCQYDVQQGEwJVUzEXMBUGA1UEChMORGlnaUNlcnQsIEluYy4xOzA5BgNVBAMT
# MkRpZ2lDZXJ0IFRydXN0ZWQgRzQgUlNBNDA5NiBTSEEyNTYgVGltZVN0YW1waW5n
# IENBAhAMTWlyS5T6PCpKPSkHgD1aMA0GCWCGSAFlAwQCAQUAoGkwGAYJKoZIhvcN
# AQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwMjIwMDIyNzAxWjAv
# BgkqhkiG9w0BCQQxIgQgwGEZnYn6DU5alz1vtjwtRXsFQaoWEYBMPzaqGC79hPMw
# DQYJKoZIhvcNAQEBBQAEggIAg25RIiyBsgheA0TCMIE/6SHuRUrADj9QzkmOvVPZ
# sXAqWxAhXvMTPjgV62KyNlkd1CP9TC1ZKzvMye4RguJjC8yqTGDcltanCNd2zvc5
# cwy+Fm8hWfs0uxYcPVyIJgCRIg1owhJn7vMKwZ2vvhdoCDzKiaXSqDKSn339JMRt
# 5/jv2NKYK6nYAoMQC7unSOf6xNaMTJKReJNfjSqLtBR9UpPZhMIHMvy5q7jZ6L/j
# q9qcrQ8Dss3Vh6dUQ901m2eSFxiV/jsQPY7K1mf9IZTf+9LW94ff5PiAkDkkUcg5
# kXDOnjBjfrzsWp0OoiL1rf9UNGr7CbmS8265EihNC8XnzTromqc3nbXGuubO0WwK
# YXC1n7fxqr6SLkCUP7Xv6Zh3JOfmo4aVbZdw5TbNput8qtHUInx+ZewHQ2QQjQhs
# 8q3PFmyaBb1a/fIki1WmRf8nHeIpxr0neAWuogzUDz9H422N6SDzkwi1bxioIXdQ
# wtkVelnJjLNbZchEc8/t3gy1vBsVaZgYl9jTwmyPGwmrweswVOZEwsKbJmklHWCX
# idu0eDOXEo7vgGNVP4o05v0x9Zj4cKRgulpQ8yI5WYqxHkd0m7Be0Eid8sDUNxGf
# Nps0COecV5fbazK66oIS6iipoCnHugLJEySXM91G2nRnnW8FCcWfnMzEi+T7qZm+
# mSc=
