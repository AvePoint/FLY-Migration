...
try
{
    ...
    $Mappings = New-FSMappingObject -SourceConnectionId $SourceServiceAccount -SourceCredential $SourceCredential -DestinationConnectionId $SharePointConnection -Contents @($MappingContent1,$MappingContent2,$MappingContent3,$MappingContent4) -SourceAgents $SourceAgents
    ...
    $PlanSettings = New-FSPlanSettingsObject -MigrationMode HighSpeed -DatabaseId $Database -PolicyId $Policy -Schedule $Schedule -DisplayName $PlanName -PlanGroups $PlanGroups
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU4Z/JWNdMKwWEElwUNUXiAY0g
# AXSggiKkMIIFLTCCBBWgAwIBAgIQAybM8QJy2GqRSHGucYhV3TANBgkqhkiG9w0B
...
# AQkEMRYEFJdNAL0Yr6E6ttyM/CHX5BaiBfTaMA0GCSqGSIb3DQEBAQUABIIBABu2
# fVpbdxmiYegs8ONH6z+E2w76KGO6WhVLSpWfglati3l9PncffboTcFbhDxmlo0K0
# 4Rg4gvXBPlGdNwhFbaEdbQhG3evQ7RiqrLK9ikm5S2JEZBzbPrRkyflNyavs3vKY
# bTcshIg1CuEqNc2Mw6zoqOXw8ZzOQLAw7EeABOA4bSz9SznuCsvDSe8UG1JZpDYJ
# HAh9ztpdCBpJXGlG9I/T0JHr92ut8S2Da8QQhYP5mndVtLbpkD9N6NOHMJd8rqQO
# XyzfM0n78dONJoRsYR9sQZLAvIorbpLDgAUCa5ti75J1/1Iw5WOchRrh2CbtjCgc
# E/O1buazvI89ih6ZbxahggMgMIIDHAYJKoZIhvcNAQkGMYIDDTCCAwkCAQEwdzBj
...
# BgkqhkiG9w0BCQQxIgQgMUEWy8pvfqnLx8ltnkhBmJm22KjNJ4DL5Tz16oyx/Wsw
# DQYJKoZIhvcNAQEBBQAEggIARP05Np+qGAE/ePYOXxWs4WJCc40stX9JGM/A0gyx
# jFxtjsfoA6CNoZOVxZi6noTUNYAeiXKdT9/qbyj/YYgO7NC7gFhKgW8tpUdA0FVL
# Sm05+nyjujYMtNL1tHKcla+8gsJEszEKZ7jyhONpz8n2ZbTSud3qqNLqNgWfmvNf
# jupBbxnA3XzZVkvSapY9XU7XjyFUX23F9IYTCgMtfXqmpMd1HPsp+WEX3A/neECp
# kFL+R2v09Hpa4sXjpkpPBM5QB56VL7KzMh/hQFyhLeYLh2TDjnCmNJpec7ALsPuF
# J49uSU30itO6pUiGcCN3MqNfvrQYgEhh+Qy1j/1wabEEXiTEKSLUYGrkMsVZ/Ex6
# 3VhE/U1+DL9zEwC0tbYWAzAwbiDHhY4W5kmJs1XlDD393D9VegU0UORfLUH2x3ev
# ZpKcas640+rWUrGe/R1SEKHIg+Gza1KRxcbJpfe/2JyJM1i3rzrJGi/2MMddUwy/
# bxCYbpgkD7rzA7aYtnHp0MlztSjY5qWPOKadfexl6kl/+Iga86lyYA/emziDLMrX
# lUMT5W+NggPkjZ0IVFkTqujpTmsYEgZQ4H/BLL+TBCqJTguBn+fZgsRnAZRwsAcE
# iH8Mrcueq8jBv0qecZD/wzu3zN0txtXKY2TpnagumDj3xto0WBc5fZCUmhrEXLdx
# OLM=
