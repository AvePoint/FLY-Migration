...
GUID = '6489d484-bfed-4196-bf81-3713ac2ea82f'
...
FunctionsToExport = 'Start-GoogleDriveJobByPlan', 'Add-ExchangeDistributionGroupPlan', 
               'Get-PublicFolder', 'Remove-GmailJob', 'Add-FileSystemPreMigration', 
               'Stop-PSTFileJob', 'Get-PublicFolderConnection', 'Remove-SlackPlan', 
               ...
               'Add-PlanGroup', 'Add-Office365GroupPreMigration', 
               ...
               'Get-SPConnection', 'Remove-PSTFilePlan', 'Find-ExchangeJobsByPlan', 
               'Start-GmailJobByPlan', 'Get-PSTFilePlan', 'Start-SlackJobByPlan', 
               'Complete-MicrosoftTeamsPlan', 'Remove-GoogleDriveJob', 'Get-FSJob', 
               'Get-ExchangePlan', 'Get-MicrosoftTeamsChatJob', 'Remove-SlackJob', 
               ...
               'Add-SharePointPreMigration', 'Add-IMAPPOP3Plan', 
               'Find-DropboxJobsByPlan', 'Get-Office365GroupPlan', 'Stop-SPJob', 
               'Find-SPJobsByPlan', 'Get-PSTFilePolicy', 'Update-PublicFolderPlan', 
               'Start-DropboxJobByPlan', 'Restart-FSJob', 'Get-IMAPPOP3Jobs', 
               'Add-FSPlan', 'Get-MicrosoftTeamsChatPolicy', 'Get-Account', 
               'Get-BoxJob', 'Find-Office365GroupJobsByPlan', 'Get-DropboxPolicy', 
               'Update-GmailPlan', 'Get-MicrosoftTeamsChatConnection', 
               'Get-SlackConnection', 'Stop-DropboxJob', 'Find-BoxJobsByPlan', 
               'Get-GoogleDriveConnection', 'Restart-MicrosoftTeamsChatJob', 
               'Stop-FSJob', 'Add-GoogleGroupPlan', 'Remove-Office365GroupJob', 
               'Get-FSPolicy', 'Add-PublicFolderPreMigration', 'Get-BoxPlan', 
               'Restart-BoxJob', 'Get-DropboxJob', 'Remove-GoogleDrivePlan', 
               'Start-IMAPPOP3JobByPlan', 'Start-MicrosoftTeamsChatJobByPlan', 
               'Find-GoogleDriveJobsByPlan', 'Get-GmailPolicy', 
               'Update-MicrosoftTeamsPlan', 'Get-PlanGroup', 'Add-SPConnection', 
               'Remove-PSTFileJob', 'Remove-PublicFolderJob', 'Get-SPPlan', 
               'Get-SlackJob', 'Start-Office365GroupJobByPlan', 'Get-Database', 
               'Remove-SPPlan', 'Add-SlackPlan', 'Update-SlackPlan', 
               'Update-IMAPPOP3Plan', 'Get-ExchangeConnection', 'Get-ExchangeJob', 
               'Add-GmailPreMigration', 'Remove-DropboxJob', 'Get-MicrosoftTeamsJob', 
               'Restart-MicrosoftTeamsJob', 'Add-GoogleDrivePreMigration', 
               'Add-BoxPreMigration', 'Remove-BoxPlan', 'Get-AppProfile', 
               'Add-ExchangePlan', 'Get-MicrosoftTeamsConnection', 
               'Add-MicrosoftTeamsPlan', 'Get-PSTFileJob', 'Update-SPConnection', 
               'Restart-SPJob', 'Get-PlanGroupById', 'Get-MicrosoftTeamsChatPlan', 
               ...
               'Restart-IMAPPOP3Job', 'Restart-PublicFolder', 
               'Find-MicrosoftTeamsJobsByPlan', 'Add-SPPlan', 'Update-ExchangePlan', 
               'Find-SlackJobsByPlan', 'Add-GmailPlan', 
               'Remove-MicrosoftTeamsChatJob', 'Find-MicrosoftTeamsChatJobsByPlan', 
               'Start-BoxJobByPlan', 'Update-PSTFilePlan', 
               'Search-ExchangeServiceProvider', 'Get-SlackPlan', 'Stop-GmailJob', 
               'Get-FSConnection', 'Stop-GoogleDriveJob', 'Stop-PlanGroup', 
               'Get-ExchangePolicy', 'Start-JobsByPlanGroup', 'Remove-FSPlan', 
               'Stop-MicrosoftTeamsChatJob', 'Add-Office365GroupPlan', 
               'Add-TeamsChatPreMigration', 'Get-FSPlan', 'Add-PSTFilePlan', 
               ...
               'Add-DropboxPlan', 'Get-GoogleDrivePlan', 'Get-GoogleDrivePolicy', 
               'Remove-ExchangeJob', 'Remove-IMAPPOP3Job', 'Get-IMAPPOP3Policy', 
               'Start-PreMigration', 'Get-SlackPolicy', 'Restart-ExchangeJob', 
               'Stop-PublicFolderJob', 'Get-SPJob', 'Find-PSTFileJobsByPlan', 
               'Find-PublicFolderJobsByPlan', 'Get-IMAPPOP3Plan', 
               'Update-Office365GroupPlan', 'Remove-MicrosoftTeamsChatPlan', 
               'Get-GmailPlan', 'Update-GoogleGroupPlan', 'Get-SPPolicy', 
               ...
               'New-TeamsChatPreMappingObject', 'New-FSPathObject', 
               'New-SharePointMappingContentObject', 'New-UpdateFSPlanObject', 
               ...
               'New-PSTFileJobExecutionObject', 'New-PlanGroupExecutionObject', 
