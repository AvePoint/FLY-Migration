...
.PARAMETER Contents
    The File System plan mapping conetent
The Contents parameter is an array object of type FSMappingContent
{AvePoint.Migration.Api.Models.FSMappingContent}

.PARAMETER SourceAgents
    The File System plan run source agent
The SourceAgents parameter is an array object of type String

.PARAMETER DestinationConnectionId
    The File System plan destination connection id or name

.PARAMETER SourceCredential
    The File System plan source credential
{AvePoint.Migration.Api.Models.Credential}

.PARAMETER SourceConnectionId
    The File System plan source connection id or name

.PARAMETER DestinationType
    Destination type
The Contents parameter is an enum of type DestinationType
{AvePoint.Migration.Api.Models.FSMappingModel.DestinationType}
...
function New-FSMappingObject
{
    param(    
        ...
        [Parameter(Mandatory = $false)]
        [AvePoint.PowerShell.FLYMigration.Models.Credential]
        $SourceCredential,
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDlj0AMcScIjt9u
# 6RecudyKFJcj3gaZAFpbZLLUeWDO8aCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCCUYM0lpAxv53myzLSuO3NNOCm1XRQNMuvAvmI3ylH/1zANBgkq
# hkiG9w0BAQEFAASCAYCilxX2SQr5/+9P+roPs562JX+sNrbCSKapqkOJC0uAfTA/
# qsCLPs1Gz+466kq8dWPGtamq5mJIWRVetoIdKh5T0is4rRVrW1isQEnO06KT9ZzJ
# QnR8KcFAKNJsuQg0MlYmRy8YTMTsSU2D5/Z370f76pwANa0OmD1ZbqP1WJNx3wzv
# skho/Ib2+8I63Zfwu2+D7KjmzywWgUNt+DrcDwSWSnICxqa4UKYijHaNq9lgNmwT
# lXnJNj2wgEbi++9+SEXFqQNok2Cd1qbHveA8s08lYVQIwNevUwN9ytDgVvXH4v9O
# laG7jVQzLRD3Sjs6vYS80tJkDc1snuMxngZlzUKWHAX9kwcpCtt4yaINlee4IkMQ
# MhB6lSZS8H+oqxN32aBFE7pTHd3t6C1zHsmHbb5Ce6Ua4eYFapQaIxKe/hZVuft6
# ikI7yScle31Az3et1aHIgOMb112/E5QjxqUA6OsEWeCo89Uw8xb6vKEWMdnjEgJa
# uS1EwJ0Gwb57204x8N2hghc6MIIXNgYKKwYBBAGCNwMDATGCFyYwghciBgkqhkiG
# 9w0BBwKgghcTMIIXDwIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEE
# oGkEZzBlAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQg2X9OpJZAD9c1
# JKhrLIaVvQgF0RD1wPPJN82/ATavcq8CEQDqn7p2SXWXQJMCTL6AeMPoGA8yMDI1
# MDUyMzA3MTcyNVqgghMDMIIGvDCCBKSgAwIBAgIQC65mvFq6f5WHxvnpBOMzBDAN
...
# 9w0BCQMxDQYLKoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI1MDUyMzA3MTcy
# NVowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQU29OF7mLb0j575PZxSFCHJNWGW0Uw
# LwYJKoZIhvcNAQkEMSIEIBInhW91yue0UsAJATbWmsdryCuBiWgqThWXBWIg6230
# MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIHZ2n6jyYy8fQws6IzCu1lZ1/tdz2wXW
# ZbkFk5hDj5rbMA0GCSqGSIb3DQEBAQUABIICAEdf96Y+mUVYAVmE2sQM1W33SE2u
# 0CB6GX3+FXJsD3d9fV20JaOMZbACANAPsL2JvWg7nT+GMOCFl89wskJlpsM3o0Yu
# ofrOZXvGV/cnNq8LHAhP6bwcXTjmX0X/VWe/u7vCVVrZKPFkMcPZURhYDqJL1qmL
# rsxaKLOeiaqzzCk7+uP3O1tEc8w+aXUm49mUPVmISG8EMSA3vNe5EFbFBdHay6jO
# wbO12ElHbHvoSE4nfybLid5Sp2A7CCPQKtN7OBI8obQewEselq+DcErmPXJSmKXT
# 1GljlEFGNVNYeJoioATWsME9tq9rwvH6FXM5eXnrXsJA+candTKWiIQmfZ7gFbmt
# vp9AxhH4O0cUx4HDSh+/HmWOaQfmOFOC+kUB/Cqscowu8njTi8aED7+fyTWVDu//
# C36gUB0diAMFmwmPHEHG3y353BU/0MSKnR54rJz1bJscrhQMmdnuLt0SODR5RNIr
# uQTHGkvJvHU1PK0eQ3sceqb53F7E7FWsVhYjc3XO5/85zzT0O40W4ia+OvmmRTTL
# 8VpITavWNV31STFzi6mOoXaekyCDRDfcn9KHTj1cPwwPEpAI2A/k6tXN4uA3iZQv
# 87E/xH0K7EMAJdo1cyG1vw8TY83nU5xCEfMFgzgdVV72B/IPXQJEEa7P+5SepbDd
# hwuxSijpaAAOdkhO
