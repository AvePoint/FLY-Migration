...
.PARAMETER ConversationsMigrationAsHTML
    Conversations will be migrated as an HTML file and stored in destination channel folder. 
{AvePoint.Migration.Api.Models.ConversationsMigrationSettings}
...
.PARAMETER DatabaseId
    the id or name of migration database

.PARAMETER PlanGroups
    the group id or name of migration group

.PARAMETER DisablePlanGroup
    disable the already set the plan group

.PARAMETER DisableMigrationDatabase
    disable the already set the migration database

.PARAMETER DisableSchedule
    disable the already set the schedule

.PARAMETER DisplayName
    generated plan name

.PARAMETER ConversationsMigrationAsMessages
    To migrate conversations as messages, make sure a service account is configured in the destination connection.
{AvePoint.Migration.Api.Models.ConversationsMigrationSettings}

.PARAMETER MigrateAsHTML
    Whether to migrate Teams html

.PARAMETER MultigeoTenant
    If you select the option, the Teams will be created in the destination central location by default. You can also select your desired location to create the Teams in that location. Note that this function does not support creating Class or PLC Teams of Microsoft Education tenants.
{AvePoint.Migration.Api.Models.MultigeoTenantModel}

.PARAMETER OnlyMigrateDocumentsLibrary
    Whether to migrate only document libraries for the source team in the migration

.PARAMETER NewName
    new name for the update plan

.PARAMETER MigrateAsMessage
    Whether to migrate Teams message

.PARAMETER PolicyId
    the id or name of migration policy

.PARAMETER Schedule
    the schedule for the migration

.PARAMETER Migrate365GroupMailbox
    Whether to migrate Teams group mailbox
...
function New-UpdateMSTeamsPlanObject
{
    param(    
        ...
        [Parameter(Mandatory = $true)]
        [AvePoint.PowerShell.FLYMigration.Models.ConversationsMigrationSettings]
        $ConversationsMigrationAsMessages,
        ...
        [Parameter(Mandatory = $false)]
        [AvePoint.PowerShell.FLYMigration.Models.MultigeoTenantModel]
        $MultigeoTenant,
    ...
    $Object = New-Object -TypeName AvePoint.PowerShell.FLYMigration.Models.UpdateMSTeamsPlanModel
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBdrhsOrnoBg3PT
# 45/uPK0RbRySxMVvEzY5Tz/I2xbndaCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCAHrCL7LHPIQa+JjPtdE7Ug36lCP7JqUqv8t3h/chkoPTANBgkq
# hkiG9w0BAQEFAASCAYCaA6/BV7UiFR51OFGEfqA0CC6flUrLTTMJh99/218LjAOv
# 8VbEZEAAEyy2yCHg59wtyk4eerpfJMhteZF7t9lmkecBvRbbai/xH82Awd88VKHR
# CXdf/Y6UgFy+PA80ABvP6Kwg42tppkvkSgfPbQRfDc8ASHE4f26ioNqoFgg0MX4k
# kpiJs905KWqCkASvRPxxUSUXPYJpBSOg5WufbJxoksRTv6pjRLHh5ucrHND2NuTB
# nQCLkCenq3SI4ve/Ef88OOrGbo68NzUD1B1tJ838mWmAlzMcudCtT6NzEQFeOE1T
# tO12rdxa3SRKoA23VM+93qHikGeXolf+XZF/6VdIIntr+iNzOKjh87OyEsukRS6Y
# Rcrla+/Pa0QQBTN6PUCF7CwkIWMywNbw3ZHJf7cSxeXdALQBG5UnEoOUefcf0+Xt
# qGWAKlevdKrEDi5Rg2XHHyoEPVhoAMaj7qosmDvWCUc+7WbyGBO6bhZ7bFlsM9ob
# XnQ8Q4EM6oq7hu/qY0ihghc5MIIXNQYKKwYBBAGCNwMDATGCFyUwghchBgkqhkiG
# 9w0BBwKgghcSMIIXDgIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEE
# oGgEZjBkAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQg7iLlukH1Oj0i
# 0OLioEiA0D7NoLdT/SyamyOdQyQCbRwCEFgR/WfGThBhaZRkbkv3emMYDzIwMjUw
# NTIzMDcxNzQ0WqCCEwMwgga8MIIEpKADAgECAhALrma8Wrp/lYfG+ekE4zMEMA0G
...
# DQEJAzENBgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjUwNTIzMDcxNzQ0
# WjArBgsqhkiG9w0BCRACDDEcMBowGDAWBBTb04XuYtvSPnvk9nFIUIck1YZbRTAv
# BgkqhkiG9w0BCQQxIgQgVBDE2DrTgbDqBlE6LrdvHCGxruhBYcsJ4fZ4OLviDLIw
# NwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZl
# uQWTmEOPmtswDQYJKoZIhvcNAQEBBQAEggIAQrMVl/PKm0OemPZV0UDClG8pQiom
# vlvEcXxELSmEGWEahUfVI5ioy7x7nR7oB1sOJdwa/MXh6y4JVKbbruLgwGCRacOM
# bi+BIM5NKKeL6IISlWJchuFjI+sJdabIF++VMAGCPS1O1IfCw0EnXfC6bDwwTXLY
# Vg5Mai7JYIOURyZHEyArxFC8QeZgMn9tCdnUkyKgPMkh6F1yQN/AOE5Q9ZkUPpCz
# jMHENmRMBitm9qKNTw15AV74afM1febe/7KRVt/0ifi/QlPQkE+zVd/9w2sMHg5Z
# TleoMhpwrUn0zCYcgNv30bkJ42NU0F9uLubEGglFDkSHgXAhWNMYCCf1QaxXTkrO
# c0Z4UjkMTf6odl/orYd85YaGryoGxdw4ogFID1aBaymPDYwbQAU3Dz/VwvLmvCKO
# btCcnfU+f2T0G2DMlBt0iR955c0DaLdr38+S20vslF4aBAZ1nV48BaN0iRJ8AU1/
# uCMSg9TWfrRHOuAyb2VCL/D7ADjTzfYnh1WgGae3TJ3uMBHieuSqBZE20alzYeK4
# d97dLZfnJFv1pVPPSnoKOtb5ITh4fTg5xdwf9/LsWRDIUj81AA1qYQIY7CNr+CaA
# pheziepyZSW9CHJEXIuqhBZXGmZ7a46BbQjgYpnFky+1Ez454zN38h3Dg8Y7/vvw
# 9f6MC0PtTQoSxsc=
