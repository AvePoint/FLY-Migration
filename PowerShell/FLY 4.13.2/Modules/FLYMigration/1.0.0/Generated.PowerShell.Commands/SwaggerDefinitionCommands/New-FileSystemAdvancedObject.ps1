...
.PARAMETER DestinationVersion
    Destination Version
{AvePoint.Migration.Api.Models.FileSystemVersion}

.PARAMETER Agents
    Specify the discovered agents
The Agents is an array object of type String

.PARAMETER ScanFolderSizeAndItemCount
    Only scan folder count, file count, and total size

.PARAMETER SharePointLibraryOrFolderUrl
    SharePoint Library Or Folder Url

#>
function New-FileSystemAdvancedObject
{
    param(    
        [Parameter(Mandatory = $false)]
        [ValidateSet('SharePointOnline', 'SharePoint2019', 'SharePoint2016', 'SharePoint2013')]
        [string]
        $DestinationVersion,
        ...
        [Parameter(Mandatory = $false)]
        [switch]
        $ScanFolderSizeAndItemCount,
    
        [Parameter(Mandatory = $false)]
        [string]
        $SharePointLibraryOrFolderUrl
    )
    
    $Object = New-Object -TypeName AvePoint.PowerShell.FLYMigration.Models.FileSystemAdvanced
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCACr9b4znQCLysb
# VhjnOcKLk874vofqcHBSBheXmqPsXqCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCDTWQxcCbuWUKOs5P3kcw/zFioHovScXG+p9LNBLF7vfDANBgkq
# hkiG9w0BAQEFAASCAYCdb+ZdOta+N+9nGuhmdDjdopgMvomwERedYdbmueaYjcVd
# WBnfm414gN9aJctUfmfnN2mMXjGWxs3OW8cqXzkNNitq9Cj3jjFuJXOB4lH7x1r2
# vRJWN78XBj4CsoCqO6qzleWEOM92oFNK1Xnrwo8cpyPM6mr27tFT6FgDDZ6BEsi6
# tE4pv1U4u9IBWAU0kqIdGduKyclI4evcH2G98iKt9GlBjbKcScf3b5WPQCPQq7bX
# SrtvbpbGjWCo6ft44NRN6YzDje2n2Il5Yg6ENm5P1Zg5AzE1VRpwGWPOy0dieQbz
# OVrfboVJVI5O4BR7s7fJ9HresyQFbZkG2bLI2q0/mjctFINf9YGuIFnNjn6RjUCg
# E8yXfYsFktyNaX6CpueNDx5sXxyY+E8DTOgDLHRuhk1XqRaCAD6aboucNIr2YDu1
# 71BB0ANV5HiJSLkzROoJfKNpt/YceTJxjp74UODcEhcGjVWIZagBbAk0H1V7Or04
# HyvlcBON+v/33Qf26buhghc6MIIXNgYKKwYBBAGCNwMDATGCFyYwghciBgkqhkiG
# 9w0BBwKgghcTMIIXDwIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEE
# oGkEZzBlAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgZJMCXNwvQepp
# bkXR2yVjeTWM/FIdEcqIeJvFcLBv4U4CEQDHCGc+QMtAw/EpOQVRSqmyGA8yMDI1
# MDUyMzA3MTcyNFqgghMDMIIGvDCCBKSgAwIBAgIQC65mvFq6f5WHxvnpBOMzBDAN
...
# LwYJKoZIhvcNAQkEMSIEIF2x8okn5RO14RK31tqHGQW0Mryftj3vnJm+dwSNMS11
# MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIHZ2n6jyYy8fQws6IzCu1lZ1/tdz2wXW
# ZbkFk5hDj5rbMA0GCSqGSIb3DQEBAQUABIICACeqJ4IRNM1XjHa6f6wTFvZFVdKD
# PajAJXd5DaKz4FEHm2bO86gZbRPomMMr3ebK0MzA3Ufyoeb7qSJRZVF1ZPJDBD8V
# 82UnLncYc0zcFvHZdUrkoFxNCuj4N5+boIC89BNtB2LouQiDA6gUcLqW7zOtugiw
# 3KWLQo0EuWE2x+O33hNYmxhcf08G2qGIJvIB4F6HhA5uUA3WrY04O1rj4bFwOLK2
# L1e1uDN6Gqj50F1T+hsbK+SCgB/ejZqctVvh881gc8VSU6f4+hmTABdD8jK6+1oi
# wYgkiH7I9lyvgfsALOxz2A/5FqpqTowcNZMqKchYVjafkPFsEQ9jK4zwjlUuYFwD
# hv5LiaX/8V3/X2Py8k9jqLaVZxN+xAlhpqkbX2W5zE4VIr+ZINcx80cUWal2i/Vq
# KumjZicTkAmccDOUv66TgItYvfaSid31DQSHx8crzan7ixHpcvrik+mdRb7mbaUW
# A+mEXIUTc2CiZA+zLQoAsPWOVbtpLinz1e2mZ/67vCev1F6WPEwkgZJJhwSpQNpX
# paqt/5Alni4NoLULlarzx+Kpvk7GCZwqp779VX8HL5A36r/ZpAnPkCwRd4MHODh/
# otQC2oDCTbYm6DCV8sbzPcxCv2Oh6a01qCN9iGOQ/fM2LRLBJUt+GjoxhTFeYMZw
# pOKl6O7mVZkFDHpA
