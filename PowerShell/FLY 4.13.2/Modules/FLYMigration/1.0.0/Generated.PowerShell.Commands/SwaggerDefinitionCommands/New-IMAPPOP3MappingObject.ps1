...
.PARAMETER Destination
    The IMAPP plan destination mapping
{AvePoint.Migration.Api.Models.ExchangeConnectionModel}

.PARAMETER Contents
    The IMAPP plan mapping contentn
The Contents parameter is an array object of type IMAPPOP3MappingContentModel
{AvePoint.Migration.Api.Models.IMAPPOP3MappingContentModel}

.PARAMETER VerifyMapping
    

.PARAMETER Source
    The IMAPP plan source mapping
{AvePoint.Migration.Api.Models.IMAPPOP3ConnectionModel}

.PARAMETER SourceAgents
    The IMAPP plan source agent
The SourceAgents parameter is an array of type string
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCALYq6RrjXf0h7F
# Mxj+mOWPku0o8HnfZS020zBmfVYlXKCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCBMlVUijiMlZwqqkAXjuiIQ1w1uObYrXrzq/S7npque8DANBgkq
# hkiG9w0BAQEFAASCAYCMCFUhRX229l0BlvoKD0mSi3PWnd+NaVgG3LP46eKzaH4F
# u7rmFvjUkX0ad7x8XEvlg6OxMxQb3xeiyaYBpqxyG15nBlwAvPg7aUNKw8xbrrf1
# WDyBbwWBIaZgGCZhVm3uvQUMae4Near2WvCy7tb0hc0584gbFC24XZHzIoVTBF2Q
# JYs12COlpQgvIUySRaU8/OAy484fJyOVCu9m/A6uAzSS07Os4O3QemE/6B4LA90h
# y+KjloNUyDCRPcKLnetAo4CZXXk3a2mDrL6GYXUjt+L1LgrDJPAl+8uPJ3QNrDeA
# PSbwueePO51mC52OUmNkh6CEizVNYSPJl5F9ME9/w9U9ZvJmMHu0M0S/UisHq/C6
# Giz+5FqgvFmfkY8s1Neo2/YKVbcoprW5qx6s81uaHSnwGnQibvgiAq2IDYyBJO3A
# j1LdF0XVxwZC2W5RMRKCGSPqPCekt0uI4z+LMjyw+9c8l5xBQxRw+igJTSIGU7GB
# +5+2P+f7nbEnh5+Q0q2hghc5MIIXNQYKKwYBBAGCNwMDATGCFyUwghchBgkqhkiG
# 9w0BBwKgghcSMIIXDgIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEE
# oGgEZjBkAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgQvP3aI2+chcE
# GEv3tO5s6QEFw5widNy7BGZ+1GiialoCEBdgh7VN9WeCr+5td2nlIUcYDzIwMjUw
# NTIzMDcxNzMwWqCCEwMwgga8MIIEpKADAgECAhALrma8Wrp/lYfG+ekE4zMEMA0G
...
# DQEJAzENBgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjUwNTIzMDcxNzMw
# WjArBgsqhkiG9w0BCRACDDEcMBowGDAWBBTb04XuYtvSPnvk9nFIUIck1YZbRTAv
# BgkqhkiG9w0BCQQxIgQgXiGkT0YVnJ1//IVnBu8ZL1dYULX6UK7uCt5Z8sy3ACQw
# NwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZl
# uQWTmEOPmtswDQYJKoZIhvcNAQEBBQAEggIAu7gl3luKD0VwxIq3pe/vtZbBq61g
# o5TVrtJ8l8pjyuw7if7Im48z+CyJjMqLaqLGxvVn6jKAuGS6jYFBHRJLjQ+C9Dp+
# rBXCnMQV4eAptDTSN7XyEdnw+XgPMQ3YzwvcGiHQU8mQuGtOMMm+bD7G+VjXMLKg
# DCJNLn5dr7CDte7bx8c4aBrvJmTRsQQI//GQhyTGSkzoam/ZUMsEvFeyuf1n5Nh+
# WAzUB2dk566SfivHrKmd/FCJ/+G4WlzaQg8BcpxXIy9OQ2NLs7qN8rZaiWxTVVfe
# /KoR3Iqcy9z+mdFH95L91xM5R7yNE5oRgB5hXCD+WHblICDxrUzllyZoXN5JwEdM
# GBGtGblfFo1ulZQH+yOuu+nb0IGL7/LEps9B3L/Sl5COmagQdUb3zE0PM7DKGMnq
# 4PVNOUFkGmxGfPjCZRNHI40+/pPfcZQVpKJnEt5Tp0h7tBP7uh+lwGznNRUl3Q58
# GQVFMPkEo5PMcq4Xvu8XyVFSSx9xpX1l8yQDfuwhYrsiqAyDpwxC72LZoW1vfgB7
# ri03YAIAG226U8Y2DyI53d7tHbnYooyTxMHxxLe/YzclFvtjXb6lv6aEtR2yaFrs
# Is9WzBInXTqWGCuWqna9zVc6aEJEBiQTIxkZchc9uP+pljTgtlLDOWo8pSRvUeAp
# U9oHKoTyjDuvRR0=
