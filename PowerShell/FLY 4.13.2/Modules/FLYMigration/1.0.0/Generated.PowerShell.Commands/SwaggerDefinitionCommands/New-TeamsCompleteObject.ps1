...
.PARAMETER MigrateSharedChannel
    whether to shared channel

.PARAMETER MigratePrivateChannel
    whether to private channel

.PARAMETER MigrateMembers
    whether to migrate members

.PARAMETER Plans
    Need to run the plan to complete migration
The Plans parameter is an array object of type string

#>
function New-TeamsCompleteObject
{
    param(    
        [Parameter(Mandatory = $false)]
        [switch]
        $MigrateSharedChannel,
    
        [Parameter(Mandatory = $false)]
        [switch]
        $MigratePrivateChannel,
    ...
    $Object = New-Object -TypeName AvePoint.PowerShell.FLYMigration.Models.TeamsCompleteModel
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBlrdapgHk+6z+e
# 42qiFCy7IULE7jl9Kf48N4KpDbQawKCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCAl13fWmNnCvKKeulZxs2Kzb6akgV/a9rdNo4sqeJXiUDANBgkq
# hkiG9w0BAQEFAASCAYB1zOqxducAERzD0UozviZZBnvpMyYmdmbaZ34yHVezscKp
# kntVQWhiB41+Nuv1VJaSQfgtZTUMkLZOmI9f24DVEfht76QYC2S1L9beI1M4X0cM
# 2oc8NHDjwxLTSP8FGso9FwRGv2c47GzRS2ZrjUwUlisrrwbbi/esquyx+yAn/Lvl
# aH4wDavgOX+43JPK1pm/dk6cMNIi8Jh5YHi7ck+lF6xNEuqqpZtOpwmwnX8bXbkK
# 0VM9+4MZl550AWfc5ANYfFRzaMCfPmrrS2tNIQQ25St2qV7kN7qhd8J+oMlyKfdm
# IMpBSKv3zNPdUlLWe/QTBx0YTuUOhC6ysMucTRH7czqXYnMgcpd5q/lBzXtzzh5B
# OJI4/p3FBNCOKCuQLkxGLLMigax0FZM1cqklFt14ypQdhGlVFGmdAwrswFvRFKxC
# v0YRHl6aToKkLvETo5SOnCwdRXJJpy15m9DXs3dFTmttpqYKXNBiLkcTPjvxzw4L
# xND74RzxL1DqtUJKBlWhghc6MIIXNgYKKwYBBAGCNwMDATGCFyYwghciBgkqhkiG
# 9w0BBwKgghcTMIIXDwIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEE
# oGkEZzBlAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgGa7THhZ5kR1I
# GeNhiRPLsL9QPXlMdoCyjuS7DkCmufkCEQDRynyy/rugbwkMrDn+w9phGA8yMDI1
...
# LwYJKoZIhvcNAQkEMSIEIGxKxZCNrjorT0TlZWLbumn9DJf7Vy84dWAIcG0PaFba
# MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIHZ2n6jyYy8fQws6IzCu1lZ1/tdz2wXW
# ZbkFk5hDj5rbMA0GCSqGSIb3DQEBAQUABIICAEusq7WlkluFVYJBguEIukyFckuv
# SBjA7G3Or2gm51UBe/6wJVo1nZGnuhj6QYPREobg1C9TX3vXXIK29A/v94JNQB/8
# ot4k5l+KpmFiIdDH3WQ4eCRQSq/014weW4oA+CromrIUtREcKQqs2LLKhpLuNB+K
# mZl3T6YmeKDMY4aTjD9D24k+PtJmt4aZnALc/Zy4F7KQsi1LS1kBfO86Wy8LkHxd
# XCCMPsiATTcIGFeJ/GH6zKySIPbEkTmwfJqVyvk0X+3b7spZq7mdCxi60T5KGM9I
# W291mXYhZIGSJCqXVSQ43BdlKWvOiBTXEKvQCF6Xb6qz0vPjmhNN8bLXb6QBj2uD
# lvTwtUdKMidRtDp9hL/cU/GQ5GNm3HyW3xQ51awKPFPpsuo6QlJe+I/kcSltTGnC
# slHVhacLSQmEYbZoBQ43lfy1eYyWcSXeFGe9FFa7ZPJpoHupRMuAWXyag3caP+x9
# ZCrWKdUvbzdf1KJOP0kn6jLcdOOC4SZnz1Fvzon47flfk8oUBrbEWpkDHL/KppP5
# 3GFaEwwGk8x0ZtJpkHJLCDLFYzDasTiH5BpdxcY8inqX07p5V0nMtoNbB8q2xnyK
# HZmlAa5LcOlVQbSrqGp16aUhgZmbUpJjBP46WD3kHUOM3/vZXvV1wk+JL3TCVXVt
# 4pY20HUO0Smpj6HA
