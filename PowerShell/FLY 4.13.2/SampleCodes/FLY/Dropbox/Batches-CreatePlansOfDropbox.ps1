	...
	foreach($connection in $connections)
	{
		try{
			...
			foreach($csv in $Csvs)
			{
				...
				$Mappings = New-DropboxPlanMappingObject -SourceConnectionId $sourceConnectionID -DestinationConnectionId $connection."Destination Connection" -Contents $mappingList -DestinationType $DestinationType
				...
				$PlanSettings = New-DropboxPlanSettingsObject -DatabaseId $Database -PolicyId $Policy -DisplayName $PlanNameLabel -Schedule $Schedule -PlanGroups $PlanGroups -MigrateVersions:$MigrateVersions -MigrateLastVersion $MigrateLastVersion
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAml5a00elSUFDP
# oFvZJOjqTpXX52AzYTpR89nxRKgxWKCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCBGuE9RvTgI3TTxaZ4rmfGKkYJ1ywfmXHkLmPh7lk4q9zANBgkq
# hkiG9w0BAQEFAASCAYBx4K0x5TTcN6oocY4hyT+fijW1DFzqbIMKoy8+jVOnf9vE
# zDQfQu7ekzxgYoTwg649CbUf1hC7RFxj3/uTNkxivuv9/8Fnrc5EzXRVyTUm9p3E
# 1YOUU27IXcGsVdzCAHWeXa5UoTvW0+0s5rQGuRvx3hzXBJkw5IBJXxtY4FljawYN
# n5pviovG9meCjF7Ubuf2MEbwLfrYwR9r/t+4kSzgXZ0NMY+m0jPrOQ1w4Oa0/Y4e
# HUw1Bq6O1+IdQTClC3RWydB0Z6cu1Z8V1qiKs4vnxdfYDDozkh+oZKP6ffPRSKoW
# 95CQlb6kdiWi5R28JGlpJ5YXfAriW9EydOVUP3XfDa6sZVbD3fEyKgfuQV9OEPdh
# VpzFKk2o6JttEvqa/0NNK6+ypHrh/AetcrLq5W3OnYlyC/kUkEVf+19yHmzeyZyc
# UE2bfPp8tHtiK5llnM7hdapY3BOIQU8NaE51Kpf7X5Kd6yaqIQ2ciSV9qUVWrZph
# PRHI2DkAOy7SxF6f0Aqhghc5MIIXNQYKKwYBBAGCNwMDATGCFyUwghchBgkqhkiG
# 9w0BBwKgghcSMIIXDgIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEE
# oGgEZjBkAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgrE9L1YE0Ckci
# 01WnNem0W7FuDmqGzYMp+7BDaWXHxcsCEHsTi1+3f2i51DqIODc30k8YDzIwMjUw
# NTIzMDcxODE5WqCCEwMwgga8MIIEpKADAgECAhALrma8Wrp/lYfG+ekE4zMEMA0G
...
# DQEJAzENBgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjUwNTIzMDcxODE5
# WjArBgsqhkiG9w0BCRACDDEcMBowGDAWBBTb04XuYtvSPnvk9nFIUIck1YZbRTAv
# BgkqhkiG9w0BCQQxIgQg72EaIpeQKHmqntTUVBDnN0NpOzO2jsTMDRMvecjZuHsw
# NwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZl
# uQWTmEOPmtswDQYJKoZIhvcNAQEBBQAEggIAItu0qn7bNcI03YTnVS5ctwkupYq5
# 7QGdv1xIPX3fW5NPBH5r6Tmeu5py5pyA5f3+rV3V8qAtNAVdgnMmzlsqW+xU6z9E
# Ku24DPsF6V1VTmTqrsHbtklWsRP4GGlyqjZcg/438xwqO4Z2D3NPjEiS+1U7EGhn
# OYpyp5WmPOgo7uU7vUwVNAEpQjX23F6SbUQW7cZ4p9e+xMSjoYiIUby2Yvc9CiG0
# 4gOhvfW1rqNemYDMSSxoQ8uxzpjhLdvj+MHtVcyBQaGxr0TSBx9wJQlkP3HT4Bah
# gTv1TVdIiuTwHKZ8XWTkd6tJUCqG1JxiCk/CfulQQ4tH0WFSbkENP4rQ0bG4PklK
# GRx9EUUYDg7K12ktpBheaIBDmZKbVl5mthqUZjGtqpCCmxROYhvxcufVa2Un7ZJs
# CZEq8AYOoAaOmBH5keitCkzf1PkTDoowEU/KFVNGdBhH/Sz4KxWwAJdObXgMgUFQ
# Ef6Z8MnMy5+YZWoquyTXX89C24aSRl6YexEcODePDCM8YtXS8GP5d8wQSxCLlKpq
# 4xscA8C7SQge1pl2VMCV7dKr/SEJxNbydHcsTUNJMd6RKeNvuKBPEVVa56Igd2u8
# j4MS1333zUcwgeWbqSC3V+w9TMuQnFlwCkz4bsy+nH91aHajxxxmHRferj1DUzUb
# rs48Ox2wRuc2Xbg=
