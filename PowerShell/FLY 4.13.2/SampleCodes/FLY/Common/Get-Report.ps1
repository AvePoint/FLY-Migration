...
$FolderPath = Join-Path -Path $Path -ChildPath 'Report'
...
try
{
	...
	# For example: $DetailsType = 'XLS or CSV' 
	$DetailsType = ''
	
	# For example: $JobId = @('Job Id1','Job Id2')
	$JobId = @()

	# Select the job detail type to download
	# For example: $FailedOnly = $False/$True
	$FailedOnly = $False
	
	# Do you want to download job logs together with job details
	# For example: $JobLogWithDetails = $False/$True
	$JobLogWithDetails = $False

    $response = Get-Report -APIKey $ApiKey -BaseUri $BaseUri -Type $DetailsType -Id $JobId -FailedOnly $FailedOnly -withLogs $JobLogWithDetails -SavePath $FolderPath
    Write-Host $response.Content | fl
}
Catch
{
   $ErrorMessage = $Error[0]
   Write-Host -ForegroundColor Red $ErrorMessage.ToString()
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAgdKqvyWSxy7Aw
# CD3Vnv+ZNW3jlE79XHWT2ZOnfG/Cs6CCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCC9Hk/gGJzhhAZdSYFamMpR191HdRGMrwCRNMh75IkO7TANBgkq
# hkiG9w0BAQEFAASCAYA5uMvDVGu9gZuw3VFUTv/2uCeYpkk4Lk/kP48goctAdG8n
# VlaQY1AWXBiPZCXc4xayHU5eBZlqCA0k2Vxfll6duKdzDE8eejlRgfgBkL9tO7WE
# W1tlTN2dTqtDdpVtUDVnfpYGYfs+JLBpF3cKSHeRc7aaCOPZMPam8DoQ/9Ew4Gy8
# aeVUpmZpG1/CbaL57u2tNKNG0MQhpTkp0V0WveYG8kYEzpc6db+xjCtvfBqs3EUo
# sj4szl/YunqWN51mPYa5DteUCeZLwqC+PgyDQDi+w4LOcpC+1i9y80lHz6lpMjJg
# nBNbXEEgznkImh40ZoUZt7zx7FMqnPX2mQq9n/+MIgCZdEsXEIpjZkZ8RReX2A51
# pmEQhb7XHfpNGfsrFs0b7j0Bf9txna5AYot1hxAHGuU5De3zcZwb2KkKoiCwOMyP
# 1mPsKk0XTxzYOI7xF1zOrQhnPrX+36/aNQ4UyHH8eLbEOxDPkdakadhBatNlUoon
# 1+ykDJtJuW0JtxzXhPGhghc6MIIXNgYKKwYBBAGCNwMDATGCFyYwghciBgkqhkiG
# 9w0BBwKgghcTMIIXDwIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEE
# oGkEZzBlAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgyxkh7UxDKiGd
# G7N3SsdULgsDU0q5I9rV0z2oV6V26hACEQDSWsdwg+UYRXDNS7tEw1/iGA8yMDI1
...
# LwYJKoZIhvcNAQkEMSIEIEDZKLQQttxtjV1mAkGn5RrcOQvmha/RCTqhBAFWxqaa
# MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIHZ2n6jyYy8fQws6IzCu1lZ1/tdz2wXW
# ZbkFk5hDj5rbMA0GCSqGSIb3DQEBAQUABIICAAJ75uX+DlUyHYsy1FmbvTJDwiXk
# IbqdEzE/Rh2LJLVXmHxFnvIr/y6kjyWW5E/0qwMZLbIwxCBeBhW1t0cVtbUpZeUe
# Uvcvc9pMvTRTn07Br7aCKdoGr1pQ4W27w6SAIssDab7wRrRSPufodrD9MPxuzU0v
# TMqxD09c2eUcu0a0vNKQ0l5D4IMpWwGVrhek76dfG55UXFrnfmiQv2LiY+tBiJ3N
# mzGgvHNYEz8pv8AaZNSSHdzWIViwiTsiwQIEeBvl32pzTNmh6CyLB9Be9ynLHSeg
# /syuPUvMoI7vY8/RTvskWqnN3W0/fyp9S2pAf8ICIadVbmRQbs+ySsGZUbsW4003
# ZpL1+yA88yh6GLxuua0n7Bo7aLOsWSrMsSpASTm8/CLrjJz30Jlj+yc+oVdca0Hf
# xFr6rxy6zsl37yYms2F11RYQOabe5Jkz/mOQ6wXl1FBjePU4BpQCh+ow96+UryDS
# q7UESu3peOQL+wc6ZbwDbPLbHmxFs6UCXqds6TX1cw16Llm4ZCo68FdYFK2A1e8Q
# Gf6TnPztNNS72ZaN6N3OY/4vWeJOzCarOovmlz6PftDWf5iUt1j2NhNezOFjgmEv
# 2cEz92EtiIQT1k12rWCJIWCwBrSCtShacNnM6yDGRrLifWHmbbOT8IHNBv9ijowa
# jN8NkZmBKXvcjoGd
