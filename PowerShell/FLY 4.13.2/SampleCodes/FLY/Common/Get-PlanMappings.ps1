...
$FolderPath = Join-Path -Path $Path -ChildPath 'ExportCsv'
...
try
{
    # For example: $PlanId = 'Plan Id'
    $PlanId = ''

    # The default exported file name is plan id. 
    # custom name example: $ExportFileName = 'custom name'
    # Note that the Custom name cannot contain these special characters :\/*:?"<>|
    $ExportFileName = $PlanId

    $ExportPath = Join-Path -Path $FolderPath -ChildPath "$ExportFileName.csv"
    $Response = Get-Mapping -BaseUri $BaseUri -APIKey $ApiKey -PlanId $PlanId
	$Response.Content | Export-Csv -Path $ExportPath -NoTypeInformation -Encoding "utf8"
    Write-Host "Export File Path:$ExportPath"
}
Catch
{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCdkfgONnzAFr20
# ZQ704bUDsHvK2+lO7ihouBOOp9X+QaCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCB981ybP2ij2MLSu44uIvZDlT8BpZpS47ozdRRvg/67kDANBgkq
# hkiG9w0BAQEFAASCAYDfMrh/Z0ajrMjo+b5NYSOCHIFRRM+YIKasghPySiBgjj2E
# ZwTqC4HvM4HkdCJu8j0Ojnx37AlNs7rQce+vCxlrqFcn6U6zDtFWWiF6fQEqf3Xp
# nSy8TJ0DAJrIB5Dx+ay4E0h5mOOtNNCg5D+7ORd2W2l64bYRubI2GoPmyh+LFfXs
# uHMGaEqlSos6RpcF08Sq5YeDQNfQjoU6x12ZKrIkM03/SK+i84TlSjjw4b8EutiE
# vHUJ1631QHBlAvd+Prpxij4C1glxFfVRcbMSdWFl60gGQJggPPNDKze12C0WJ//T
# X8xkBH9M8HFOiZF7WOOUEUCFFd/P+uu3W44L31wRsqZAnBziSLGKuYmygKgC8hf3
# FBJjJiZYsIXj02z/m2gw8mM3v4rKQi/BYGh0Bma8jYIPfygwb9iYP9f66Fcr7n3N
# tTlB83WkYrNqZOoXjzEa3+yHpKPORAziRMoUt6tRWQq+szDUQ/SYX4fEPVpTKxZu
# qwi8zpQPUzJOInIcTX2hghc5MIIXNQYKKwYBBAGCNwMDATGCFyUwghchBgkqhkiG
# 9w0BBwKgghcSMIIXDgIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEE
# oGgEZjBkAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQg/Yir0KkUCpBC
# 3J7Qah2jVZfU+m+pGJMb42eTk5EfYogCEBQNckor3+4+5u2RVHDz95QYDzIwMjUw
...
# BgkqhkiG9w0BCQQxIgQgJrr9e70mfTIJMQD40FrP3JxzlpE7kdF0lxDTvb8n0Dow
# NwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZl
# uQWTmEOPmtswDQYJKoZIhvcNAQEBBQAEggIAHXFpQSeGCip3nTI+0p9Iyd7Xix+o
# EdZZ0Q0JNNMye92HifaNVVHrdbqE/L0wa/MhnRGI8ylEsMC/CZk+lgRZR1x5ChrY
# lzTK8SIHLnl8GTuGx5fNTBFnffAasQYjwhlrr1eBOdr/SzgcC0P+kBu1NXavcZIf
# cjelHHPyGyVDaqjbX8dp2ZgBqBAaomG0HZQz0VVQo6tTPx5bcTP+UYSoGQ+Au9Um
# qBPKG4BlVaEz8g+ikOoXFm0YxRL/d8Xi9teO+nRHz6Ns/8Nomj0zv31pwvZh2+cw
# 4Z0A3NXQfERKsd4juVUppIuhWvYwQ4hamgGMo/JAem3JC/m8sXdBKAvtP73dQ59f
# phOJm8NSa6MhPr76hQ6UBNuERlnsKmvD1tPHprLo3D+4t7C83WnYzTIZJ/7tfPKz
# 8WrFb2hzLF9jmnp0EA45T4oMYm5IxK+RzjtLEC9ipOWiCBNmhdGwDYcDIffJNNLw
# kIpfuejXhi7mZ8/Y6SY52pBNemTFQ87dK2tROJI7ZsnYGRNsAVrUgRxiNCpy0szT
# o3KQ1vnY6ZqUNUSrATBh1tgl1tsWU8hWjgdHhq/BC+ehc3WAKcRlHGvwrnrdSctL
# g5e5vGmYlVVeuc6U6T8oKblYvPSVAGMcNBPFjz223DC7Q5J/i0hkSk+BxyLm1EX1
# +8pLfCYuJJUGVPY=
