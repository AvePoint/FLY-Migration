...
try
{
    # For example: $DatabaseServer = 'SQL Server Database Server'
    $DatabaseServer = ''

    # For example: $SQLAccountName = 'SQL Server account name'
    $SQLAccountName = ''

    # For example: $SQLAccountPassword = 'SQL Server account password'
    $SQLAccountPassword = ''

    # For example: $SQLDataBaseName = 'SQL Server Database name'
    $SQLDataBaseName = ''

    # For example: $AuthenTicationMethod = 'SQL/Windows'
    $AuthenTicationMethod = ''

    $SQLAccountCredentials = New-DbServiceAccountObject -Account $SQLAccountName -Password $SQLAccountPassword
    $DatabaseSettings = New-DatabaseObject -DataBaseName $SQLDataBaseName -Account $SQLAccountCredentials -DatabaseServer $DatabaseServer -AuthenTication $AuthenTicationMethod
    $Response = Add-Database -BaseUri $BaseUri -APIKey $ApiKey -Data $DatabaseSettings
	$Response.Content
}
Catch
{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDJfU/cJxleB5kN
# JlG5N9uc2238vglKrAvXCtqvE/O6G6CCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCALSHTcYogYgaumHJLNlrhTsUfExX2jMkRZhR2jjpvDODANBgkq
# hkiG9w0BAQEFAASCAYCuPenp+xYVVJdzqnHYegL6zY3J8wrpTqLOE0P/i4MbsmWh
# SiNIDbR99n5TRCfOohYRHyZUx/2rk5mdR24bZhKahBMSmV8E+izk+oJQU3WD9+0v
# G32N45yi33qjNNSSMImegnWQnaBNNdAy+eCNV7gOX0RXjTQBNC0lW0+7XrtgDOIi
# fXVmLFCoqfKkEiGiI2J4xYI7/knrsI049KS1JBFvWEyI90yOXV4/9PYyFNWTFyrz
# 7l73MR0eSKvALhgLS6DMgprKuWmYdbDwQJEGCzMgwtz08flBYiTkF5y19GBprPme
# eHv/yc408tR3F4EnxtCiUZ/rpqW0ApsgFQD66+N+MIPHqxLfX58HGPD0aJn2SHoJ
# S9R1Z0f2YICsgWzik8IE0VzUVDmTICIoXxrXtA7dXeqmSDOkggFBvhM3DrD8srvu
# wOSlfgV7tqDrhX61Zk2uachYEzitb1KWOT/fHs7UO9Gr+xu1gFYA6WdkeP3ZIfTk
# HNxCT9jnZF0Tas4XDKehghc5MIIXNQYKKwYBBAGCNwMDATGCFyUwghchBgkqhkiG
# 9w0BBwKgghcSMIIXDgIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEE
# oGgEZjBkAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgbyRN6WFDGzTT
# 3BMsj9gM2IXMRGsf4GJOcCWr30h0WLMCED/lLpiNXnFAmJRZL18X88AYDzIwMjUw
...
# BgkqhkiG9w0BCQQxIgQg476+13Q1jUzsUBnhqMVGKZu92aCCQeOdQYI4kJCnHaow
# NwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZl
# uQWTmEOPmtswDQYJKoZIhvcNAQEBBQAEggIAbPjUgdqE72PQqd+/yAzDTELEhjzz
# 5Q72bT5fL43w/IQ/ujNmSidEvP61D4uZjLP18mswHMIEGSpuPipPZjXjmx0BPpCx
# J18i70oFC7gjSeFH1HHAUlbyp22sF0O9+Cc9FFfcjDeW0+jVxMkGXxwmnI48hMLV
# cZg4rl9NBi+wUQiG9i+5DwqIxp8f2G5UwYbFS6zmZLcSZcZZwnEXas2WlllwSCAf
# aXez3K5ylOb/ag1iyYixESHlLlte2OXouwEzTC7QGO059OaKKG6Jfd0la0HC0Q7Y
# sfgj5oz3q7dc5jE6aodkcJJSIJbkIL0gbBiMVSAh/xB0QVCV6qSTIvMosQgv4wsl
# m3MlPUi3pHJ1ozj2DiKEm7W3fey+laHA1RpXuqw8CBustqOJxoQKxteVc2UtOpc9
# Op2j1bhbt5b+hjgFCZFNtdotQ31rbQyCui6g5tWu9OakiJPm75tCnMOw8A/TyLuE
# Kp78oYCkExiKDvaKKur/dN0hvJVlrilaggKeFW2w1Zo3O8WHivScJmTdPxh6ETLv
# UnCb7HVEtbwIEFYvoOi1nPUSzV04EVhLdwpz4Yd5/wT3vbqYcJl0dK4WSnOfRBNX
# 1KrImRbHa7arhuqAP4ux8Ng91hrIGhTKAPZUX7hpbpxRVL3GpzlhP/UfdFJMX2D6
# i714dohc4ZX0OtE=
