...
try
{
    # For example: $Name = 'User Mapping name'
    $Name = ''

    # For example: $Description = 'User Mapping description'
    $Description = ''

    # If a mapped user or group does not exist in destination
    # For example: 
    #   $NotExistOptions = 'NotDefineAnyUser/DefaultUser/KeepOriginalUser'
    #   $TargetUser = 'Use this default destination user if the user does not exist in destination/ Keep the original user's/group's metadata in the destination (requires a placeholder account)'
    # If the value of $NotExistOptions is 'KeepOriginalUser' or 'NotDefineAnyUser', the $TargetUser cannot be null.
    $NotExistOptions = ''
    $TargetUser = ''

    # For example: $UserMappingFilePath = 'User/Groups Mapping File Path'
    # Note: Please enter the absolute path of the file, please refer to the example in the MappingCSVs folder in the current script directory.
    $UserMappingFilePath = ''

    # For example: $UserMappingFilePath = 'Domain Mapping File Path'
    # Note: Please enter the absolute path of the file, please refer to the example in the MappingCSVs folder in the current script directory.
    $DomainMappingFilePath = ''
    
    # UserMapping will be created if the user mapping name does not exist, and will be updated if the user mapping name exists.
    # To keep the current UserMappings or DomainMappings, remove the '-UserMappings @(Get-UserMappings -Path $UserMappingFilePath)' or '-DomainMappings @(Get- UserMappings -Path $DomainMappingFilePath)' parameter.
    # To update User Mappings or Domain Mappings that is empty, set the parameter to '-UserMappings @()' or '-DomainMappings @()'
    $UserMappings = New-UserMappingsObject -Name $Name -Description $Description -UserMappings @(Get-UserMappings -Path $UserMappingFilePath) -DomainMappings @(Get-UserMappings -Path $DomainMappingFilePath) -NotExistInDestination $NotExistOptions -TargetUser $TargetUser 
    $Response = Add-UserMapping -BaseUri $BaseUri -APIKey $ApiKey -UserMappingsModel $UserMappings
	$Response.Content
}
Catch
{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBm9GVgoJ/uR8+3
# ZZ5P77jWOdSsJQguE8FpfjZNCaRPfKCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCCpH+0ZJ0FxXZDzndFiZK/NxXlfrb2FkukEYCtNs+o7iDANBgkq
# hkiG9w0BAQEFAASCAYAShNB5YDiYeZZuFPVVUpIQmsp6u1T9pnyMEiuFZ1yzJlmp
# S3wOCFS+wgfIDW5FQm9yfG98sO+u3sERIGq9QrSajjVojm+jQz/xr9CPTMzTD01H
# K80wAexSucFw9GeD9OWKBVzR0HFV9J8qmMsqeyLDmAdjnMai9kBi8zviBpLcuHs4
# w/tkt+abQ+s8SYtYuNjROpUVd0PNDE6Ps72PNU/d5X3hW6lIy2kno3F6N/9wyf0i
# uhCZB4yT08iVf6FCHWAlrPMdQFxBS+xvdpCf8+ZhY0ufCgQvsz4ID6XPk0PJgyPA
# BAxvzi1u4A9IXDQ3R/fJzYn3bxot8FTTrYN/0//6cU0Lpd7bLNbHzApPIpxTUGxr
# Izyu5zj2psDNksGPHYR6hOgV3mE4F23RR6ew3zPe6wIeNw73ZHng0WeRk4veL1oG
# 3k+GMWKJ76wn1eKDBtzN4oLqPy3WsJC4nnbhafuXq1b/xJoqen+xyUCW3NbXC0YS
# MnEQfi5tQ77tJO8sbQKhghc5MIIXNQYKKwYBBAGCNwMDATGCFyUwghchBgkqhkiG
# 9w0BBwKgghcSMIIXDgIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEE
# oGgEZjBkAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgwGcGrjplf8PW
# C1c9BmkbCk1hlKj0gQ4Rjz5qFeiRWYUCEC9zpJcgOoiv2+4r6KKCodcYDzIwMjUw
# NTIzMDcxODE3WqCCEwMwgga8MIIEpKADAgECAhALrma8Wrp/lYfG+ekE4zMEMA0G
...
# DQEJAzENBgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjUwNTIzMDcxODE3
# WjArBgsqhkiG9w0BCRACDDEcMBowGDAWBBTb04XuYtvSPnvk9nFIUIck1YZbRTAv
# BgkqhkiG9w0BCQQxIgQgph78Is18f9p00mqy16330icoTgP8EirWAXahgs0/+Wgw
# NwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZl
# uQWTmEOPmtswDQYJKoZIhvcNAQEBBQAEggIAOyzOGG1tUom818Fp5mXmS6ONY7uV
# Ba0dI3c6KEZutnXheWSPbTPQydbQTUxA1eap3rsMMeEudyhc7eXzuFHKISsbUEw1
# gADljlF2m0tEBAC32ITik9+7Z27gzZVmlfFOUBT4uio/+RTljvBZSnAfJ4cgaW/o
# vdfh2+Der9YEQhOJ4B/7k5zAtSQkU4FWNIHmyfNvKYAQhdg9i0O9KrvgoYeHS/o8
# Un+W7CGtlEDXiU81S57iUirizbxMocvJFdxEvtFC4wram+XxRTaqpT8IVzkZQq6j
# wJynC/uoilVm65RUtfJO1ztNl8gHcyCKTTWa4MEq40Z+O6UVWaoimXAb+sVt+phN
# 5eVhOAKiR9deSsqKg2f2XKTRhbJnSAWnp8/xtajvS5pnjGQ4X3JbVxQnv0eFdEYm
# U34knesT/68PR8IKVp6o1DUOJCJxE6yITS4I1H4KPNdVVfpc8SpdJoO6NxNi+iVL
# FXELaWkEriBSd0VOMpluUrs6AQKIVUOwmCjOxHSUJvth7UtO6dFIOBvxXDFK2pVZ
# u4aJ2zxnJjJGkTsU8pzOv3IoKBwAgmhtENGn/BrkulrOLpL4N9uGMS+razjVwd2q
# zQfVkofDuDhUxfGB7XyZAZOHshjwh6Y3iLmVu8ZDtvVGTJvnRDjbeNpwmRbWEKyA
# YCH0D8aOMyshyyY=
