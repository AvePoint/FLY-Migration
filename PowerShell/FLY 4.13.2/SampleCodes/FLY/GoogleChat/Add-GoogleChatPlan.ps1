...
Try
{
    # For example: $SourceConnectionId = 'Google Drive connection Id or Name'
    $SourceConnectionId = ''
    ...
    # For example:
	# $SourceMapping1 = 'User01@google-mail.com'
	# $SourceMapping2 = 'User02@google-mail.com'
	$SourceMapping1 = ''
	$SourceMapping2 = ''
    ...
    # For example: $MappingContent1 = New-GoogleChatMappingContentObject -SourceChatName $SourceMapping1 -DestinationChatUser $DestinationMapping1
    $MappingContent1 = New-GoogleChatMappingContentObject -SourceChatName $SourceMapping1 -DestinationChatUser $DestinationMapping1
	$MappingContent2 = New-GoogleChatMappingContentObject -SourceChatName $SourceMapping2 -DestinationChatUser $DestinationMapping2

    # Verify the user exist and are available for migration.
    # For example: $VerifyMapping = $True/$False
    $VerifyMapping = $False;

    $Mappings = New-GoogleChatMappingObject -SourceConnectionId $SourceConnectionId -DestinationConnectionId $DestinationConnectionId -Contents @($MappingContent1,$MappingContent2) -VerifyMapping:$VerifyMapping
    ...
    $PlanSettings = New-GoogleChatPlanSettingsObject -DisplayName $PlanName -PolicyId $Policy -DatabaseId $Database -Schedule $Schedule -PlanGroups $PlanGroups

    $Plan = New-GoogleChatPlanObject -Settings $PlanSettings -Mappings $Mappings


    $Response = Add-GoogleChatPlan -Plan $Plan -BaseUri $BaseUri -APIKey $ApiKey
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBQo32efMYMY4fN
# n3Swptp5N9lilawIGlW59fe9c+PVzqCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCDF8bCr/ZeJgQralHFUv9J6RnXnif+43FqF46EmcO9gMzANBgkq
# hkiG9w0BAQEFAASCAYA1OQzyJywEKs3WsA0yNwnhmYvET8kvXFfVU9Y8XHjM+5Ob
# GEDt/CxA+DIFKOOm6lHvHjK2sZb6lO8hI/Wl0m3aaxPk5hm8wCCYN9T828TSKrrH
# TwnbzlvMUjv5YzW8o04kXVxdyaYoKqeXcOEJc0b9Z6J9fcJRd6uSD51zs9VNLgbp
# uNLmIZDyjfJHYS0p28GPN1LfqJFhF26hArfvtnuOCu5Rfyl7I3B3W02lbQtiaKF6
# UxXIigupgGNZyHg6KnxayaT8EBdINIcafWD1C+e5Y2Eq//WG3ja0/p6DItoycCm7
# sYZvG4MA9Yryrn+wjcuuKgQHyRtU5JatncdqHyp2/ZQjclMs8ED+5Pu9dkefMllm
# gubC59OP3bZrNILapAvS1MEwsJErICFpvrngeZ6/E2j+7igf4p3WCffhAyPo5U0J
# ahrFKrgdyhq6lXDo7KWS7OW665xuv24Eh6AtASD0vfGGi3887W5ZLiOpXOOLTzJF
# 8zxss17Q9fOD/B2Kfs+hghc6MIIXNgYKKwYBBAGCNwMDATGCFyYwghciBgkqhkiG
# 9w0BBwKgghcTMIIXDwIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEE
# oGkEZzBlAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQg7uvouzOgYoS2
# Py+qhey1RMSvlEshMYh+vHH4uIYu3XUCEQDoEu0J33K8YYul+gAgJveBGA8yMDI1
# MDUyMzA3MTgyNlqgghMDMIIGvDCCBKSgAwIBAgIQC65mvFq6f5WHxvnpBOMzBDAN
...
# NlowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQU29OF7mLb0j575PZxSFCHJNWGW0Uw
# LwYJKoZIhvcNAQkEMSIEIBZQdm2Pjt2ss8ptBuAWOJheE78VKjJ0kLB9VznOs8za
# MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIHZ2n6jyYy8fQws6IzCu1lZ1/tdz2wXW
# ZbkFk5hDj5rbMA0GCSqGSIb3DQEBAQUABIICAK65JAXqF3xbPemD5M06eFr8UOuQ
# Aui+YTV9O2tNKCE6LvAqKHNxwyn3AA8PjaHLuZD8q/6O6sscVOpWF3VWn3kcYZh1
# MHp0EdzGIn56HK+mfLlhrxC0YK3pBjwVzG6HYIJdpxBdITEAJ1L28UHIevKRYGrx
# LH9mLKWW7b0UWYlTusvhGCs60D6N7mmT1cwEa/dK77DSoe2Zk7hUUHeiutl7g00L
# 8TfbFnlTeHavqvwWCjhVWN2tiY9UkOddzHIzpLoM2fjTjkFT0DhXEzL7pn9LsXTi
# vwXVX6pO02VR1OqL4udKW4JoV4O2V3ifBXKmS+Y9wG/mkGUJ5rGf/vH0X3TFQrY3
# r70WjYESDA9+Jyx8AWO75rOrwdc2GcJataYqX8/YwB5SXk1/clkq+xwEOhGnF/QM
# r0O3os3lBZujdhaBIPv4IRNszqbwJ7JVOlCPNQEZb4TWGnru2zoRueG8IExCm5yH
# YTyggyuvjsrXcBO2tX29AOhNRnAQSJwdZ1uT4StdaylXtsdjIkWZUZ3QisfEvMbb
# ux42WdyPOWBVRORDImKgblMO6M+BsxZtayHG6O06KuXB0P0cnrxWpnsgDIm+cUVp
# uxuuOCwAx9FMnDslCDMAk4CFxh3l9lIBzqETMKmYhfYQsn8RtISQAmCZKbM7jOLr
# rD+OHc+G50UJHDgS
