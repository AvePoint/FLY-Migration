...
try{
	...
	try{
	   ...
	   foreach($csv in $Csvs)
	   {
		...
		{
			$MappingContent = New-GoogleChatMappingContentObject -SourceChatName $mapping.'Source Chat User' -DestinationChatUser $mapping.'Destination Chat User'
			$mappingList += $MappingContent
		}
		$Mappings = New-GoogleChatMappingObject -SourceConnectionId $connection."Source Connection" -DestinationConnectionId $connection."Destination Connection" -Contents @($mappingList) -VerifyMapping:$VerifyMapping

		# For example: 
		# If you do not want to set the Schedule, please remove the '-Schedule $Schedule ' parameter below.
		$PlanSettings = New-GoogleChatPlanSettingsObject  -DisplayName $PlanNameLabel -PolicyId $Policy -DatabaseId $Database  -PlanGroups $PlanGroups -Schedule $Schedule
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAIFbmGZBA0TyU2
# NSLtXZu1D2IeVq7lam/xsBI9qwP2A6CCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCCRyYP24v8P8isok1NG9u/SZRKnkX6dAUPIEIgFjGebKzANBgkq
# hkiG9w0BAQEFAASCAYDLT9qlA9hxMu+migyBtAV1lK56UlPMyKMqlV2NCSB446DT
# f81NoQRPmnlvEJFoG5tpFVgLVqFvkszwyv6SHdkSbEw+FTuOIb3DMa+qRbu0w9sA
# 1rkMtQ6zdPx2Q7jQtMKa7uuK5qeXOyuk5qUY63TT9xX8w+Cc+GqzKf7ka69mLyut
# 8yHKCpKsNS2CxjL4/LpwrLL9h5h9euVryJcgdqzT5AQYCKuuCncKvHNsv4ngHIaS
# 9KwnwfBqJEi5gFRBCJNDehnwPXtIDRo55sko65ywJUjKnwY2j/2XSPs9FF4qfFAn
# 2+kWbpiQHVTYDH9emxgdTWp1kbV2b2dAE+gaM5rFSXF+VS7QIID3C7UbcpbVe6wk
# g+nIzR7bzJC1rMdTr7KNJQUEPB4kr0LP07YEJgButbjzdBUb8AgU4ZshqzZCanOY
# FeHDh3Ooh6JFYewbjMoFF3+uMiZSDA8MJ1eiy3zi1qWqfeb0AiGfhqKdHxyGMU/Y
# 2M0d2P5nGHJ9mmyylQShghc6MIIXNgYKKwYBBAGCNwMDATGCFyYwghciBgkqhkiG
# 9w0BBwKgghcTMIIXDwIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEE
# oGkEZzBlAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQg7PHLk6qG7SAW
# rUyO4uxoGffoO9YYuRH/UU91Hmbl+WUCEQDyPIHplaKp4ta1lZ6vIkofGA8yMDI1
...
# LwYJKoZIhvcNAQkEMSIEIG52WEUFhNNTy8KhVNm20eRo1447lgKUDTpy6T8kdmmL
# MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIHZ2n6jyYy8fQws6IzCu1lZ1/tdz2wXW
# ZbkFk5hDj5rbMA0GCSqGSIb3DQEBAQUABIICAC/7SPzc9dEaIZ1V66A9hazC/O3G
# fx2fq9/Fjtkp2OFUP34+0OV8Ku65luZinZHhaOexov+Ns1X8RG7omgfrBrY2RM0Z
# m4klQ5/C8FCjQknsRIGDhb+2WoFoQpyFugKhJgVL67jdO6c83pF2IL6QDJaH9P7I
# 5MydQOM7gGBD6rKKWuFzbUL4fMeUm6TiPtrCt+XL3UdyOI4YCBWHyBeF4kAo07Jf
# MlDZN0zM7bzgemZY5YBrr6IcorV+KGJ1CAE5nXS1SwCevcfG8KvO+ZOs59QfQL5J
# LW2fXDQyV8va2C3Gw6ifLkOQKcNjLRuD9PRAE/tS27GoD/cwGr91HLReO6yfICj6
# O5Clpa45cBwE8F9eA+ytXAf5TxSwCdRycOK1dO27v2RmZoItuZNJ2cjjfWlgwcns
# NIPHb/OLX2BL9nx84VNMryaaCjk7azJmOw66aMCZZOkkpCkbQspc5Jst6Snlp4KJ
# w/WV7aE59qQmXmHfffRSJsWWL33eItFEWb7ZAAaFZ3icygg+HIf9yx68EPaUt2pm
# DMX/fkjU2s7XemYmke2DRYCtXkJqTwmXjcPIk8r5TAtfa9VmKHr4GZJ+j45m/KTo
# Cj7tL+wFUiOOKZePFlS0fRBUjUVfymg5WihEW1Ft8/dydYE5W2xwZJanRSVL2Xw5
# 6ZQpu1wuTABvH1RA
