...
try{
	...
	$connections  = Import-Csv -Path $NewFilePath
		...
		try{
           ...
           if(("False","True") -contains $connection."EnableSSL")
			{
                if($connection."EnableSSL" -eq 'True')
                {
                   ...
                   throw "Specify the EnableSSL parameter error, the parameter type can only be 'True' and 'False', please check if the EnableSSL parameter is correct."
            }
		   # $SourceConnection = New-IMAPPOP3ConnectionObject -Type Gmail/Outlook/Yahoo/Others -ServerName $connection."Server Name" -Port $connection."Port" -EnableSSL:$EnableSSL
           # $SourceConnection = New-IMAPPOP3ConnectionObject -Type Zimbra -ServerName $connection."Server Name" -Port $connection."Port" -EnableSSL:$EnableSSL -ApiPort 7070
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDasy9I2Unr86QK
# Yw9YpDePbeMOuGYSGy4hzsmRZq0a3KCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCDvmQoIrdClSmrSt951mQ/Uypx8cskm9+HR3+HgZEdcNTANBgkq
# hkiG9w0BAQEFAASCAYCYnt3EVUyWz7vuOlrvtgzpbQ5kTdDl48XjsDIDQlJ2+Fj1
# fzB7DC7msEeYJTtCLCSil/Y2pfLMEP1ni4YRW73PzgMVh60eGc0PQmwDHa4dA11X
# 9glwba+vDJg49kkugIHOKAmN1Ngvh4tlEHo08NK67XIUbP8qAWNA5qiOpnifa609
# kSyqb0EiKIsLgJRwByksdQHupspRxzU5ARZY0ls4zoFqh5bfPgSV68LtfR/bQ3Cw
# /7gP+37Oe0+yxQpRGuVWpYiHSOvoud0J+H7p0kG+GR3LQ7rM7TrUL0hQf3RxWvfe
# wsLcWe4VXa4aewjWWoptp69g2UVJYFhq4m5cpv4/YoqJssZTmYukNXfv+tZ2uKk4
# w51r9GUcaTjucKUaAXb57TRVJRKyaa2TUcSZcZzTvGdbCqGXurOCwrhEQfgHYDai
# mHZJg1GJ7ayfJ3V3Q0aURxxcxsXe35P/TVROB/8Pq2MXfEYR3+/2VlQvPLPjGm/g
# AU3cJ8sv8/y6pHPyejWhghc5MIIXNQYKKwYBBAGCNwMDATGCFyUwghchBgkqhkiG
# 9w0BBwKgghcSMIIXDgIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEE
# oGgEZjBkAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgeJrdNRF0eiNt
# 4qQKrdLXElwPMO76KPWc5lGohbu+hcACEEUdq7UfEvUc5cAR0fZd9ogYDzIwMjUw
# NTIzMDcxODI5WqCCEwMwgga8MIIEpKADAgECAhALrma8Wrp/lYfG+ekE4zMEMA0G
...
# DQEJAzENBgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjUwNTIzMDcxODI5
# WjArBgsqhkiG9w0BCRACDDEcMBowGDAWBBTb04XuYtvSPnvk9nFIUIck1YZbRTAv
# BgkqhkiG9w0BCQQxIgQgy0e374KUVksDHg04Gj0UxS0mPRYJXOgoBuhOLebbGqYw
# NwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZl
# uQWTmEOPmtswDQYJKoZIhvcNAQEBBQAEggIAU2rr9uOIAF5cN8jOjL02MqYa0KH5
# eo+iVEV19ZQpi3AAv/2yTLB4fOLieo2loSTCq/3Rd9TWBF/JFgn6Use5TQj0EufM
# 4Q4FmzjPMBm2XE8BlE3e0I/hZ1rFZjR+ngzyCSPWpbmDePnSXkGStycD+DjXd705
# iNmLcbfPaa9KFXnadHyPHNXrROmj8i6xTtfOSir28oz52kEVhy1z477Acm+qPERH
# H2hIwpNkJtjLK4jjOsJHS3Cia5u0uiEiTWTapiXeD5wUrnriXddYJuiLcTDco1QY
# 34EFUu7g8jZWtjoc5DDjJ6Z20N3zM10gqjN/MRzQVvJS/yvJOpJZXmhJmPCq2+Ye
# RmzYr2CxCyohbahO+SELfEYOmEaKI4osYl594rrEyRZBGADi6H+DM++bUWpm/O7V
# uaGpQmM00DCMJpJBydgNIOSgCq9/zljP/J5M/AoJFVJh8h6g+3idrKGECHEbJzUY
# XfffR8OWlKu7vVK/a5YX8iwZNAxHfIh5sfoRd3jXaettPX9R4hWoR0B+fOQgFjNr
# 7u5N9sxS4YDUxIEGKiI20YnHYf8+zQnQnTwknIrgcUlZU0AZtENG+EJDGzU1zh+r
# O09Z3lzvLyLaEHz30X+z74gXbG2E4U5CVO52WVrXtRThKzUIMttHWJhF11tUf3n8
# DEcmRD4Y9/RG25g=
