...
Try{
    ...
    # $ChannelMapping3 = New-ChannelMappingObject  -SourceChannel 'Channel3' -DestinationChannel 'Channel03' -DestinationChannelType Shared
    ...
    $ChannelMapping3 = New-ChannelMappingObject  -SourceChannel '' -DestinationChannel '' -DestinationChannelType Shared
	
    $MappingContent1 = New-MSTeamsMappingContentObject -Source $SourceMapping1 -Destination $DestinationMapping1 -ChannelMapping @($ChannelMapping1,$ChannelMapping2,$ChannelMapping3)
    ...
    $PlanSettings = New-MSTeamsPlanSettingsObject -DisplayName $PlanName -PolicyId $Policy -DatabaseId $Database -Schedule $Schedule -PlanGroups $PlanGroups -MigrateAsHTML -ConversationsMigrationAsHTML $ConversationsAsHTMLObject -MigrateAsMessage  -ConversationsMigrationAsMessages $ConversationASMessageObject  -MigrateGroupPlanner -OnlyMigrateDocumentsLibrary:$TeamSiteScope -PlanMode $PlanMode -MultigeoTenant $MultigeoTenant -Migrate365GroupMailbox
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD5K6enhJrQ3CM4
# CIe+LeM7E8N82kPvbAL1ubjxiQMSDKCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCCwYbI09yOMW9GJmH2I/68h8YnilJsDTr35MmVvxf+ntzANBgkq
# hkiG9w0BAQEFAASCAYDR2a+Cf6nragCzDJ6hZs6Apz/F6fk5x6PudvbIxTn+PeGo
# +hxdvV+0rMU9aTyfyM9ix4CwC4LPQTehs/YlTWOsG8m1WphQhQF0ZT0KDsepcwp8
# UV5MT9n7K/7roWYuvap8iJIfpcmDp5MHcH7MTUekKumuQMixN182yptV+FLVAcWT
# pxRB9RehM5yq200aOI47jyqC/UuG7O6iVscNzIuZB+gzaCCBTEQwOnZP+xwwUfkd
# mnc22aksop99s7Aj+8SyHdPmim417zIJMBvHpFAWC7qDxPgMIbpSiMmguSLaYTK9
# VFqiOxPQ2OD+/sS0zKH98qbQTEUcfs8Bo5l6eDM3LP5pzjwfZ7xAjRcbXqMwX0kZ
# Czij3sErCi1j4OJiD20aSXpsdNcK30Km/uSj6kwBkwnQxfuKlhsqMluV8U16sKOV
# KN0I9WEBzMncsUgvYA2G+dSFDl081/LYsq91KgJZaHtIYVY3hBbWTknuDwyntJyP
# ekAK0USMsfY/7RKzVU2hghc6MIIXNgYKKwYBBAGCNwMDATGCFyYwghciBgkqhkiG
# 9w0BBwKgghcTMIIXDwIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEE
# oGkEZzBlAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgKUXISbEg584l
# b1O/fWvla7SsIa3jtAsyg3BngsFZQGkCEQCbO0AvK6TVA4bXcgt6DabgGA8yMDI1
# MDUyMzA3MTgzMVqgghMDMIIGvDCCBKSgAwIBAgIQC65mvFq6f5WHxvnpBOMzBDAN
...
# LwYJKoZIhvcNAQkEMSIEIBAzHjo5t17CMGebLPQBUdw4h8mL7GaZEqZWcX1WU3HT
# MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIHZ2n6jyYy8fQws6IzCu1lZ1/tdz2wXW
# ZbkFk5hDj5rbMA0GCSqGSIb3DQEBAQUABIICAHzkngZu5FxHeCoJ5LetbYEqLie3
# zj0rO450Hiq6kQzvHYFwDgjpDzZ+G3HeFxKLo4AxESmYyubTtlN66r/WLl4Bi0h2
# kpiIDc4WT8HugUrV9MWXAEn2ngAOe4mGiGJyrxehK5dH6y6Q6INxdWD7j9VmUOc4
# sJboftoE6n5XuJNOkhrXuBHheDYY+9/hPmUPoMoXkyshVGqqtKxY3uzgmLZbD+Fj
# 6D9xRB9dFIvuWRb60F5iNkzn4bBkO5jNNdmk6VYiU7JStwk6bVORIT7CHyBVpmA4
# CzVyeG5ddYz0S9gUz0wlzyf0YIVcLv8BHQQYamNMiAOjOr7+MuF57a7Ii9WklJEw
# AgsrvlxCOYvKZ47f8Nt6CPCrZp2lHDh6APUTMIcG3gSNOtekT51Dvb0VnYn/XP/j
# NYXx51mDB1BrOfUxGRebHAT66q0c9JilM4VsTyDlvT6gP4rjUb2Qj/5s6f82rOFi
# 8X6eot8oIb3+PilmF6g+S8e1ba1cOrrfnWF1ryRrM9Wg/uDWK4QNcWo2paGRsDM7
# eM6YzsOFsfRkgxL0kDInQKx6XU7pp/lRACAOip+7K3sWqXJfhNV8dvAOjrQ6zfq2
# n3+gtCbOTAkgMs6cxHNJG6G1koHt0qZ42Hi+YUmzREnm7KCIqEVyAcmwu7JL4Z0a
# s2MxTbJqf/dW5n0D
