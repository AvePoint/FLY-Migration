...
try
{
    ...
    #  $OnlineConnection = New-OneDriveConnectionOnlineObject -Username  'Service Account'  -Password 'Password' -AppProfileName 'App profile' -DelegateAppName 'Delegate app'  -CustomAdminUrl 'SharePoint Admin Center URL:https://yourcompany-admin.sharepoint.com/' -CacServiceAccountName 'CAC Serviece Account name' -ServiceAccountAuthentication CAC\Legacy\Modern
    #  $ConnectionCollection = New-OneDriveConnectionCollectionObject -OnlineConnectionOption $OnlineConnection -Agents $Agents -Name $Name
    $OnlineConnection = New-OneDriveConnectionOnlineObject -Username  ''  -Password '' -AppProfileName ''  -CustomAdminUrl '' -CacServiceAccountName '' -DelegateAppName '' -ServiceAccountAuthentication Legacy
    $ConnectionCollection = New-OneDriveConnectionCollectionObject -OnlineConnectionOption $OnlineConnection -Agents $Agents -Name $Name
    
	$Response = Add-OneDriveConnection -APIKey $ApiKey -BaseUri $BaseUri -Model $ConnectionCollection
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA42M0srnKc8nbj
# Z84aRXEA9x/DfRzu83T6VuidTYckYqCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCDJwMIHvwNBQZ2F3Ax5HsTHSeYPMpkFwaXFaaJy4telgDANBgkq
# hkiG9w0BAQEFAASCAYDB/wKJEXqDnKtl6JeqgnB60sznkta990q0cc/IdgKyvjvk
# VTYjVMuVqWicV1fWpCkAIqRkzf2aF2lppA2IrLKypQ7XYDmEHSxcXnDdobugYGOH
# +vulpOxq7i8KAV14mMlsxlR8azbYanOjfOhn9KTKBg4yxUyLjRTyuHK8e1nNnz9X
# ZrDnOhXgfuMzzq4kN4xBHC9/fOJMMSdmPgEYHMlSD3z8uXyfSgdJEdkuyClLtAZ9
# eEzxEA+H1w/1waOwSchysKL3vmfIVnZs8NfcPJfGG+BB0SszQ0kR9+T3d8ZMyAwm
# QLZdx8lGa4ccd7bDjYk5duqntdk9UcZOzI7ESXHeECPHTep7+HzYrAkjyLxwTVSp
# 1jXHnziapvLOLkjRan7Lw3yJ6jpFprJCJETGnlZunD2JW3U9ok4+xyB1rMtqjumS
# HmMSVj8BmZ5XiNb051FxvsmTey7NyYr4Hv8/RHFhPBt69NOhPCL5mpZCVIRbOish
# mlfXpUChoLP11hPGvZqhghc5MIIXNQYKKwYBBAGCNwMDATGCFyUwghchBgkqhkiG
# 9w0BBwKgghcSMIIXDgIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEE
# oGgEZjBkAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgLQSdlpQxYkOJ
# uJjrbSAb0AErk1iRtOG48gg2hB4eQ7wCEEHv6w9t7n1o/A70wcrPkcwYDzIwMjUw
...
# BgkqhkiG9w0BCQQxIgQgn9ZLzJ/2XsyG9PIOChBG78Jq83KQ7RzNiBHKIWQCRsww
# NwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZl
# uQWTmEOPmtswDQYJKoZIhvcNAQEBBQAEggIAWZTx1gaErF1Sru818hzwJ7VfAV81
# Sa77+FNHPK40Ruibj6kVbaJ4rLvU6jCCh5hyasa7yWnHcRV5jthJF/02xBcF/kwb
# UC58PPxmV2+DtodV1M6iv47h/3SRRDTyCnHGJQh+Ee8UF9sDCwIoTr6YfJZNyoCp
# qSQEyAuQTM9qLsVhLLbEGJISuX/R1kTkbDT/yGihFpSbg4LKP/x3R4RZHXAQNJRh
# KnZLxKfh+dOMj5BzVurAQ+ohGn4CBR/fCOaKbekKzoU1oxzWkCkjNE8EiU4pifn2
# TGEey99o0LGlBmjpqMKBQZjLt33/68jxYjftSHE87SI0wywAkU44fMTkNe5jlEPj
# /tQFLtbR3BfUqmcmdLiQlBhRdm0nnsfZ28TfG/xJz+YQasiE+Lv+C2I9cKtROVsd
# /kXHZZnTc/kSsl7WA+JhLxUxSS3yAdKPXoya2rHXBxyG+l7ekIafVwW48PH3v2Gk
# x5c936x1w2HkZShXMWDFb3p3I/ZreTvnSDMthlO3JZaHXu3+Nxk2hMtAwNjuI8Dc
# QU2LUQeqB7StaUVWQykV3iKvqPKbITX66Wq62VPLoPOCwYki/jQOXzCW7uxlZix5
# eA9mXmfApQvPGPJ96Y46oyIfYTKNFRp8CSaj4GY0szSFfI9+9mkmbKKEDoixuPu0
# HrURavPZB+tVCvw=
