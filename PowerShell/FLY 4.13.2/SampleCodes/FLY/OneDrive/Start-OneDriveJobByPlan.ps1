...
try
{
    ...
    # For example: $Settings = New-OneDrivePlanExecutionObject -MigrationType FailedObjectsOnly/Full/Incremental/PermissionOnly
    # Time-based Migration example: $Settings = New-OneDrivePlanExecutionObject  -MigrationType IncrementalBaseTime -Time '2020-11-13 12:01:01+08:00'
    $Settings = New-OneDrivePlanExecutionObject -MigrationType Incremental 

    $serviceResponse = Start-OneDriveJobByPlan -BaseUri $BaseUri -APIKey $ApiKey -Id $PlanIdentity -PlanSettings $Settings
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAWggfldQb76B1w
# NqWr3eVd3qBmtQC7Gc44A9IIOIpw4aCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCConFag47nP2o7BxF25nEYf5TnDlbduNTXqAjaTpOvntDANBgkq
# hkiG9w0BAQEFAASCAYAdo4pWDEBb0TPvy/vzODJJIBv9+hBH4H6CroMtwcUo2s2y
# 5hL+uG2eZ/nEJWHKgsb8pR3nedtLii/zyOZEgL3rOQiuUIwUkq2DItZD+of0gMOt
# sLGXMdToIVuCHKXu1zmpdpxuSMaU+9/L4ovsoDORAbezV3WOYKV7kbQvOXDNmJ2C
# 99Ukx9oGHKvBzYKISZXg7/J3ndqWOwxucBeHacHrF/PlpkVlIFkDN9TwTdSzyjJA
# ZwUxDmHwwy/2XDxz4mw4qTaXsT2XcqNXn+xdDS7beWmRg8NYlT4PB9B86gFJ21iN
# 7nNEmXE0+jbX+QhvgRncv1TdvwwE4SSBZqbYxQn5ND/5LOS4Jigv89xJU5XXn5w6
# AyZ6GkEN7Ds5EK8pgXcwgSURMmTLoPiqAxMxO49ypQnUhfn10ZOZT1g015x19meh
# xK5HjPpV9512ilTA5LWlTLwFSwOVSxJctWbg4AsiSx7EuGPp4wBaBu4ePseUYsuG
# gPI1k4zm/svcItpzaRKhghc6MIIXNgYKKwYBBAGCNwMDATGCFyYwghciBgkqhkiG
# 9w0BBwKgghcTMIIXDwIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEE
# oGkEZzBlAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgMAZ7oBFhSaU0
# O/CuqVQrNI0S73R/tVyHFLMqROtz9S0CEQDvAdHyq/xW4NJu0/9XrKS1GA8yMDI1
...
# LwYJKoZIhvcNAQkEMSIEIG0zlPkJfFZsAUmKqnBu9xKbyMxTHrlmGxBUp07Rrlao
# MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIHZ2n6jyYy8fQws6IzCu1lZ1/tdz2wXW
# ZbkFk5hDj5rbMA0GCSqGSIb3DQEBAQUABIICAAQ43foCjVl/pgQfzXH1azfXHLY2
# WnJT9+k/Bej06XDTHKEOkJNn+vsnfl8GJo7ZuQjZliNJMbBYUp+TMyUKGaidLEEn
# 8BT1M3avHEXUGP1X0DabrU1ImC31sc+OQeFKL543uWHL8eZbdI+ChirmCeXkFWi7
# VAPercdPRfmEyX6Q4pSxQ+CoDxjKt1XjyusIhOhGF2sJuHOSQ6erJ7urcoCzX03q
# QAvPYdvU/Vx0xSYua3R8tDCKAoqsc9Tdz0LwH4onGRTam362xYk1BsMI0lAwjfGd
# UY6Ze0+EZmAi8PTkbW5OJ3yM1kFEqFljYVmB5kTaabx9X9iLiBF1jr6XQPcqgeTG
# LhomI7IdoIZ8FW+/q+u+pFPaa4mfLDXiVe1iSlYmA5+IU5GRCl2O5PzhOWlL9+0e
# T71Bws3cw0stbj7pOkb1RI0TrUjuJoyTsLzo7jjuyacypzlReat/ZPvZE8lcYJhg
# /+WrVDNbV8O/pnLkXrKc2XrXLb2KcxEc9gNZ92fytT9uuRGjd6qAWkowK4cY6d5s
# P8QQ4WFF1N0qmHN417Z3bP3itIfTl2J/h2Y0gfykrjSYLgfkdSSww5Ul/Cd8Y00e
# j1i61D/hZjbgXT4/6mcMXvUCOTjb9/uTGM+T+zprAzdBzH9+wK8acM1PBNmCV3Vl
# PgjNgkKrdUAXLbCC
