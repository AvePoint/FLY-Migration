...
try
{
    ...
    # For example: $OnlineConnection = New-OneDriveConnectionOnlineObject -Username  'Service account'  -Password 'Password' -AppProfileName 'App Profile Name'  -DelegateAppName 'Delegate App Name' -CacServiceAccountName 'CAC service account name' -CustomAdminUrl 'SharePoint Admin Center URL' -ServiceAccountAuthentication CAC\Legacy\Modern 
    # If you want to keep the original option, delete the corresponding parameters from the New-OneDriveConnectionOnlineObject cmdlet. 
    # For example:
    # To keep the original 'CustomAdminUrl', delete the '-CustomAdminUrl ''' parameter from the New-OneDriveConnectionOnlineObject cmdlet.
    $OnlineConnection = New-OneDriveConnectionOnlineObject -Username  ''  -Password '' -AppProfileName ''  -CacServiceAccountName ''  -DelegateAppName '' -CustomAdminUrl '' -ServiceAccountAuthentication Legacy
    ...
    $ConnectionCollection = New-UpdateOneDriveConnectionCollectionObject -OnlineConnectionOption $OnlineConnection -Agents $Agents -Name $Name -NewName $NewName

	$Response = Update-OneDriveConnection -APIKey $ApiKey -BaseUri $BaseUri -Model $ConnectionCollection
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDgMRKF393OOJ61
# HnooSgMVt7jQnDSiNip9PyQ0gLHHi6CCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCCtdDBcAtg0wBjVsJ9M/A87rvZvoOC0XlhqVCcpT0/8TjANBgkq
# hkiG9w0BAQEFAASCAYBhpL2NZdscVM+uOo772BT7eDvI5fpID1wXMHpIMhPmGR2x
# dztgBu958acB2evO35d37M2wbMCQC39NNEQQMWHTDaZ3sBazzknhrq+8J3xB4in3
# lxKevyECry40BsYZafBWHAjAdYQU0+xoj7d3pEGcMDgXUlxZ/0aF8mFXUTGMtQUH
# TJhaZe5DDW/C9a9cVSXXFqm+BCkNmedrAZaZLUYpr+46W4lb3tfjn2CTQWKKoCRG
# MQ06hQoxIL/CcM/naqUNz1i2LSmAju9DTvc4rA7rFT8XaNRXKWqspzlTC1BpPNdb
# VT+FvLsb+LsfMegTvJJhB/7EP71vpJ1MyvcI9I2Xw4zLv0R5FsYa2+mhbE49c37U
# R6qoEBz5UBMugCzJP/aEe1HN9JRjGnwLZIEKVIBG7Nzes+D+ZjqhVDp5Xg+ySViJ
# nU5CCvaScPlp0RkPw5b95mKlkuhb9DYnCQGIssUeB6DSw0QYEv6rrxsxPra50tgW
# GZJZvvqS8DssTFJPvCOhghc6MIIXNgYKKwYBBAGCNwMDATGCFyYwghciBgkqhkiG
# 9w0BBwKgghcTMIIXDwIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEE
# oGkEZzBlAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgMzaWdKp2cy64
# W2dWiT4tzh2gMg+clDTcJ+TWOir6d3YCEQD8N1lZ75oGJrbXqxwtM9XlGA8yMDI1
...
# LwYJKoZIhvcNAQkEMSIEIK3E+JJCXvJFkt8xR2ESVRFar8aO+oF+T29Llml/bE4j
# MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIHZ2n6jyYy8fQws6IzCu1lZ1/tdz2wXW
# ZbkFk5hDj5rbMA0GCSqGSIb3DQEBAQUABIICAAnouFwOJTUIjfYMAlxttO7GR12q
# lJD14p4N9zDz3y87podixY0JtlKSuM7htN8NDgDZnBFGssgmEk6JCE/vcbKav4z6
# Yzho/QK8MZn+qTc9KuB3vRrg0H4VmZ8vMVEp0qpIfYzRFCRnb1JhfIwS7KHY8QGQ
# QC35zKfCaKITH4dg8IUAR/6597Fr3rGLoOe0ZNDnfXUpBsNGUJVWlzDmKkKmgLmu
# AQGcNCNAMDeop9VZw8Sak3xn6WO/olI7DJjHk+xYerV0Xy6B+mzRI9x4CVhv2SE9
# aPPWjgr70I5qUF5jnJBZZDiBbtRkCFO4nZqFC0JwSGDV3YsUgzUnpdvT25imI4Fm
# 2l7a/q2nMRi3MM8X62e2hQVBybRquzO4SuwYCWmJWiXPWZu7P3YAD4V4tI+Cxgbd
# yESwWgoKAsf258nrdSqY7+L7ZkRIIIGHtk+chzvtIAMghnRncrFtMKKhIBdbwZ8H
# tbvk5nMhYyh2FlAWbst72QNKQJvXMZhE109H1ahEI9FDpgyAS3RM9s4RdAOnSwUe
# D7NLsnOYRUSLAxpsZrkcQnJjuPGeLa5dZ7WEzW7ucmpigyNfXodZH749mO0PkRkh
# 6zJwiheShV2yhfe+4/bPLfuLi5NNaCrjv7JdYg5JHAJM9DCYzSqVKodPHDbXkgkL
# Nu/fglE/46e8j17t
