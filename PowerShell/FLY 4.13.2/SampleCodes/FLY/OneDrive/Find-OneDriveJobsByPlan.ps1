...
try
{
    # For example: $PlanIdentity = 'Plan Name or Id'
    $PlanIdentity = ''

	$serviceResponse = Find-OneDriveJobsByPlan -APIKey $ApiKey -BaseUri $BaseUri -Id $PlanIdentity  -PageNumber 1 -PageSize 50

	$serviceResponse.Content.Data| ForEach-Object {if($_.FinishTime -ne $null){$_.FinishTime = $_.FinishTime.TolocalTime()};if($_.StartTime -ne $null){$_.StartTime = $_.StartTime.ToLocalTime()};$_ }|fl
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDnjadRFTNwhafu
# 1/8zO6PCeXPTLRN5E/VUw9DmN+gyE6CCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCANFotPsLyzSTmRKdPQICFron5H0MmiLPFP0OPo4rn7qjANBgkq
# hkiG9w0BAQEFAASCAYBRhKSrOx75W3ccGLIj0L0rHc9gmof3rj51tVpVlXNWXHJt
# lcs2Ce6Ox5U0IhZ7ZEb3BhvZP7Iqs+zv47kHgekaLFDkxpnffR7OHkr1A2p6BP1c
# G7WqL0JVsecmBuPvdJ6BLbmZ/PWckrFiHgxE6nQyETIMpmmOzCEjxFNsOnONnJL4
# SG4txSnwikT1e/jkGg7HkFvJU2ETyp+70iayi+wcYlM154mqNODmAi1PwUjxNVym
# JQ7NNkMJJDzRuHsOrLmgTxd1+CCLJRWziy3rJCdQNWjWhljvurrhgihWIjmKCrn3
# hxGAquqSC4ENyihRCw2d3mqBpkrQf+8CupGJQmXL+Z+utvYDKxcL8Bu3Ya6GP7e9
# STilGEaigEG9xSJiGAFPw6bwZQM9KYzHHG721Y06JnhWxv53wUJ6qWT39OdiOeLH
# C3RuCXIOsteLLyYAHdfd6E5JnG40javgYDTkK94pL/TEWckUD+RXa56F/C1RM4hu
# vOQcU+2exVZhr9ZcXCKhghc6MIIXNgYKKwYBBAGCNwMDATGCFyYwghciBgkqhkiG
# 9w0BBwKgghcTMIIXDwIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEE
# oGkEZzBlAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQg+Ks2dXIFGm5e
# DyWECinFXYFFIvucJ7/sZDS4GadvtHMCEQC2mzFDuyP6BN/C4Bg0Q0LcGA8yMDI1
# MDUyMzA3MTgzNlqgghMDMIIGvDCCBKSgAwIBAgIQC65mvFq6f5WHxvnpBOMzBDAN
...
# LwYJKoZIhvcNAQkEMSIEIGYgwOcptqotDIW2kSymETKIefIs921KT4mxMRf3oN5X
# MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIHZ2n6jyYy8fQws6IzCu1lZ1/tdz2wXW
# ZbkFk5hDj5rbMA0GCSqGSIb3DQEBAQUABIICAFzKF2OCJFai2JpIBwaWt4D9Tyv2
# 3Agqo717iFLmk/17fcjYBP2G1/vDarHg6aUOVcIqQ47Jp6SbGuCf3UseDBUc2yX6
# uyYJdTL8FDB67bFq1wFf6tAR1GOG17mEhuT2ZRShGzXQwdeDhq+HGXmySgXfJgyI
# hUfIjlxlb0rEmVqoc5aVzzaC48YmH1gs3sjQRbHj4xlrJq10fUvZ4Ugo95q08i/j
# PCD7xCY8yDQmeBDheg09UVGqJvLhrOp3YbnnNt+Vt6VxazxrUqAlFsuTLgJGRFZp
# HQVqvfYwT8+dam4zFZfqZp8wq7wXHPeKgzQMmy7wlOaPbXljK8lwYcC++0PT1oYa
# ut289uCaGsFZfrkIynrMcP/rrqZZrS9tEGEMQBgSeobSJtz3wg2f5nQ2IHWht6OK
# yjeZbXSVk6S3Xwp1Fw6H2mzJwrUNEFFBuScfDkHdMDfB1FyUn48QzJCp08molO9P
# G2nUvCgqcs2HA9UMp0oa1DM1TLAtaYqKkQbrv+NfPc3lr2siO53Sj0iDv6wHEw53
# 647eWdSzNQ8nnRWMQVOCzqnq/6exkvUpYXIC+YRWYQHwy6B7NqaLWkv024mS1mqh
# bkTyz48uisqg6Z1dyWU1dhooepIUSrxhB0xNN7r3OTMzfEK0G2YbEHDeV6aFJg26
# I/dPYk8SeAcunkX2
