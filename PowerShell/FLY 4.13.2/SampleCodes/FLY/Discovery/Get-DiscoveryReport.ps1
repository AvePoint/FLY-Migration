...
try
{
    ...
    # For example:  $Result = Get-PreMigrationReport -APIKey $ApiKey -BaseUri $BaseUri -ScopeName $ScopeName  -Type Box/DropBox/Exchange/FileSystem/Gmail/GoogleDrive/Groups/PublicFolder/SharePoint/Slack/Teams/TeamsChat/SlackDirectMessages/OneDrive/GoogleChat -SavePath $FolderPath
    $Result = Get-PreMigrationReport -APIKey $ApiKey -BaseUri $BaseUri -ScopeName $ScopeName  -Type SharePoint -SavePath $FolderPath
    $Result.content| fl

}
Catch 
{
   Write-Host -ForegroundColor Red $Error[0].ErrorDetails.Message
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA1OAu444B9Q0Xv
# JP+zJreqvEhZ9iL4OpQRqJOPGhTZp6CCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCDfhfcfJfdZSyGEtu6qsehzSLKTGmPq6Fe1mBOkzAi2xTANBgkq
# hkiG9w0BAQEFAASCAYBzplbHNjHwozrpTUZSKYfiwURCoiFNYzs2CA5TLO5PnC4Q
# WIk92XY2GtCi1THls6l6r7B7ipIdCQ9mJz+DeOYdj7TBgqsRdLHI/t2QCieYfV9j
# aT4KxPTANKIc5lgjme5eYC08pON22dVd1pw921XX/pTNoDEN2gAnYTskFDVW0Sp7
# LhQt54K4nHrPwhkqw/beMGmb9DxcOq+oBerLXEG5fT3MTDD0AeMHnqxAqCAw0P4+
# lmyBrhLblyRAfqC+22WTgv0nIVr2pTE0byTtHTxkdh8FqCh4AwdMWp7dgrWQhdil
# u0cw6yKsp8fZVGXVMONATcd4mZXzwF38AGrxx3UlE1cJN2euvk/BXUHLstDTJ8OB
# 76Yny2f03Z/7+5gQuYQcxnvT8kVyO5qmqQtbZWt6w3s6x/gIz1dSObeeAd5ACJOK
# eYX0f/4qA25YLGh6X8CD7tP4ESadKzxBHIHd5biLQdd+Hcfd2l9hIGaEdMxokmBi
# 1fh1PIx7tHGhYfPkyH+hghc5MIIXNQYKKwYBBAGCNwMDATGCFyUwghchBgkqhkiG
# 9w0BBwKgghcSMIIXDgIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEE
# oGgEZjBkAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQg4AYU4/mlIHtU
# pmbsNjegAx7889cHXUdD8UBxHE6sAUwCEEkeugHgKQyJG/UlFuqCUm4YDzIwMjUw
...
# BgkqhkiG9w0BCQQxIgQgCVdXbla3oljsSIRYG+qwhIIdPCyi+bUTFum8IITKH1cw
# NwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZl
# uQWTmEOPmtswDQYJKoZIhvcNAQEBBQAEggIAh0Lncxia452mfA+fZwbZ5GWOMgqA
# qKMEw9raEuvPdib5g4GNh+YIBS61q3o8of2NIkFCcRaT3NhkIXu/j5kp/4IEJnJr
# qwqtBXZFPvCjIXaB1eUJudkDxcbFR4iaOEZ3RVYQDumXKxhbBq6tTbIMBgHIfqID
# bJ3vojogFV90oysSBHZ33UdHTnzOy5A5I70Rkj7zMBG8PIehm9SZB3tn08FcsW3n
# U3/uhpyR1VxMUZGBt4PPrhoDZHOqF/lKPvRIf9hZnRx0Cf4MoORvBJqwx9pfVSIK
# hawP6yrXXHea76gfXkBACRhj3Btzni0OzlZCvkGi2WcCLpbc3FMmmMK4um4kgP/Q
# gaHp9OPhOr5GYF47heCEHEMMmHwRbI5Xpod8534KMpgLAwoDPkhscaWhcT664+av
# Ug1WJ/sNz3L20d7F35X2KC/buhf5noanf8Furcu5LMb6lKdK2OfxmURhmroiBaRH
# MEc2GglhPi/903XzA9Kt4gk9a6ybKLKkZq4hGrVXL3HGDptxpjsidXf5x9MQLGRx
# ZWoQEl3LW01SQccjCfFjV69Llu/fVb+CkNHmUVciZcPh5zjctmCIpcOx7fbmVGbH
# nDIu4IK8bJb0a8/pYovUj64Eg9zAJ8zcLGVIQ3Tu3yUdA4NknXZfsa/SnAxKOOpD
# h9cvDbe3/tjjtpU=
