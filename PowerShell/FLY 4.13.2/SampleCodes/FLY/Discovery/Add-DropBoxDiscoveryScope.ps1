...
try
{
    ...
    # For example: $ImportMappings = @('user@contoso.com','user@contoso.com\folder')
    $ImportMappings = @()

    $Advanced = New-DropBoxAdvancedSettingsObject -IncludeFileVersions -ScanFolderSizeAndItemCount

    $Scope = New-DropBoxPreMigrationObject -ScopeName $ScopeName -Connection $Connection -ImportMappings $ImportMappings -Advanced $Advanced -MigrationDB $Database 
    $Response = Add-DropboxPreMigration -APIKey $ApiKey -BaseUri $BaseUri -Scope $Scope
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAgob4+1OXitEDM
# PCWo/lLsdbRRHGWmsycvjy2TPaAH16CCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCBVMsxnDecqAABzhGshp0d8+lqnEmun0UwcEHd7jQef0TANBgkq
# hkiG9w0BAQEFAASCAYCfGkQAzYOk55raMzjxYVgZrkK39rmHtKAcVi7IlrHjT9dj
# ANCcXR4qsxk19P+0UBjrJiSNMDFAod7yoKKMnMyzLrfw2p7pH+zneCdb+sRj72e4
# yEYmOzff26ZLqS4X6331PWOXHMiButoTsxYqjTXrHuc3qFvoi4GC+g7i3ZeAWOXR
# zsL3iPEC3JJzuNcORqbw7q4ng40C+GcK6ZVrViksFehaiI++QQ+I0FgnmQdb8SXB
# fvyChIgObNfI+6YQu/qkGzOHX/QXw6JuMOm+dy+me+z0H0dV5rvb+zo+RO2Y0xpb
# Ba0su3uPFrkquxAOEVf7BWDzpvmkis0b1yn4nl1B8HwHC5SGLeaGJimdSjPTT9uL
# UihcfwXzyBuNWf1klk5SH6VqALEE5WVNvFbhM0leTt72wUZG6+OzruZHvfIAYqHF
# fD2rxMykweN+VQkFJnHiNiYHzD4ajfYl/JWYICO/w8UNhYUe5cvbEzqBwnQQdDQS
# fM/F2vbmaImBLc0bnuWhghc6MIIXNgYKKwYBBAGCNwMDATGCFyYwghciBgkqhkiG
# 9w0BBwKgghcTMIIXDwIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEE
# oGkEZzBlAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgKiWENEmpnAbp
# 1H/3C/gQBQLnaH7VzIiTV+Aa5zMZxBsCEQC47xz/zKrOu1NoAwhJBcLSGA8yMDI1
# MDUyMzA3MTgxN1qgghMDMIIGvDCCBKSgAwIBAgIQC65mvFq6f5WHxvnpBOMzBDAN
...
# LwYJKoZIhvcNAQkEMSIEIKwKLuQ4fI4V9XgWMSbSqXg1n0KkVbXMlz12w8u1JLdU
# MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIHZ2n6jyYy8fQws6IzCu1lZ1/tdz2wXW
# ZbkFk5hDj5rbMA0GCSqGSIb3DQEBAQUABIICAHXzye+CxirV88D7+u2Ep0U6jfdG
# mSSrGDHY42eikYqgokimAOxv4wFDWq2czYNMPP9dikpZRz/M1H4x0M6BPWDIRipI
# M/hlXTvsNkLvtLoCINslatXym4ez9VI9VX5vY7758532FfAJt/RgrYwLHmCWNCG/
# VODnGDh6gCy3wBInGBNwPeSSHgOIWtKaNwErEbaCdXLslmofNRxcBMw3fnd1T94w
# USU8jd8pnzY33322POg9WmFEjpvv3yqPI59XdXVm0Ybn+gP+XOSn+ZW8vSTB4XkW
# zhBJs3Wg6I/6W2SFbWFg86LF+KkfQgwwKvTiiKe9bYGA2cOrRLjobPE88kJGqA7B
# kSfEOHrhYWarXO8NznRVxsbd+Zwb0396X/hI+LHuoxoEHj7EkzM/ZfaDikwemOK8
# 5fdDnOEawOIDWTsrm9uQygC8y6zJtH92KvJj0b5mhvR1A7oRdpKx1kPGZ0Oj7MMT
# R5fEdhgXt5aSTJcuKwNgUDfH0KgZjacdfvUcCghBbwTsBe6LquscZSSdD97nngNp
# 61J1bOquZceU5Tkn5rkoxWI68R5VkndMbs6kdEAzwXFRYQqd+UndKkpKYB2Td+Ma
# sBlmWhCGFPT7SOaRIMRmhPheUg2Lnk6WsN2tr9gZKq0jGfCJeKlXgxZl7PncF8Vs
# ahwGaRzi3yakMbbB
