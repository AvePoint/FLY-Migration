...
try
{
    ...
    $ScanItemMode = ''
    # For example:
    # User Mailbox： $Mapping1 = New-GmailPreMappingObject -EmailAddress 'user@contoso.onmicrosoft.com' -MailboxType UserMailbox
    # Resource Mailbox：$Mapping2 = New-GmailPreMappingObject -EmailAddress 'resource@contoso.onmicrosoft.com' -MailboxType ResourceMailbox
    $Mapping1 = New-GmailPreMappingObject -EmailAddress '' -MailboxType UserMailbox
    $Mapping2 = New-GmailPreMappingObject -EmailAddress '' -MailboxType ResourceMailbox

    $ImportMappings = @($Mapping1,$Mapping2)

    $Scope = New-GmailPreMigrationObject -ScopeName $ScopeName -Connection $Connection  -MigrationDB $Database  -ImportMappings $ImportMappings -ScanItemMode $ScanItemMode
    $Response = Add-GmailPreMigration -APIKey $ApiKey -BaseUri $BaseUri -Scope $Scope
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCr7/Gnl3OpmNRw
# ZPFP8o5aMhQCRf4obNQW1Ye62CZy3qCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCB5Inemy+4HwkvvTn5VFs9Tpe2bQ/c/WopjYtaVWiRITjANBgkq
# hkiG9w0BAQEFAASCAYA26+xTs67YbSAcwsBmDvF9rixLw4rY8uRIaDOw8kKsfBl0
# 862jPhX2NfGNMWswselkb9aiM1nxUfIL5OXoGfVs70l0oBAlVBht0j0OgxSZm3OB
# 29pP6qEf2CSV82fnsS40cB5ZpTp5Ap381kcNzxzFpngAyA1EgijNFEsngk3xhtmi
# RfonUyN20KheBOIqN3+6W2+rrFDJDsKRIohb7+++q7POPaccJLGiCSKtRyI4niVK
# AW8e/wVCATx4ogKd+fxSxJe+AGiZ4pduqT1ist8A/hS+ksURoXR5XDCVjZTZEXwZ
# RzF6y52DsZH7VvF/UITypqowV3a0IAOrDSSth2IyJ04Hf6aWpHtgL8oK92dhk5X1
# GPodCYS5IA3YAIdNHBioCMrBa1omthyucdk7qGUa3TCI5Y30+fjpq/N6h9y+0B1f
# pGKe72bg3x5sGw7GlPzvORDi/e3NyrqeD6Fa/LFXmrhNbSLeI7cV8OiNok9L963H
# P4ZySxIxWNBhKEG/oBShghc5MIIXNQYKKwYBBAGCNwMDATGCFyUwghchBgkqhkiG
# 9w0BBwKgghcSMIIXDgIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEE
# oGgEZjBkAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQguZSNQvOmrye5
# E9gVQIhAdBnxbR3KLFhzvm6z8HbjO4wCEDlYJuUMcdzkm9EKRtBR+zcYDzIwMjUw
...
# BgkqhkiG9w0BCQQxIgQg5tyxCEn4rZNbL0AezlswcTZvH88p6eMcZpo2Rd2FvjQw
# NwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZl
# uQWTmEOPmtswDQYJKoZIhvcNAQEBBQAEggIASlATVrFgZjkZgUh4cc4iPOwKtbrY
# Oiz4wV2MPVL471nEWmcK2wZS27bWawxnLv4xOUoCCFhxSzIDz48xmXOLOdY/NHD3
# 296ZwH44Zfh9sbHY0gCAxYJwXxAmJJKdKKEh+MjjvuIGa/dl6x/pqfqQgA+1gSiR
# tbHEgPhGgmM5PydSAXKpni4gt6TCITWkTd78xOS6/cN9gozH1Ew8kEogyknBNnk8
# M9Tic46DaL5i1XGmA2WvsbZGstyFWuVxICKv3Q7aw05WPlH+GlvdSQiSqbK+fLzp
# NpKOdqJj0HYgsBgnU6vByMsSUa36sqG1MW0yM5DEIn8veDLjDnmgxnGDILi+i7ri
# u2NSRMBi5cIgAyMc3BWPXb0ra51lcgBEAxevzDFvfeYKigymIouAv5zlEOlD9rc7
# 2K3/SEGLsIBICT+RbBfbKOOJD4nBIfm+hz2rbYYLPoSllJYaRjmEdWfxPlL99oVl
# SN0o/r/1D4Ws9N1I4wmdNKHHGSMYuhLR6K8epCgq4gF1lhY7/aBkJXuPYzCdhfFd
# VdVTEw0jVEGJgnPs0paf+0EXs+o1Qw2fGE6ZT8SXsg6JmMfnMgi3va1vGeOb+Y0C
# EK5UKSIFhyhvmWt+waouVhVbZoat8tSr0dzDbHqhk5T1AnpySPRumhLcsKqAPhO2
# miCrlJ3jElnWMeQ=
