...
try
{
    ...
    # For example: $Connection = 'Connection Name'
    $Connection = ''

    # For example: $ScanMode = 'Detailed or Quick' 
    $ScanMode = ''

    # For example: 
    # Site: $Mapping1 = New-SharePointPreMappingObject -ObjectPath 'https://contoso/sites/sc/sub' -ObjectLevel site 
    # Site Collection: $Mapping2 = New-SharePointPreMappingObject -ObjectPath 'https://contoso/sites/sc' -ObjectLevel SiteCollection -ScanSubsite
    $Mapping1 = New-SharePointPreMappingObject -ObjectPath '' -ObjectLevel site 
    $Mapping2 = New-SharePointPreMappingObject -ObjectPath '' -ObjectLevel SiteCollection -ScanSubsite

    $ImportMappings = @($Mapping1,$Mapping2)

    $Scope = New-SharePointPreMigrationObject -ScopeName $ScopeName -Connection $Connection -ImportMappings $ImportMappings  -MigrationDB $Database -ScanMode $ScanMode

    $Response = Add-SharePointPreMigration -APIKey $ApiKey -BaseUri $BaseUri -Scope $Scope
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAFL4gYwTClZ1ip
# Y5OHtBmgTpK4vMZUhP0f0s1pKef6LaCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCD2+Wux+jBvHEFt1ChaEcQTXd6hl3NJpb9Qda/evrwKgjANBgkq
# hkiG9w0BAQEFAASCAYB6/rqN62JDwkuVZQm8wkNFux+mst6yi/dHNIjF7XAML08d
# x9PZ75aOzUy3n31692c555EYFkUZ6RssMrs9IuRhX3lOaBqG4+utZyxRPG0nS5tT
# bl0w85DbZqNvvnoCcMdYhuj/xIZ2xarCBi+lqbCfeGwqpa7GXUX7JScGJiSmOkje
# Dhcl4LFE5rq8sptKsMks7EM0ZkB2GF0x+3GVp7GBOCbNmHO9BXLQID7ZLPCsk5r7
# wjVKxPIjcHSFgvMeoksRghLX/GsuyjC36JAOFxnlhprXLuZw/bh7h1jBp5I3h9gH
# DOQgRYKmgOTbGY3pjaciROWsws2OoEyaP/O2H5r07Dp9ocPfixiXSSQ2nqvDHkI3
# yf+XIuVtSsvHk5biIAlkFPzDe/As/2VCPGuReR0GPOzRR5ujblRXfWc73lTWjWKK
# MH4U24qt1ie5JYb+Kb0g4DuivM7n/Vv2mD5qPg3QZc/zWMuC94+FQ8tsGzC8BRZY
# N8d3pzCfxEIgaUMlFxahghc5MIIXNQYKKwYBBAGCNwMDATGCFyUwghchBgkqhkiG
# 9w0BBwKgghcSMIIXDgIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEE
# oGgEZjBkAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQg+Cuah1wjkxFR
# Fy2jhKdxi0p2O8n6ecv+WCPKAhTHbC4CEHpVurHm7jbKlfhP9dUZhJ0YDzIwMjUw
# NTIzMDcxODE4WqCCEwMwgga8MIIEpKADAgECAhALrma8Wrp/lYfG+ekE4zMEMA0G
...
# DQEJAzENBgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjUwNTIzMDcxODE4
# WjArBgsqhkiG9w0BCRACDDEcMBowGDAWBBTb04XuYtvSPnvk9nFIUIck1YZbRTAv
# BgkqhkiG9w0BCQQxIgQgwOn6PJsmHLY10HAbhZm1PspRqMNH5nb11vrmC19GRDow
# NwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZl
# uQWTmEOPmtswDQYJKoZIhvcNAQEBBQAEggIAU55w66z/DWZdoZzasaVHv16mgGzp
# RxoHEvA3mMACruoP2Bz1XQ8Tw8jsTJ5cWMxkoAVC5t1L/NZTrd4xfsxRyTCCrlmd
# orC6rDfxICaNNgSsac0ilgltFyHB3xqvKF766x+HPyFH6hURFx4M16bRI57CmpLl
# JwJk4QlWfIGMP/MQNsSVwd3g7+8FJY8z7Q/x63K1YEK+JskvBmT09xBwgGNzULdT
# 3a6niSod7oSgkfcL5HBBvzsllKy0DBaxoNQyw1vqWoQfOVOzFRR8FRjIJaXZeKvU
# 3juZjMCjMSbPZ2A3DPMNdq6x9XX2BgKlT/C4VsogZkCcmhxc7AWZ0x6nEasXrPsa
# r7Bp4EhAlcm+oZKF9ciFU3P38EiD5AzzvbTeTS+tqk5o5N3AhqX1nN0xjFp4w+CU
# 6nPK49/VQm8bCXcb78ybm+P4wLYWXkfBL5fcoRclhmT3xdlbOQLkRRoeMfMKSAqK
# FayzvT8cqhfOt65oDcM8avWsnKYxMhvvnKETTwynH9z13FgxTn/OjlNaGfuot0S0
# coRXx6yEG4jvADgVAdnwe1sfn82rEx3yJxYoWOdcGYY4RzlKEiWTflHhpmBwTPYx
# Gz9ZiEC+E9lGgTWALOtyhJfz7J52x28fXrT/uXT18ARz/AG50eKR24DaclfW/Amk
# mYo6gPi33Wsi12k=
