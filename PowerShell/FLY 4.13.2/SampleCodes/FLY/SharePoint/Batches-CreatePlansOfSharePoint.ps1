...
try{
	...
	$connections  = Import-Csv -Path $NewFilePath
		...
		foreach($connection in $connections)
		{
			...
			foreach($csv in $Csvs)
			{
				$mappings = Import-Csv -Path $CSVFilePath"\$csv" -Encoding UTF8 -Header "Migrate From","Source Level","Migrate To","Dest Level","Method"
				...
				foreach($mapping in $mappings)
				{
					...
					$Source = New-SharePointObject -Level $mapping."Source Level" -Url $mapping."Migrate From"

					$Destination = New-SharePointObject -Level $mapping."Dest Level" -Url $mapping."Migrate To"

					$MappingContent = New-SharePointMappingContentObject -Source $Source -Destination $Destination -Method $mapping."Method"
					$mappingList += $MappingContent
				}
			   
				$Mappings = New-SharePointMappingObject -SourceConnectionId $sourceConnection -DestinationConnectionId $destConnection -Contents $mappingList
				...
				#    HighSpeed: The High Speed method is recommended for migrations to Microsoft 365. Large volumes of files and folders can be quickly migrated into SharePoint Online, including Group Team Sites and OneDrive for Business. Content is first sent to Azure storage, then imported into Microsoft 365. No need to bring your own Azure - we use the default Microsoft 365 storage. If you have additional security requirements, configure your own Azure storage location.
				...
				$PlanSettings = New-SharePointPlanSettingsObject -MigrationMode HighSpeed -DatabaseId $Database -PolicyId $Policy -DisplayName $PlanNameLabel -Schedule $Schedule -PlanGroups $PlanGroups
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDkFJFqIflzs02M
# 3xVzg+8oa05sdG6oVKb64xoKFp2v3qCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCAJAfdcva7WZtt/Tv4TEnyyb11croYv2gTFPUi4aa1z8DANBgkq
# hkiG9w0BAQEFAASCAYBBHhCnTMJuuWi9zYN3MIc99j8IwUNyroqWE7n8wtM1s2f7
# +Tjf52+sfpuQA3AAruNrZBsI/tqfMPMoYHUGVJnl6IflKw9cSyKPI78HX8KuilYD
# /W89rDGfufkp/KcTu7QH5amKVUgdjtcgS8cXltwTy8+veVfCFZyht++qJG2mLr61
# GTzWI34CLr9a1nxMVJKtbb9tCuOy6JXpW9czdcd9vvid1y9Tf9TMrCB47O+f8T+P
# iAF8YXBLviYkyacMYxqIuabsQGTdUzw4bu2Nt2YlFZHDgZ9n8uJnW7g7Ims4C0YQ
# qrfyV5pCXOTdeRUuJfVmaV7WvLE1rcn45zYNjVrqQAGFOvzUSgGak1X+VEjmJFYY
# DdR8FuzAHmRGOBRrVMBWd6GtBHPbO2g0l+bWgvCv3ZhSqvvzAWiCPewMUHoSVdX+
# TrFWWK6uHHSGqySGonmmXPFuSVamnui6Sr9pIyA/72nJuUM2WCgkrhij1GytLjxy
# tAVzMNJBfPHckGYT7VChghc5MIIXNQYKKwYBBAGCNwMDATGCFyUwghchBgkqhkiG
# 9w0BBwKgghcSMIIXDgIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEE
# oGgEZjBkAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgA8BjS789WfC4
# wAzW9SsY3fU0R8dfMsvdrLXGk7EWZWwCECcNBPZrQWKTFhCBJX/8ZA8YDzIwMjUw
# NTIzMDcxODQxWqCCEwMwgga8MIIEpKADAgECAhALrma8Wrp/lYfG+ekE4zMEMA0G
...
# DQEJAzENBgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjUwNTIzMDcxODQx
# WjArBgsqhkiG9w0BCRACDDEcMBowGDAWBBTb04XuYtvSPnvk9nFIUIck1YZbRTAv
# BgkqhkiG9w0BCQQxIgQgRBLOBvi+cyEigl/dmUv+dzL/9xvT31HoIvGjwAWafg8w
# NwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZl
# uQWTmEOPmtswDQYJKoZIhvcNAQEBBQAEggIAI/zF48dMV5TLxTsNkiMsAHbswe+R
# t5wUsZ0CfeeBYUWkwmwOx1juUFu7+z0fiC+CffgX2jJHEYqD4AAas48xtBaEyr7E
# 7IpdAyFUMXGZogG3UaFHUOsBwW9JeI6Hg9v0rj/0vUUf8Z2YizFQph985qyMiHHe
# IUSoTAOP2k8gkVIn4gOH9AcGolbO+DHjKlmO8SSjz4wbnV0OLtgFpbm+RYjQeX4s
# ehdxeKnDy5zO5on/lMkUMQgz6LNblMGc88CM18WDSpjiRVQFkyEgSK9BWDWzAIHf
# qQqgihD1MM2zgiVim1QbuqnJH+c72M0T0xiXb9S5uPZBKSym9uxXoeiSb2cEOTy3
# 5kZjSme74eL06mUvDrh5DGsVLZQ9deXQ56khd09CQwIxJlkJeEp375jGGY2AWpws
# SAK6TVJm1SVzhiyq0BzYR28ml+CEs0WxiQEKucbfwbJdTfkoNVjfmftUKOinBTWU
# du7u0pHNm5QsEqmrEMmAzsbPY839RW0w2lFOIXrmx2mcKJxG8GVnKf3JAzHnyLIj
# JG//Fj8oQOJejHnLe/kWke4kfjzSAOCQUumR1dFIJQ68TRMwHGqJvuxGbgyvHquM
# z5v48Sf5t6VUNw9XYo02MPd2MJd8R9PAuqetg72OHPMzqAA/XZO8P1fvOtHfARwV
# E1sf6nytJCr2kOQ=
