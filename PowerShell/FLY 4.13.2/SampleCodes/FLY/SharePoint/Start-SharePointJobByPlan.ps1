...
try
{
    # For example: $PlanIdentity = 'Plan Id or Name'
    $PlanIdentity = ''

    # For example: $Settings = New-SharePointPlanExecutionObject -MigrationType FailedObjectsOnly/Full/Incremental/PermissionOnly
    # Time-based Migration example: $Settings = New-SharePointPlanExecutionObject -MigrationType IncrementalBaseTime -Time '2020-11-13 12:01:01+08:00'
    $Settings = New-SharePointPlanExecutionObject -MigrationType Incremental 

    $serviceResponse = Start-SPJobByPlan -BaseUri $BaseUri -APIKey $ApiKey -Id $PlanIdentity -PlanSettings $Settings
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC3t0s5+QTCnQD0
# KNOF4RlcJTms6hkTMeY90EJqrQ+Mv6CCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCAdPxNKXZfuD3J2ASsDl9j8ETzX2ATFHckzIpFDN0GEDDANBgkq
# hkiG9w0BAQEFAASCAYAnD3xXdrGG4lodvlCgTllTeuvLsnAq4J7Wx3MgOTOYIzUx
# RPGg4+Zc97uBKffcPcX6vslkozttqwqh4wPudN1i80eAHxknAfGb5WynJ9xOyj95
# K0A7hektUp/AgRH++Clvr3TPiYcj485ioCqG2U6cevcD9XSc10CCo6kjWlMjPfAG
# lVIEVv+Ewpth+U+vDU4WbYj/8bzgxs54nwtNf7P2xIISiIt363HVZO3osMtPqSaG
# rDUXp0r050yhbGrs2RvO3LjbcCzvKPf6t9NIqCH/IQWrRzD6AxOVzknF7Ha+BIMS
# WZQoFOmLi/fhLI9B6h4lk1AOCcOMHTCJwV/CBCwkNMnXoJN05YK6kzVXDD8lHrn1
# oflfTv4vJfggBTiivpM1U1UKTF9M+XTv7oM6v8fnOht8D6QaaygxQ9SkBjS/8mPj
# Eh9iWAbCgIg/4va7inzVz36kRdw4u8Nd4T/r84AbsuUzOoQMyU6PVRbEsfsQvEth
# mFM7YH3bU7EUHSqm8/Chghc6MIIXNgYKKwYBBAGCNwMDATGCFyYwghciBgkqhkiG
# 9w0BBwKgghcTMIIXDwIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEE
# oGkEZzBlAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgFnY+z9NDxymQ
# B9yMdrnQLbJdE3OZz6IfnXHi2or1JBICEQDN586yiCpLNC0gwUy1/I2ZGA8yMDI1
...
# LwYJKoZIhvcNAQkEMSIEINO5CGvDraB0zf/sbtVWmnYrx6Gs9wGuhPAMB5hLgVEv
# MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIHZ2n6jyYy8fQws6IzCu1lZ1/tdz2wXW
# ZbkFk5hDj5rbMA0GCSqGSIb3DQEBAQUABIICAIT2HKz4wY/LIqorwjxp4wY1OiPt
# 4uExoDufs2rmR4EOuxzrA8cAjQtIO5TfnyY0vBw0cGQoPbmxgTwP0gx26XafP7KH
# PLufFW+6x7+V/kCdbRHiQoDfDSKSRn+/eWaeFJZhVo1G/rLpjYH/RP9xzOjQamFA
# a+NDWlwyTL73kEJ+Ksm5ZEa+pBKFp2fjbCrESeS2lew4xyfcM4Yt8IRowRHuAMwX
# kBW2hhwXvQZGDfVWPijnjNBmrwarF1mIM59NPaeMTDkUBCRQGrqJG0LxK/3twkuU
# 4/5301YaLbNzM8vewSl/tpjy8xXFm18uFZWWH10/Qy/UqcmIIEQFAaiAsTojEto9
# 8GeRquoY4EGMbqUDLnEJvxNTlJzi3jEy8ArsdSz1JULo6NaKVR+hKhIn3ans1sJq
# a0mklek2SSe09znSHeszPr3EDi4kD3KO3NkEH4nk+MJOd54UpPTxcqzbZLOYW0Xf
# Z4gloUrvCEB0H3R+Mv+GkplNGC0qkl8UKlQW6VLgPY4jqQTsVGOK2RhwoU9xobwr
# Z/buGXhuZ2YPOGd/hVgowvfqrS05uo/ojiRR/Gc/dBQP4DLixkFLkw8vQEq25rXJ
# cv+QdrPYOXUWoeQbclsnQzQRj/qLW6FYPzPpyHmFH5guSObxLsn8gxeirgn6W82U
# e1yy0fL62vU0hEWz
