...
try
{
    ...
    # On-Premises:
    #  $OnPremisesConnection = New-SharePointConnectionOnPremisesObject -Username 'Service account'  -Password 'Password' -CentralAdministrationURL  'SharePoint central administration: https://yourcompany:port/'
    #  $ConnectionCollection = New-SharePointConnectionCollectionObject -OnPremisesConnectionOption $OnPremisesConnection -Agents $Agents -Name $Name
    # online:
    #  $OnlineConnection = New-SharePointConnectionOnlineObject -Username  'Service account'  -Password 'Password' -AppProfileName 'App profile'  -CustomAdminUrl 'SharePoint Admin Center URL: https://yourcompany-admin.sharepoint.com/'  -CacServiceAccountName 'CAC Account user' -DelegateAppName 'Delegate App Name' -ServiceAccountAuthentication Legacy\CAC\Modern
    #  $ConnectionCollection = New-SharePointConnectionCollectionObject -OnlineConnectionOption $OnlineConnection -Agents $Agents -Name $Name
    $OnlineConnection = New-SharePointConnectionOnlineObject -Username  ''  -Password '' -AppProfileName ''  -CustomAdminUrl '' -CacServiceAccountName '' -DelegateAppName '' -ServiceAccountAuthentication Legacy
    $ConnectionCollection = New-SharePointConnectionCollectionObject -OnlineConnectionOption $OnlineConnection -Agents $Agents -Name $Name
...
Catch
{
	...
	Write-Host -ForegroundColor Red ($ErrorMessage.Response.Content -creplace ("@@", "`n"))
}

# SIG # Begin signature block
# MIIoJwYJKoZIhvcNAQcCoIIoGDCCKBQCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCyUw0C9YDX+NSB
# MweaVkRdZoNeDr327gotK3RWwYuodqCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCAuuVkZEQIOb5lc5KAy6T/KGT9qGl9X8yNFh9PU10JfczANBgkq
# hkiG9w0BAQEFAASCAYCZkdQi87PTLFjqL2NqSIcSrdkH/3thfJFw1Uj4CpLdi/8+
# iYLmbonwSVLjBwW9JWTXFnvXDVuKu7A8D+uyGeKD1RSmxU+tPdbtBRTTbdh+qF81
# oKLtC0KaWPREaPomactILOs75SN4VPvsPjM2qC4GZP6K7Xyo28qA4Nqps4aUhv+F
# jaBotE1CRTRH7xUxQy2VweFriNmlCIEz/bawrYH4lFcwLWs7uW0xbdxHqkBcAvUM
# 4SoXTwfHmwlX7RYg15ElRg59T4XaxqL2CL4ZGIj0Qk12LzPmiA4h9/9sLRL0uK/o
# hJ9S/vlJAHLuybZuKkQgIARQ7D4zi5BJwMCjxmw1OSPqx8ygXH+dozceZv+gmW9C
# U4ypG5QcP8MTwp3vWyeSOATsNyhev7ZUfatVQdLAJcKSSRbylTboHGDln3L2gGA5
# rZKpyAzdEJ96o5pkd0JN67MbsU4b6V2LNnKROABpRs+uhh9cnOu6vfzfmyx1loNG
# DBrMdOYJJbKl82vdCemhghc5MIIXNQYKKwYBBAGCNwMDATGCFyUwghchBgkqhkiG
# 9w0BBwKgghcSMIIXDgIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEE
# oGgEZjBkAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgbU9OMqXoYfeg
# 8/qfXfso08T0CPdaMQtfB1H/o8UajnYCEBb7+Rs/ZC6vtQB4vu9MuBQYDzIwMjUw
...
# BgkqhkiG9w0BCQQxIgQgIkSlWbFh43F6/mOYiPikxd+qZcDS7pFJCKRHSNGLSSMw
# NwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZl
# uQWTmEOPmtswDQYJKoZIhvcNAQEBBQAEggIAZKQoX9r4wu87dJM/9EyGo4W6gzaZ
# PQl++Zkc2zRFDzjBfb5/uQN35dO33fYi7rhWK+yX1PnR9Cz7+GAK8mcYxpvt8e7B
# Sp6jcIXrpTAqt+4giBGv4oOiWsJgZLU2k7co1zrBEwu8bbaP1nlp7m2djvJIXYhr
# 52UTvlhNZiIIzvSxcMAMYqcAcP5WV+egAacPmv1SultbQNyvUK50D/XGIt3+uPTk
# NeI1dX1TNkh3dzVb/K/Sh47Pdwcdngc+CG0QWBC8oDOMjIyfrmhz3CR5y4g2G2hR
# 2AHBSrNhopkRg6cMKmsG8JGUCHOOG20jusM082e1CSdf2LkhQzc3hztoUpMLGqeT
# d9yudMfvtEsy1PKm36PYHW0Vi3jxnwrO5o26BzJIFn0nlMSItg9MPC3dpKtuRVeJ
# ZDT6T2Jetgq8yy0FQSmEdIsqRutSFnh+UMEMqUtbxXtFSS39VdeQu8m1Mqx91dff
# 8o5bKVuF5qaIdZxX4aNmbYDQfpZAcNw4a5Lpd2tzcJHbrjedXd6NTYZORXUtkzxE
# lYeXG+ZraKhpN0/LOEN7idOhyEy0gRc4rqlwJsEJpauky5DIODtQVw1yKLLxAWs5
# Wm0JFeCzptoF/veoB3VH74N/wGnAM8W1HVICEM2+fDa9gWoLGXqvZHiAzQo3TUep
# +UQgOv9ZFyQM4KI=
