...
Try{
    # For example: 
    # $SourceConnectionId = 'Microsoft Teams Chat connection Id or Name'
    # $DestinationConnectionId = 'Microsoft Teams Chat connection Id or Name'
    $SourceConnectionId = ''
    $DestinationConnectionId  = ''


    # For example: 
    # $SourceMapping1 = 'User1@contoso.onmicrosoft.com'
    # $SourceMapping2 = 'User2@contoso.onmicrosoft.com'
    $SourceMapping1 = '' 
	$SourceMapping2 = '' 
    ...
    $MappingContent1 = New-MSTeamsChatMappingContentObject -Source $SourceMapping1 -Destination $DestinationMapping1
	$MappingContent2 = New-MSTeamsChatMappingContentObject -Source $SourceMapping2 -Destination $DestinationMapping2 

    # Verify the mailboxes exist and are available for migration.
    # For example: $VerifyMapping = $True/$False
    $VerifyMapping = $False;

    $Mappings = New-MSTeamsChatMappingObject -SourceConnectionId $SourceConnectionId -DestinationConnectionId $DestinationConnectionId -Contents @($MappingContent1,$MappingContent2) -VerifyMapping:$VerifyMapping
    ...
    $PlanSettings = New-MSTeamsChatPlanSettingsObject -DisplayName $PlanName -PolicyId $Policy -DatabaseId $Database -Schedule $Schedule -PlanGroups $PlanGroups 

    $Plan = New-MSTeamsChatPlanObject -Settings $PlanSettings -Mappings $Mappings
    
    $Response = Add-MicrosoftTeamsChatPlan -Plan $Plan -BaseUri $BaseUri -APIKey $ApiKey
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAE1HfhgNHk2J8B
# h7v6mEHaM3SabLZVFUfUG+yLYhwLZaCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCC24NoJfSwEtRPtO4Ppa/fkyO5P7CM58esn9TM7RMtMIDANBgkq
# hkiG9w0BAQEFAASCAYAkguKZ+7r3vJwoF8LsyDeD5yXjUFicCND4IY/i7+ANlfw3
# ctsqgnuWFNXVyRHKBfPWZJpK93I8j6nVxG8rhp5nkVUtsbKowDoSMMiRYvpalIuR
# l/jPEb7SjeLkK8FMSvdGFHHVl2qAJgCCPC454qwhA20K7tr6Cj1H6PXMdffUuQha
# D3INVzM4hgpPucKbDCLY18RpIopRsDnXhxPWbhmVpP4QYkLnGxpPWX33WRle7h8+
# gajr4mX53f/fS5X03lCZhsnfxMlkfWZLyDCF0m9PeaeesWROygcvNUPY2kMZccwn
# Uuo0N2r9HQ91RdqiRbs3SjZNBFGq1oTVvDtUvNyce0TtwL4wppGzh81yvyjP3Xv5
# BS959CojBWekgP4YqDiUxyu8PPIYLG4gd++UMV2LK5orKJYFqN+g1RwNupYjZUVO
# uUT10D81wsdajy6crROiL2pf4ioruPtmqNUNadcU9pP022azqmnBSAvO5lqmMoLc
# p45XaNDet0dn1IiidKqhghc5MIIXNQYKKwYBBAGCNwMDATGCFyUwghchBgkqhkiG
# 9w0BBwKgghcSMIIXDgIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEE
# oGgEZjBkAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgNnruZ+dcQico
# vWWTss3pfhfS101ZeJDrl153j82iGyYCEFiw+nOSmc6v2Tb4s+2TcTgYDzIwMjUw
# NTIzMDcxODMyWqCCEwMwgga8MIIEpKADAgECAhALrma8Wrp/lYfG+ekE4zMEMA0G
...
# DQEJAzENBgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjUwNTIzMDcxODMy
# WjArBgsqhkiG9w0BCRACDDEcMBowGDAWBBTb04XuYtvSPnvk9nFIUIck1YZbRTAv
# BgkqhkiG9w0BCQQxIgQgdNYQhMov6jQD60zp77du0SoM/IdRo+sqX8X/gutTZZkw
# NwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZl
# uQWTmEOPmtswDQYJKoZIhvcNAQEBBQAEggIAmRrytJy3jZx+fw0CNCGmEPZC/LX0
# Duc5AfKyZ0WqNZYJpAZpNg81enXcQT7tEAbjZUh6NJPs7/RXc8n42FBTbobLNP66
# IOa6Z4PUF+5ubuJAzf5way6kGznDK8ZmSuaW9tkVDlllDCk12xBAKTA2WwWVWPxS
# c6D6AhBxY44/0OJUJST/EFQolGAa3Sgo6k0S9SH+MNVTRUOQV/CrXXs/FDZ4zpEd
# dv8/wiAkzP37nLOcSXNlAzSdjRQESqoVE49S8OMv4b4SArVIE1QlXMe9cL5JBBRP
# nSjRPUWpryhaXiRzH2fYVigm4uXBwo0yAlg4WIy/IYxt9HJxMsG3Uii//maNXT4T
# HgNgVyoL9YKaSLEQnfDm32MFZHlzZx/3AGIcTmvR5HXpwUmFn7qTs16frtK3/Ga7
# AHqcW7NCgSODoDAFazjiIDk+G4pxwOP8R6WsEficJkmZa98kLnUPNqhocv0UWkXC
# devjMJcZ3E9JJ9W2SfV9EChbfFTQ1bBUE6XApXq4zh3HZfShnB+x5091U/NOUdRr
# VKFFVKfS+w4uszBlWjWpb8Fic4NJza5UR84RZgsJ4/w854FPbBteDBi5IYknOsXu
# oOlItoY+y+qkFg9wfXaj/zQWrkPjs/TQ7fyI4zKMU3NZ9leLHH9WCBrlS87vxEgO
# DLD3KXeR4Qorb2w=
