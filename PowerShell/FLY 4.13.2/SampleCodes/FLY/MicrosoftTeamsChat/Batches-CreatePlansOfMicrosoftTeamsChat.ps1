    ...
    foreach($connection in $connections)
    {
	    ...
	    try{
		    ...
		    foreach($mapping in $mappings)
		    {
			    ...
			    $Source = $mapping."Source Chat User"

			    $Destination =  $mapping."Destination Chat User"
                
                $MappingContent = New-MSTeamsChatMappingContentObject -Source $Source -Destination $Destination

			    $mappingList += $MappingContent
		    }
	   
		    $mappings = $MappingContent = New-MSTeamsChatMappingObject -SourceConnectionId $connection."Source Connection" -DestinationConnectionId $connection."Destination Connection" -Contents $mappingList -VerifyMapping:$false
		    ...
		    $PlanSettings = New-MSTeamsChatPlanSettingsObject -DisplayName $PlanNameLabel -PolicyId $Policy -DatabaseId $Database -Schedule $Schedule -PlanGroups $PlanGroups
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDj+bod8aMxdcnU
# QYaN0EIQSeBlt13xpYc681oA9B9PXaCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCANH5DGWYIYrdXlHHewbcHitOO+yxM0/Bt3i1t37cg/sTANBgkq
# hkiG9w0BAQEFAASCAYBm9tXWQDsc6hO6+NNbpQyi3rf1V9jCpkBb/CrGePVZCQA5
# e6/SKWUqaTAIRSmb18EKeNz7LX71fOF0omnAAXxlr5g9YYAd7QmD7QWx5N+fGqlo
# 7mXfY9fbNOouIjQv25NfckJeWkXNPYcMGkHQ5+lte9lWgyRefqIUxYZVvaenUJ8h
# nJwjXAKBzm7pOOVyUUKrOXJW0Y3nPVUPiIaCw9hDEcUHoLQzzlklKKV9tOa6FMoK
# CmdTYUOuKqCYqIvnBy/3b2TEl14lJHG+bu8P0sS3EFmQH4z8mH3vGF/o5fgT9jIl
# ZbY7h4zCzNEpBzv6hooKGwxb9Z03bDm9mWrpzqK7fu2DMoCdZY0LnfLsk7lY+Ixi
# Cd6QEZQp3wllni2OGmx07dRMCRXVx6w0GGWpORgl70rY7g5qHxgXUDhD4gUdvHha
# iaViVg3YkmFrFUkCZBkPMuOyLPQUvSW7atXvffm+MHUkCYnetWSqRRWnZ34Ixj7A
# OYRB4hyDR0qRY05gtZahghc5MIIXNQYKKwYBBAGCNwMDATGCFyUwghchBgkqhkiG
# 9w0BBwKgghcSMIIXDgIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEE
# oGgEZjBkAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgsPEKv3bXCB6J
# +vwhHSfUhRZ55DV2AocWwAztqg6vWuECEDNgkmZbtJeE5p+6Svy9qikYDzIwMjUw
...
# BgkqhkiG9w0BCQQxIgQgCATdQZWk2EFZ38yaajfmpHU8MaB+dFdJj+acJndNNP8w
# NwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZl
# uQWTmEOPmtswDQYJKoZIhvcNAQEBBQAEggIAmXn+EP0Zc4XF1kn05gZizVzX28hD
# bNY4jdtCgojfMFdAoSwcMLUzgFSN+NPcWtgbA/QAfwtjCC4Hiw5XCOcQZccfZt0d
# 07oS/kw0s0CBDuDL9zzvL1Bj24XWVIPVG0+H77q7O7vDmaEz+aUIq0aqCoGN4r8K
# oiPYSvvt87IplhZZHsH6KWfaz25ptFQP6RyvTzwyqS5b9yrwk601cysMPMT6A58k
# r2byF2DngpM5L6brsH2i7awgHHi8JUU5XIuX/v0AG6W1+KhKOzlv1w1VxHe500fO
# mW3gxftMSLvDjmt9L3V6eoC+JSENm9Vbe5IB6Fi5VriFCaeSDczGPezWHN/2YkFn
# y5OH7yFkMBQZp1wKgflns/xraB2oNP/jhlhQXKXHF6bNm4szmGdT383Fx2j3Eo0T
# ZFidF0S6p9uPD3WaCiyOrDUHhJg8DVWeIESRJKiVEfVlFrrNoUvsSpFIoyqeeKpx
# M3GUiurHFqczwwaWmbog/zStzrqu1azGE64WX3G5k73UwWboujA3RkcXHxLjboek
# 043Hyh63+cLO8PE80f0HInVfrUULmeoJf3uLJEfRV8N7W5rySqqv2sUWjGbUV4WL
# kHmFkC9ZCalLC3VMgYJHO7BFa1RmK5DqQFpbsq1Lwt/c21nsypbjW0Yi/3H1gk9K
# ziuZ2OqLIS3vLu4=
