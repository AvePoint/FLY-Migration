...
try{
	...
	$connections  = Import-Csv -Path $NewFilePath
		...
		{
			try{
				$sourceConnection = New-PublicFolderConnectionOptionObject -ConnectionId $connection."Source Connection" 
				$destConnection = New-PublicFolderConnectionOptionObject -ConnectionId $connection."Destination Connection"
				
				$sourceConnectionObject = New-PublicFolderConnectionObject -ConnectionOption $sourceConnection
				$destConnectionObject = New-PublicFolderConnectionObject -ConnectionOption $destConnection
				...
				foreach($csv in $Csvs)
				{
					...
					{
						$Source = New-PublicFolderObject -PublicFolder $mapping."Source"
						$Destination = New-PublicFolderObject -PublicFolder  $mapping."Destination" 

						$MappingContent = New-PublicFolderMappingContentObject -Source $Source -Destination $Destination

						$mappingList += $MappingContent
					}
					$mappings = New-PublicFolderMappingObject -Source $sourceConnectionObject -Destination $destConnectionObject -Contents $mappingList
					...
					$PlanSettings = New-PublicFoldersSettingsObject -DisplayName $PlanNameLabel -PolicyId $Policy -DatabaseId $Database -Schedule $Schedule -PlanGroups $PlanGroups  -SynchronizeDeletion  -MigrateMailboxPermissions 
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB1F/tYyusY5ruP
# d/h3OLOKhenVhIHo9PvB1ddpAacwE6CCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCBW7OKAu+dFSxYARNjk2V+tMyWKT1zO0SlCht45N3k26TANBgkq
# hkiG9w0BAQEFAASCAYCQkqLms2z21SCQUa3wIn3k2ikWfjhpke78ZPevjPHOvlJU
# ks3j/faLwu3JDGXrM0GGv9FjU6FGXmNehmHPOPqAi4axCVEtVgG9sC/4yVODme/z
# uHEM4vL6pNRMlwiFt2WtCFJRt8pXWFxAMrwMf+fnXrQ31i/GMxmwDHdiq04ZQspg
# kgNiB9YqSh/jBWtxQSZeM4v3X5T5Y73j5acv+w8gqcNmPrqhcB6YJFrSgRxi4kIu
# JmayP93nDOj/aFm9aatK7NdZ89C6BXF4mNnqvGGwlw0fMkzw1gn0fu5keIh7n7Sr
# HNYRYfNij98lf678AWaCNYP3gG6ozp3BM2c9wWVamjrwfYBQEpAdNC20bi1lvZyx
# kuMa2mspegUyCy90RIqpFBz3f7ZI4IuV4QP44l8Uy0dmIs7dxNx+g6I0Cxvpfw44
# vvDy4s8dS0+rqdzGjQghwZ1LFDduQqk4VeMKV2ssUhcV7CJdj0q2f8oZBqoF2baL
# Kv+7AufXA6Wwk61rjAqhghc5MIIXNQYKKwYBBAGCNwMDATGCFyUwghchBgkqhkiG
# 9w0BBwKgghcSMIIXDgIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEE
# oGgEZjBkAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgS0eP3RXdzKEq
# HF6ouvoRUWu4CfAoMBKj7wWXq/YOp9oCEDxvgrDW8XR5iSRgq0fPJw4YDzIwMjUw
...
# BgkqhkiG9w0BCQQxIgQgRJ+n8E0K5d+gv8McMqS2JDYh5/e0Mcz7K8N+0pHy2jEw
# NwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZl
# uQWTmEOPmtswDQYJKoZIhvcNAQEBBQAEggIAbltqESW9/ktn4ylqkOWD1rI8LQtz
# F1UmeCPgcuvCmXpy2+6Gxgw5HHqzc7NDhZ2p0g6BljxcjhkAwNDixPO4GRex1s1u
# XGTxEXAQ8MqSuMDln7GincheZlXIiPynY89U7ia8l5Y/aw9ta9fLleCtBHtsuDyJ
# TTyfObgoiZQxyfAIYoXUxxfv1XS5zTjYq8xzFgNlZOapd6AQM+KAxGqRmNNOcUgP
# 5PzRE5ewF4VUxGvBzQqhd50VU2LfEEfVycT45OHdb2KMUwjUEtCWMHYFoQJt5oH9
# TPpx0n8PjbXYwslp7Niu3qNHCiUg5rvOmCR6HoqbAYCTpy0YYEoIXE9dM62MxPGK
# B8HbagPOgWF7dm59KfDi1Ir2x6ms6a5m4Y8AFOzifusfmnbixRYS8Eyd7om3FVa1
# qPBuiDyD6SHgoouDbPuHX9Hh+cBUh4MtO0I86p+JDDJR5Ofh/Bw0Xr5k7Mh6PZwm
# T17cgdgFuQxuMRd8aqjRddW+Whdx9AT+jFez3oKfI0VA4lcSGAyUrMh2z6A4Icxc
# iyxKvMv2buuSZSUUGZLtgL/vrMgYd2nenNf/5/cG+9jtM9eOaHU40pYHJ9vUIuhA
# SHuk5WcMMv5pBhQNieS0yZCA43rtbJoehqCPca5/TUmwvQCQ2ZnxTXP9jOXCnrQ7
# 6twCRuCeAi9qYp4=
