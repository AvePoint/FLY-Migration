...
Try{
    # For example: $SourceConnection = 'Connection Name or Id'
    $SourceConnection = ''

    # For example: $DestinationConnection = 'Connection Name or Id'
    $DestinationConnection =''

    $SourceConnectionOption = New-PublicFolderConnectionOptionObject -ConnectionId $SourceConnection
	$DestinationConnectionOption = New-PublicFolderConnectionOptionObject -ConnectionId $DestinationConnection
	
    $SourceConnectionContent = New-PublicFolderConnectionObject -ConnectionOption $SourceConnectionOption
    $DestinationConnectionContent = New-PublicFolderConnectionObject -ConnectionOption $DestinationConnectionOption

    # For example: 
	# $SourceMapping1 = New-PublicFolderObject -PublicFolder 'Source Public Folder Name' 
	# $SourceMapping2 =  New-PublicFolderObject -PublicFolder 'Source Public Folder Name\Sub Folder Name' 
    $SourceMapping1 = New-PublicFolderObject -PublicFolder '' 
	$SourceMapping2 = New-PublicFolderObject -PublicFolder '' 

    # For example: 
	# $DestinationMapping1 = New-PublicFolderObject -PublicFolder 'Destination Public Folder Name'
	# $DestinationMapping2 = New-PublicFolderObject -PublicFolder 'shared@contoso.onmicrosoft.com\Folder Name'
    $DestinationMapping1 = New-PublicFolderObject -PublicFolder ''
    $DestinationMapping2 = New-PublicFolderObject -PublicFolder ''

    $MappingContent1 = New-PublicFolderMappingContentObject -Source $SourceMapping1 -Destination $DestinationMapping1 
    $MappingContent2 = New-PublicFolderMappingContentObject -Source $SourceMapping2 -Destination $DestinationMapping2 

    $Mappings = New-PublicFolderMappingObject -Source $SourceConnectionContent -Destination $DestinationConnectionContent -Contents @($MappingContent1,$MappingContent2)
    ...
    $PlanSettings = New-PublicFoldersSettingsObject -DisplayName $PlanName -PolicyId $Policy -DatabaseId $Database   -SynchronizeDeletion  -MigrateMailboxPermissions -Schedule $Schedule -PlanGroups $PlanGroups

    $Plan = New-PublicFolderPlanObject -Settings $PlanSettings -Mappings $Mappings 


    $Response = Add-PublicFolderPlan -Plan $Plan -BaseUri $BaseUri -APIKey $ApiKey
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAT6IfjpxOTfERe
# PxsGdbOIdHlozMuR+P5qdH3NQY4QmaCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCDzURyTD/vP7u9nUJUSXy+1za1mZCuTwktFLO1MieyImTANBgkq
# hkiG9w0BAQEFAASCAYCzy6IGuoBUgU1wxXHyXglEIN+MHKDmsSWzmZkEEa0X/LL7
# l237gTpdNNa1hWZsxiMM0TKdNxpRpMuSDLi9WlRB+OUg9ltwIp9lLcQJtJ6TMr0f
