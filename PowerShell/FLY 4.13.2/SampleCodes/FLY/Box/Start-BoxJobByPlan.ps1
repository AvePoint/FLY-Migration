...
try
{
	# For example: $Plan = 'Plan Id or Name' 
	$Plan = ''
    ...
    # For example: $Settings = New-BoxJobExecutionObject -MigrationType Incremental/FailedObjectsOnly/Full/PermissionOnly -StartTime ([System.DateTime]::Now).AddMinutes(2).ToString("o")
    $Settings = New-BoxJobExecutionObject -MigrationType Incremental

    $Response = Start-BoxJobByPlan -BaseUri $BaseUri -APIKey $ApiKey -Id $Plan -PlanSettings $Settings
	$Response.Content
}
Catch
{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBvOPdbq+0V8F+f
# ynvCBMPMtcOQpoC1yA2fFZaxV+OlQKCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCAWd2AKgNP+HXGPLQd99Xae4NP2Uf1gRmwWxQh71zP20jANBgkq
# hkiG9w0BAQEFAASCAYAKxHAiex9DKoB9iU0UVmPI9AmAO5xZoDUsYIHScQV26eut
# lEdTxKrxxVscXEspbWMSuF/SF9YVcDkXW8yslhDgkDtbMMnw+zLZ/njBOKv/Foqi
# 7EC/d1RhLG2dUDPw6DGlpiKz+XiHz+znNgWDJLcU+Xinc3Lm+VsOTyyZFGMY0q+1
# WEQNRKXX+RqCXoH6rmTUqQGCADbB8eMYlVXUT8Rypn21xTCEMVOpZRDFfK1oifBH
# ZMquwuaHcdr0qSLUTtiQzaelinYUfBiDfUQoAJCj6DdR/vOX7Q4+UZqWuQFGT8G3
# +YB6IawxpjuK6Xw9tCg1dvjPO28sX2NRBCmUbkMfAztChR605VxyaSfNK9Fda5PA
# 8XOJqLnNUQ9MDXpo65cQFk+ubFwwd1jwX/Ut5hxThnPzwxPhdl1QUAZw5xrWg0s8
# NBgr+dGV6BHtHR0EJsY78W/kAir3jmACZUpPkdxMUjWZF4oQHOnLai5ydId0ZbgW
# e1X5MfZZUZoyCIqvfJShghc6MIIXNgYKKwYBBAGCNwMDATGCFyYwghciBgkqhkiG
# 9w0BBwKgghcTMIIXDwIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEE
# oGkEZzBlAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQg2WxyX6H3Fyrr
# 832HIt7MFW1nYePOZ0pNv3nAIZiPZLUCEQCsM88/D0IHVlG2ayWe/Ab0GA8yMDI1
# MDUyMzA3MTgxNVqgghMDMIIGvDCCBKSgAwIBAgIQC65mvFq6f5WHxvnpBOMzBDAN
...
# LwYJKoZIhvcNAQkEMSIEIK0vK6mRdiy4wJ4uGBp7G5ofEVFLGOaVvIvb7QGKzC3C
# MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIHZ2n6jyYy8fQws6IzCu1lZ1/tdz2wXW
# ZbkFk5hDj5rbMA0GCSqGSIb3DQEBAQUABIICADukcWYk55BxH791CVIfJpR8jNmP
# AD6PycsuKzVjVJ3dDsqtYpyBgeXIhdlJrCTpA+YDX37KFcuDvAqCS5+ux+G0CCOy
# zx0QgpaZOMcf5MXvcKgAW9hEOD9Q029C2HfiPoniCrYZKzt5hVia68r+rQuovJiC
# YrNsPKL0r0StdNd2ziobz65uvv/a/Ijq3zvizJAHQ9hSGmOHeTCUlIsKT+ia0x72
# mnunjTVpLuuQ472PoljEt/2RIOGLGhRG3leVxR9wpSlkNNyb0RNSLS2C0wx/OnBK
# s2SyDDdoURKTDtZHpSvDZKCi5B0fQ27yoPWR2Gov53WzxLE9x4wQagfDHI5Yp5tp
# BRLZ5s3nBGpMnMeG2IN45l96tI+QC4P0SohxNwkZhyRIYenj1M9kThkmLacjta/3
# xoILmAztF6rFvGxk/IFzAop3adoOrgyV0iwt3eo4CQV/4IIXlm8iX3+v5YB9E6cO
# N/zHmxSuQq7hppHLyEFlGNWDJjeQGm/zDV/EUSp6vP+HT3NT5tSsgyEiEiS0j6mn
# 7omfoDeR4vxQQV+XTL64Gxw+Epmnlh4KWE/xW0f6H29YkgLWjyewE8YucS6NzZ9w
# 4i2z60Tcj5RI3xE5sEtyq5e/j8sAp6Wzd3HMNpWT0scxLDvGeHIlcVLEtDKCpmDl
# OjYPSr1t1NOt5Brs
