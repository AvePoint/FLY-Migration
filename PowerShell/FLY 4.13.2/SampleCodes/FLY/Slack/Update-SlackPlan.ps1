...
try
{
    ...
    # If you want to keep the advanced settings on the settings page, delete the corresponding parameters from the New-UpdateSlackPlanObject cmdlet. 
    # For example:
    # To keep the original 'Migrate conversations as post messages' setting, delete the '-MigrateAsMessage -ConversationsMigrationAsMessages $ConversationAsMessageObject' parameter from the New-UpdateSlackPlanObject cmdlet.
    $data = New-UpdateSlackPlanObject -DisplayName $PlanName  -NewName $NewName -Policy $Policy -PlanGroups $PlanGroup -DisablePlanGroup:$DisablePlanGroup  -Schedule $Schedule -DisableSchedule:$DisableSchedule  -DatabaseId $Database  -DisableMigrationDatabase:$DisableMigrationDatabase -MigrateAsHTML -ConversationsMigrationAsHTML $ConversationsAsHTMLObject -MigrateAsMessage  -ConversationsMigrationAsMessages $ConversationAsMessageObject -MultigeoTenant $MultigeoTenant

	$Response = Update-SlackPlan -APIKey $ApiKey -BaseUri $BaseUri -Settings $data
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD8r9W5aelA+OKN
# LJnqJWRNAoqjxpj53/X12MN3A6qzPaCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCCNLtu567z9J8FYqPZ9T1YCXVViAyWtwe2hf6PljVge0DANBgkq
# hkiG9w0BAQEFAASCAYAmyR2fKAIXrcu38QnqHn5Ac7Gudy7FPNVDZl+Ue5p47z2H
# 31RmUb8ogsQoJ9tQnbbIk0mZO6etXiaL1jrNg1wj/1+ZW0euKWYUgAxkjZmv3tUF
# eZcHU0qM2rfa+mQ21MLG2J54z/s+Xoj5aUhjZOUfo0PP5b96xTSO19qSlbcyXixl
# IB3zN86HRLFlAyZe6x7O7I1Ywj/E68efhpYrC8FoGcYuRBwtwp88XjNw1hNxrmoM
# W9PZNvwfsoGvVlzzWWYcGE7/pQzi0osNPzcwSaNMvxT1Lt9PZJk5EZq0vJ0xlRIC
# TVEhJ2+Tqab9fGyvFTDYXvTxHxa9leGQ/KoRXlNO/0/pZ+6gP2uUPfMOA10eCw0R
# 4Adv2p2DNJlHWtCCRdoEORtaQRWRNtnLPb7tJPrfgLYzxq2RmtU+qOCKhVVMQkGt
# Y8RtrBL3RVtprmlg3hp9kkqebqW7T7dZWLrLERPjFTqiMQcwBdW8PkGZ22XQRJbL
# eJBQNPn4rXXmPtAiJkqhghc5MIIXNQYKKwYBBAGCNwMDATGCFyUwghchBgkqhkiG
# 9w0BBwKgghcSMIIXDgIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEE
# oGgEZjBkAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQggYQP7NEmhjh1
# FcfjAnN7jNWsJDFPAK11Z+sn/SB3e2gCEDbhLK2J+k5kq+PD3w5ffREYDzIwMjUw
# NTIzMDcxODQ0WqCCEwMwgga8MIIEpKADAgECAhALrma8Wrp/lYfG+ekE4zMEMA0G
...
# DQEJAzENBgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjUwNTIzMDcxODQ0
# WjArBgsqhkiG9w0BCRACDDEcMBowGDAWBBTb04XuYtvSPnvk9nFIUIck1YZbRTAv
# BgkqhkiG9w0BCQQxIgQgfzpTc1XBIToDjLhmh2mZij9DGlESKJlIBoLHTfO9A9ww
# NwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZl
# uQWTmEOPmtswDQYJKoZIhvcNAQEBBQAEggIAi+8FOPvoQLavv/rLAK2CVFta29g8
# m6ZvTnKA4noVLZXfqKUwHfQ9mMVPvg/0gWe7GcMe6dVgAogKa6vrJ9zngoohgd81
# 1ebNhsGLmUs7bRLUik4yhPq8DMfohQKRIFg70GC9x81J52+aN28Wb19bpR3SpA0W
# RmOwIbBUfIJWL4cfJm7Zu7NLLE22N0lONG9LTjwOUTWe3cBsRcmcvGv8w5BoklFL
# iSZRVjZNCwyDlW9Zszb7Eyen6fM/ghT5PsnOLcx/JWDo3GVit2Eb8B719SIrD04x
# 8cnaMwJNW6ekRPuAdUpNg+bGTFQBVdUoCqka4K/iObDqUOjaINaRzifh0dPxXnWD
# rE7VY5IY9O7YAiqGX/21dXtBOcfeBiuEPP73vCgOkayxHHsN6sLc6aJuvSdz8wcc
# 6+R9unPYPiMrlgl3bihSIw/SONGkKRF4K/XF+4EIOZxmFMOiBVPCmEJFHqMiF8yD
# O3vkupjAJUvFuoJFOHpz+n+t76JY94twQLoSUQ3BjJaLLxg5HXHAZy2yciWD/DPg
# sdTFhIt35I00WWWtcYZgIOdpGmj2A/u6YOM9JsKLFQ5yipkvNDofdZUyv7HpNW6w
# MAcKUTj+hqbYEnY9rnjXHsAy5H80PV8M9FyBzIEQUM+e5HSdUBrfEEXUaQnFUtJc
# hPf2NHATWx9Ms20=
