...
Try
{
    # For example: $plans = @('Plan1','Plan2')
    $plans = @()

    # For example: $data = New-SlackCompleteObject -MigrateMembers:$True/$False -MigratePrivateChannel:$True/$False -MigrateSharedChannel:$True/$False -Plans $plans
    $data = New-SlackCompleteObject -MigrateMembers:$true -Plans $plans -MigratePrivateChannel:$True -MigrateSharedChannel:$True

    $Response = Complete-MicrosoftSlackPlan -Plan $data -BaseUri $BaseUri -APIKey $ApiKey
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDSOkUwBmDudkTv
# bSs7jaVfEdj3NX+W6GjMub/noWvQX6CCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCCpYnuBYX28XY+uEZEqHlB8DNcL0KMWl6VM9Hh7CNmpKTANBgkq
# hkiG9w0BAQEFAASCAYDcO3HnHbhb595YZ/8Xwd68nJnYMV3F/RcP803ZRrGiB+nO
# h/brW3QH37BgKEobEvzY/+NHqo701O9sh2cw/ETDD6p9BjpLmwcP82uI9BRPMZDX
# iltl8Zp3BpbOBkNA/4bVnurit83lN9Lp3rc1sjAZ3s8kPAA/G7/tlhlLKinLZVvN
# R32TWC8P0advaYFSiujwFYYwg/SlOn2Dp6UlMoypfMK8zDF9jdk+04W/HqST9zin
# kev7Up1fnC0cIISOH7rmCICiOe1RM/4cayVli11s/bxDq2wo0eWns/U/c2zMOIxJ
# m76Xz/7eUMCVqRLvhuwut/uV1BNxuSmRueu13xtRnxJVde94GA5IQ3a82Lfm/H7V
# da8CUAGVcAs7K7gP32cMs/8ibD8o8hOBrBxz5Ex/7jOjLlHturFSBIGpe+tFkWli
# XpU5EhyL4OmvdYBOuFiYk8uUxNIMEGji2eOFfiqX4yChyGjD7o+WJ9jJqlDfYppi
# 62AqU4jNtSOR5pN5AtGhghc5MIIXNQYKKwYBBAGCNwMDATGCFyUwghchBgkqhkiG
# 9w0BBwKgghcSMIIXDgIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEE
# oGgEZjBkAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgSOL4wO0Oy5Yf
# JTigevQVzYnldu1h5GKBCgBYMI82u/MCEBk3rol8NVuITR1VpXHDyWAYDzIwMjUw
# NTIzMDcxODQzWqCCEwMwgga8MIIEpKADAgECAhALrma8Wrp/lYfG+ekE4zMEMA0G
...
# DQEJAzENBgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjUwNTIzMDcxODQz
# WjArBgsqhkiG9w0BCRACDDEcMBowGDAWBBTb04XuYtvSPnvk9nFIUIck1YZbRTAv
# BgkqhkiG9w0BCQQxIgQgTBSspZKy0drrjHhx6F+BzHIW/G0c12CYrwETnaW0Y+Uw
# NwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZl
# uQWTmEOPmtswDQYJKoZIhvcNAQEBBQAEggIAQClxDVUpeR2WPmWUDmFTQu0dgb9M
# meRdBva9mrLldo8KRHMYlClozfkMjwSFiFLxP1vP93a0zQ0xwmqvdPDvAyascnV2
# y1up73rg63S+8FzOC0d1KhTk0rL3tIOCmZwLEqcamy50Xd7ApMQWr7xH2zsSQAqS
# 86cUy6kUBEm4rSud/5zOaazU9EPz0YpluMBaBPnUFURFEerM8aPwoCGQcAW6RhDP
# F85ciG0Z1ovDzaY793ilHQpjhZmEaFcqB7Dr5LGLuGrJszbCUgF0TJZzuwLCgo0U
# Ee/By9oLhhybDYzB7dcu5uI4HkNGQiT8R/0qHbuLZu+ck/vb28nkR5SGhNXuokfN
# Ec3uYxuUpimWDCtDF3A3jW8A7kI5T2F8CjRRHptAOKS3S42jE13hLbjjJdzgdPSE
# URDCyvrBhdmC9W1BwKlJl2eowIxlPjz2nNNSB5QkoK6lKlDcsxQed/yACV8MBtcc
# 2/EtGRBiUnb85bNaYcsJb3vp8fO2JnTKEY4USBjr87DbMcqfYT4Ln+6h0Jv1eqYk
# 0lVElN5AVWvnf5rsBe+3r7YuH8RIG4MguDYUkXHN9mb1RCko5RSg5VY864WpeYBx
# G7x9BhpE/tzu8+0waVNAgFgypLD2L7kY4/7P0sGq2Ds3s2dkW0UfHSXAt0O6iptI
# RHA1+BzV75a3WFU=
