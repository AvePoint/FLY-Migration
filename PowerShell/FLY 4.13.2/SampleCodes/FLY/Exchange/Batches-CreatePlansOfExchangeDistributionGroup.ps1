...
try{
	$CSVFilePath = Join-Path -Path $Path -ChildPath 'DistributionGroupCSVs'
			...
			try{
			   ...
			   foreach($csv in $Csvs)
			   {
				...
				foreach($mapping in $mappings)
				{
                    ...
                    $SourceMappingObject = New-DistributionGroupSourceMappingObject -Mailbox $mapping."Source Email Address" -MailboxType $mapping."Source Type"

                    $DestinationMappingObject = New-DistributionGroupDestinationMappingObject -Mailbox $mapping."Destination Email Address" -MailboxType $mapping."Destination Type"
				   
					$MappingContent = New-ExchangeDistributionGroupMappingContentObject -Source $SourceMappingObject -Destination $DestinationMappingObject

					$mappingList += $MappingContent
				}
				$Mappings = New-ExchangeDistributionGroupMappingObject -Source $sourceConnection -Destination $destConnection -Contents @($mappingList) -VerifyMapping:$VerifyMapping
				...
				$PlanSettings = New-ExchangeDistributionGroupPlanSettingsObject -DisplayName $PlanNameLabel -PolicyId $Policy -DatabaseId $Database  -PlanGroups $PlanGroups -Schedule $Schedule -DistributionPermissions 
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBKEv0JDWykaxwW
# Hea2W7qzeiMR+RTYG4HS/iXph47vJaCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCBpN2RdwSkyehXn3i5KF2xrxXEQivsDp8Ce4HyaWplBfzANBgkq
# hkiG9w0BAQEFAASCAYCtEyevyG/CdbR9kcRGDTyIJredoD+JjzlqOlgE+owYPa7T
# 7bk/Ss2rh8PR79fZ+u+AeIB03XbiALM0cDcufG3ILRF4y0phanLFFn0s1NXxSnkL
# YpGGiwujCRL3VRSQUYnWJWG4Lr+qX3rBxXGb1y7Ogq8Z3NMIFB64sF1cEdw+luBs
# yeS9KYodp/vqmUnQS5lWGtiZRO8K4w5VqOU6c4sB2C2zd4gkVCth6IUhRhKw5/rZ
# FrtKQoDGSi5VMWYmn1KWNSOIoLvo2qOYIfl8fTnVdGj8PwXINrnfODkZKmHyYERm
# JBGlp5fBkB8b3iCDktxSDc4+fN487eDAMyI4FF01luG1WYWUgKgDH3HXbUSow/7h
# U7Gtb6Y4H+ZBTELSIPts63wtb992ni/arEVY4MKVmWOwfGcSABTkLnO3pVHxzTID
# bnBHjIIOBOXdW3jff6C3hEZurin7as9/cz7qk7Ep8QXTs0P63bZ6UoZVYyeIKFMb
# XVfy6MoEoddBFsIQ5wuhghc6MIIXNgYKKwYBBAGCNwMDATGCFyYwghciBgkqhkiG
# 9w0BBwKgghcTMIIXDwIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEE
# oGkEZzBlAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgj3H9U68/OFlc
# QxVOeCKmbyFdHLyx0TE9XSwG+BNAB/ICEQCiw0uATvcfGWn8uGyCWsWxGA8yMDI1
...
# LwYJKoZIhvcNAQkEMSIEIEkWF2SPKaqIkEVOP3XVs/I33g74DVyv6q7x3n5TdADC
# MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIHZ2n6jyYy8fQws6IzCu1lZ1/tdz2wXW
# ZbkFk5hDj5rbMA0GCSqGSIb3DQEBAQUABIICADqKbUuiIwQTP1j8u9VDbKAYtvOp
# l+2qcdASMbtQ9TBp1jVHlMKg/zXKqweRO9GIyLXSbiGyts9JTnr7zlHoBoyAbIfo
# nFIU1vtcaSyRUyFFwfEpSyP1q383RCqHn6P7DjgeQsb7bxGhVP87VdLnrhW0riO6
# KJ2bOcLT2lskjr/i0dcMxZqepf8qxhfBcwBlYStRRCTavAqXyY29iN1N+m0sW8h2
# u/lH7ivZO84ocCPcmRH7/+6PZdAN3Ujxrcl1GLwrKJucXCHqY7HLusja+t5jf063
# Qeot8B2DN5cohs6knLMh2L1e7J3zbHZ7kN89o+23kN9ZvZ/sha54p+GpZo/sZY4O
# Fg1dlxJuAuHAASikwLflXp1DLfXHvtIvsr7l5CQJnwOAYmKHiwEjPUdYYvVkKr7H
# 4eM6qbiVmm8pHVq35TM20QNBYtATzuW0p1efKKb6fR3d6WlsQeQpCEMSm2y4LpUC
# e5FoqxdRgPUvMMwamuSWHR4T6P3DK0BxgGVy/WAJwwAvkfBDFRnl7iBQs/oov1wF
# ruZWiT76839VrRpdBzf7TeJg+5RMHTs7retQIfL5W12Lo0rPt+gGJZTqn8XlHUC4
# DpfpG8skI+30vki0/mZ0bQbG9jPWBLALpQns7uGkMDIxhYuf0GqN9wua54amYKn4
# a3as9Zq87WnhprLv
