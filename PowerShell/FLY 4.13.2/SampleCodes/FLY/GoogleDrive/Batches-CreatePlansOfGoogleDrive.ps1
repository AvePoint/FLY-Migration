...
try{
	...
	try{
		...
		foreach($csv in $Csvs)
		{
			...
			{
				$Source = New-GoogleDriveObject -Level Folder -Path $mapping."Migrate From"

				$Destination = New-GoogleDriveMigrationSharePointObject -Level $mapping."Object Level" -Url $mapping."Migrate To"

				$MappingContent = New-GoogleDriveMappingContentObject -Source $Source -Destination $Destination -Method $mapping."Method"

				$mappingList += $MappingContent
			}
		   
			$Mappings = New-GoogleDriveMappingObject -SourceConnectionId $sourceConnectionID -DestinationConnectionId $connection."Destination Connection" -Contents $mappingList -DestinationType $DestinationType
			...
			$PlanSettings = New-GoogleDrivePlanSettingsObject -DatabaseId $Database -PolicyId $Policy -DisplayName $PlanNameLabel -Schedule $Schedule -PlanGroups $PlanGroups -MigrateVersions:$MigrateVersions -MigrateLastVersion $MigrateLastVersion

			$Plan = New-GoogleDrivePlanObject -Settings $PlanSettings -Mappings $Mappings

			$Response = Add-GoogleDrivePlan -APIKey $ApiKey -BaseUri $BaseUri -PlanSettings $Plan
			$Response.Content
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDZ/3KJy1yYkgDJ
# HqXNeFjGoMUu+h3PHy5kJUWW8uEzx6CCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCCdkw8Gnqx2F0SwIy+eHJQxq+4fiFIhM4HsCD2LSG5f2jANBgkq
# hkiG9w0BAQEFAASCAYCnay0tOAX/7xlDleDeep252JcajhvDXt7WSQbU/cnwmbPM
# GtXD/SKZWOqlR+L09Qg7QVP9WMj2GrQFTGQaNKWGKalu/jV7zEsur3KcgbVJUFu4
# LcgTWn7k1Fk3JM+8QdzKldgGmY7tWc0/xvieBdlBxN2pd5C13dqPdNS3Ty+dMlmc
# PIg9nMk5i8BY5RD2JWb1mKEseaDqfJg/ACTAUHlqhxD2PZOeU0nEQrp7s97Fqz55
# vu2JJBTV/OgwW7TCnFghqGsIOJFUEx+0jiSALnx/s2Z30/XglU2mjHMuiJZQRutI
# QCw28DIOH/QcYVc3WW8yTUqICXQH/rzFKP9UWSwefyV0DBTQONP4LCNIBK9JvuBF
# W1inAsu9DWEelmRPexmnksQHfwWiN51OFtbKopW1mUCseN3Rky3hJ+W1QvNrTbXS
# BQoxHLtJHkQWahXpmKGYihY21v3qv8TEP/vg/x+Cs+XX1uMr5rhKCWWU4RHqy0M1
# U+q1ObbLXv/1jz9zdt2hghc6MIIXNgYKKwYBBAGCNwMDATGCFyYwghciBgkqhkiG
# 9w0BBwKgghcTMIIXDwIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEE
# oGkEZzBlAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgKdM2DKGuhOw8
# YDEMP7jDvNG3laoHNRlcY1V///0TMRECEQDMm9wwsikbd/4EMm+he5WTGA8yMDI1
# MDUyMzA3MTgyOFqgghMDMIIGvDCCBKSgAwIBAgIQC65mvFq6f5WHxvnpBOMzBDAN
...
# LwYJKoZIhvcNAQkEMSIEIGl64flEyGMgtHxd2ZLnm38VLCOe+VwVlw9k92/JiXqS
# MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIHZ2n6jyYy8fQws6IzCu1lZ1/tdz2wXW
# ZbkFk5hDj5rbMA0GCSqGSIb3DQEBAQUABIICAKJyj5EMcquzyI4fQFsoi77ZTrQH
# emYcrOrfQ0ZXHSkYVSZsWAa89dbCZ4hwRjW5cMl0b5YGuCMWywUQgvXfrmIoouIf
# msZedFE7nSRjDIZK4B/JbKmLuchPJWPpB1BHKIe0/PbKq4jb07pIshNYPZ2OGxD2
# PLXS/4uvQfegkOUY03FxlBwN4Wwjvls/zwAjHt2bXPsPPeJDVsfReaJ0OBADQQCo
# 2/xfLQpuzl0YH+zACKQUrN74QURNfT4CE4848O/CY6J1wTezI8etA2IRlUM2EOq8
# AnWp1LJA/es7gda+ZLZTs25Jxgsus08Hxv8AFnmIYK9vEtyr6xNfF0Wy52JzC51X
# vio4c5iPzsbS7ogJSuTT85xJ7Sxi6BZEIilyH+OezIchlgrrfqEmfx/VFBYv2cSU
# XYDV+DTl1G6XYKICVZHJxI4uW3iyHhOXIDX+ZTTkaL/KMAUkg1XzFRWDwy23afFl
# RbymLnmpujtKHH+i2MAOWiJ9dy+9UGVx+TjSuUyyFBwm44u+PHDDT0VP53ULl7C9
# /qozy1eMCgKXK5aTdU1vjSq7cfJPVBmQY6EhC7Uis/cN8vNssV4emJtiobZGHnbn
# PJfTnIsr3Jv/zIt+njyArmqKijVatIJlh2+lAG9quLxOD8U+brh7BITEscSF2Cqo
# 5VtD2x/E4ngqcWT3
