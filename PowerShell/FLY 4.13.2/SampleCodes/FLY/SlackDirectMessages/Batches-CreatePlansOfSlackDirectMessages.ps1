...
try{
	...
	try{
	   ...
	   foreach($csv in $Csvs)
	   {
		...
		{
			$MappingContent = New-SlackDirectMappingContentObject -SourceChatName $mapping.'Source Chat User' -DestinationChatUser $mapping.'Destination Chat User'
			$mappingList += $MappingContent
		}
		$Mappings = New-SlackDirectMappingObject -SourceConnectionId $connection."Source Connection" -DestinationConnectionId $connection."Destination Connection" -Contents @($mappingList) -VerifyMapping:$VerifyMapping

		# For example: 
		# If you do not want to set the Schedule, please remove the '-Schedule $Schedule ' parameter below.
		$PlanSettings = New-SlackDirectPlanSettingsObject  -DisplayName $PlanNameLabel -PolicyId $Policy -DatabaseId $Database  -PlanGroups $PlanGroups -Schedule $Schedule
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBlK2n0KKKpciBK
# Sya5v3+5gghfW5IH8gwsBBc5o0/nKKCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCBsmQecXYXH4HAemM0iWoTNYavzK9HHticO/8kKR8Md0zANBgkq
# hkiG9w0BAQEFAASCAYCwokZrz3uWoYSPR99DdZzmyaG1Gi9e0npkiM+11w1UkTGj
# kyo4iZHuiRI/i830g79X2gB6Cfr/7BeVt1+ZaraHoPY4BoE/xA7lnRtLgQICM2QJ
# hhctXoD+aq+XaxT/KaLSkrEoliU9r9h/1WxNnocW11WeL+hx708FZWzDqredq7Wx
# Ic0KVQr9Ld/8aQGrHSgsUEWqGvtI6XJ/N8rLc5RwgkBo06t274idjVdT5nhq26je
# yxlsIcHyXtaJsME90ShD/xETH0Tpd1l5YU/xs7caoPKABJ22U8KSJ02V7OdJl7C6
# 3I1HFGodcoLlsT9CRBgsqhVDVeuS04VHET8j/xjUGmJ5HQNAL/P1gwNBtAV9Rvin
# mNVAEGQ3xBp6Z31FQERVxYY4idRY+8nnsIi6n+N5LH1EKcg8sPw4sBgZI9OKGvI5
# bowYFG4VcBPuM/yJp1QhDZAyLvYHRjDBoNYOMCMsNMTrfmU85WGjUoKakCNGNkrF
# aOmEBkJG3NniUCNhHIqhghc6MIIXNgYKKwYBBAGCNwMDATGCFyYwghciBgkqhkiG
# 9w0BBwKgghcTMIIXDwIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEE
# oGkEZzBlAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQg8Hi3YhFxOoTh
# Yd44PWscPzQeByWHAdvrzPocWQ0ui6ICEQDvtW+dgIKd3X5SO6XHeNa3GA8yMDI1
...
# LwYJKoZIhvcNAQkEMSIEIKmIPiQBYZ5WCismcnPEsFAphZ99fGEcHIe67Hx3WMb7
# MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIHZ2n6jyYy8fQws6IzCu1lZ1/tdz2wXW
# ZbkFk5hDj5rbMA0GCSqGSIb3DQEBAQUABIICACzsKw2znpATd4XnwLNP0KMF91pA
# BRBARgztxK6j6YkPahsihE2ViKVepBlrfpmeqb/PzW386WsfSUzfq5vaVrUGDzUI
# gvliXGOwwbBK5Y+ZCMhgjGW/qTm+U2m01ZsQQmFbgVpRWPuISe3MrA1yzhIsvnxR
# o8pAQjX0DcHXnqRG7k5GHTA4VyxMRyOxIrWNK1jG2EfOnFGoh4oWw4s1PAdGEFAo
# 4C4eU4ACUQYUfoGg9r4UCXqSKb0fNJkLxLBAzDjHzwVIlQHMCo0ZFqxwSapiWd90
# HKbgupk+uytHEwmj2TVNDPMu5tBtbsjafnInrOAjfrMa2Uv95xbk0DnOa8xAvAXt
# tV5lkOF0jHhE/N7AYpbqtEkdpNwnbTKgPlktfUOn/vFmtfEkx9l2N1IRpFPonN4I
# dNfHDxlm0nDdQXza8sBfSbjiGzJ5UuCDyldoEdaX3j2WamhsjwYp9A2tQ0Wmdq6k
# fVClH3PboGkjKkAUbQAc2cOBlpgaGZDuptETFHboWZTQq9NLaWcuPmNKz7VoOKUp
# T+OA04/45EF7SZCeRmI1k9ZcUqaHi6K3+gHZS8qgle9mFUTjtNQFK9/h8CwKlnoH
# pakid4HMkbf3OkOwcgNF4JF9aH+pz1NJjrdm6x1D6YCa5g55pP8ODWuBm4ey3RB4
# oDmDEkP8pFvyvGKE
