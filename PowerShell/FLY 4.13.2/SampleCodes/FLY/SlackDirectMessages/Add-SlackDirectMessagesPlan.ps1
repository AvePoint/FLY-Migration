...
Try
{
    # For example: $SourceConnectionId = 'Slack Direct Messages connection Id or Name'
    $SourceConnectionId = ''

    # For example: $DestinationConnectionId  = 'Microsoft Teams Chat connection Id or Name'
    $DestinationConnectionId  = ''

    # For example:
	# $SourceMapping1 = 'User01@slack-mail.com'
	# $SourceMapping2 = 'User02@slack-mail.com'
	$SourceMapping1 = ''
	$SourceMapping2 = ''

	
    # For example: 
	# $DestinationMapping1 = 'User01@contoso.onmicrosoft.com'
	# $DestinationMapping2 = 'User02@contoso.onmicrosoft.com'
    $DestinationMapping1 = ''
	$DestinationMapping2 = ''

    # For example: $MappingContent1 = New-SlackDirectMappingContentObject -SourceChatName $SourceMapping1 -DestinationChatUser $DestinationMapping1
    $MappingContent1 = New-SlackDirectMappingContentObject -SourceChatName $SourceMapping1 -DestinationChatUser $DestinationMapping1
	$MappingContent2 = New-SlackDirectMappingContentObject -SourceChatName $SourceMapping2 -DestinationChatUser $DestinationMapping2

    # Verify the user exist and are available for migration.
    # For example: $VerifyMapping = $True/$False
    $VerifyMapping = $False;

    $Mappings = New-SlackDirectMappingObject -SourceConnectionId $SourceConnectionId -DestinationConnectionId $DestinationConnectionId -Contents @($MappingContent1,$MappingContent2) -VerifyMapping:$VerifyMapping
    ...
    $PlanSettings = New-SlackDirectPlanSettingsObject -DisplayName $PlanName -PolicyId $Policy -DatabaseId $Database -Schedule $Schedule -PlanGroups $PlanGroups

    $Plan = New-SlackDirectPlanObject -Settings $PlanSettings -Mappings $Mappings


    $Response = Add-SlackDirectPlan -Plan $Plan -BaseUri $BaseUri -APIKey $ApiKey
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBXsIF6zDT4orvO
# lEE4AB4GTnMGybcIpObtCiGE5djy8qCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCBo6X7CvdAqDXu8NnM4vsBmI4H+0LziVj57McC5BLx5MjANBgkq
# hkiG9w0BAQEFAASCAYBeiGjzQ1cvpC8FUIxGZ4vYE1bn4sO2ay+hcKxohSQu44si
# KqhTdx8ISDYU+FzKh4oX2W2TAVFahS9TGQWOD3DHop8r5e5vRZqxV+ovMDL+JGGE
# c9U/ue//emSUaDkaFHZu600wX4V+Eug2sieeiApXUl6wIxIat3HBepHN0DCMT1e8
# lJIPq2V3tP71NK7GXbTjW0Pid2BZu6FAQlI49V7BpDcqmn0cWghhDgpY1r6QpkxO
# 7vhQKvFo47g7Z1NrFqSIA3Wzy/CnthCqLOie9hkX4VUwkQ8RPHw3FL4B1kFW5zlM
# Owvtl/JEmvz1LXsGTyLV2TdsTQrSmVxpsdAVOgAJ7h5Jz0u7xfUxHQruuwOmOjK6
# SNaY3GB01neQJf4tNma2XJSk6Xxtel2uqatBcxQfIkcLD+htQILZtymCFobq6aKv
# rFD5BQY444ejzFrp06UjgNFZCr/u/szTqbEwpMa0Gs+s78yHjlGnUZdCx8HZ/A2F
# XwAw3f7RjSsLihI+7+Ohghc6MIIXNgYKKwYBBAGCNwMDATGCFyYwghciBgkqhkiG
# 9w0BBwKgghcTMIIXDwIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEE
# oGkEZzBlAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgXLe3jqOmh4B7
# E1g+X2XR1LJESsSgBHmSTvGDGZRswsQCEQCda9DYbjVAQFxw7gJez32HGA8yMDI1
# MDUyMzA3MTg0NFqgghMDMIIGvDCCBKSgAwIBAgIQC65mvFq6f5WHxvnpBOMzBDAN
...
# 9w0BCQMxDQYLKoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI1MDUyMzA3MTg0
# NFowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQU29OF7mLb0j575PZxSFCHJNWGW0Uw
# LwYJKoZIhvcNAQkEMSIEIO20/rRoBTWe2MetciKwBuDv0aQfSAGy9Gvx1g9PoRPd
# MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIHZ2n6jyYy8fQws6IzCu1lZ1/tdz2wXW
# ZbkFk5hDj5rbMA0GCSqGSIb3DQEBAQUABIICALD51YRVx0j/xcT2j1OA3circaeh
# WlulTq1wrAD4L9vH8+lOwxf1FXOFNjOvjrg0t1TKTA1HDJgnCb6jFmpkIyk5wZWL
# buZ+Bykq0pQ3RtyCQgmvvrPGl/hmptLcYmTXvwxdqE4kOS0rndTHIQyvLAtbQQiO
# 6KtKJUAKsrnbWb4dCRqixKbYgHqU8ZUSWqs+HX7iMgTnxrrMlHHA/T2QUs1rNl4G
# rlcB/s0tyurv2sdTs2pcEmEZforTGS5gM2zJSwFTLADfGoXNS7hufg9NuaWdBGpI
# SCH/1HP8NvO3yQAyoS+DZoeCRnMq+0W3wiFCkgx2jKS6cLqvJY+MmDiExBR8WSgx
# C7C2ptVS7MH+GlakvZClOgHWD+G61PBSXc0LxsBVuPA1rPFP+41Dz2AKatnTSvrS
# 2ixDA6Jeo8/aZXW4h2iCupdueUqvfBJ+NDOUN17anSLQuxZRCI+OIUmtknrQ7Zap
# nTHfspQq2Y/YIFUIRyutmXTnrfEwjMs8XaVLNh5k0kDCNMbRrlNYOd813+7d+ZVR
# t3nJKt9KwEldk7UgXcinc227Z9ubbYQVnBbbVGH72QPSql/6oumTlt9XSm6nm/um
# 1S8lhiQVe9mZf0iWWhB3xcqWbDYT3Z7XbxSD1GMWsZHgW4mGFPTxtgD0SD+iVGCp
# AcY+UjM39Ct3URpa
