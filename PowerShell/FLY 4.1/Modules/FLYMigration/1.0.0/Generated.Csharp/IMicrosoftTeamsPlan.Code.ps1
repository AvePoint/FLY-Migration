...
namespace AvePoint.PowerShell.FLYMigration
{
    ...
    /// </summary>
    public partial interface IMicrosoftTeamsPlan
    {
        /// <summary>
        /// Get all plans
        /// </summary>
        ...
        /// </exception>
        Task<HttpOperationResponse<ServiceResponsePlanSummaryModel>> AddWithHttpMessagesAsync(MSTeamsPlanModel plan, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
