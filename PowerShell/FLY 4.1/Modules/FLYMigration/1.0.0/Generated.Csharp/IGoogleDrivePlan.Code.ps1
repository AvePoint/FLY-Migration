...
namespace AvePoint.PowerShell.FLYMigration
{
    ...
    /// </summary>
    public partial interface IGoogleDrivePlan
    {
        /// <summary>
        /// Get all plans
        /// </summary>
        ...
        /// </exception>
        Task<HttpOperationResponse<ServiceResponsePlanSummaryModel>> AddWithHttpMessagesAsync(GoogleDrivePlanModel planSettings, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
