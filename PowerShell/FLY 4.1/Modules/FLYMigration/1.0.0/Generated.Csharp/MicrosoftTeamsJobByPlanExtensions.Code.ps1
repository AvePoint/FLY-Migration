...
namespace AvePoint.PowerShell.FLYMigration
{
    ...
    public static partial class MicrosoftTeamsJobByPlanExtensions
    {
            ...
            /// job mode
            /// </param>
            public static ServiceResponseStatusResultModel Start(this IMicrosoftTeamsJobByPlan operations, string id, PlanExecutionModel settings)
            {
            ...
            /// </param>
            public static async Task<ServiceResponseStatusResultModel> StartAsync(this IMicrosoftTeamsJobByPlan operations, string id, PlanExecutionModel settings, CancellationToken cancellationToken = default(CancellationToken))
            {
