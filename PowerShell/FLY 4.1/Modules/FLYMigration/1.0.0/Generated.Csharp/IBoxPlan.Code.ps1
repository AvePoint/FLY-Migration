...
namespace AvePoint.PowerShell.FLYMigration
{
    ...
    /// BoxPlan operations.
    /// </summary>
    public partial interface IBoxPlan
    {
        /// <summary>
        /// Get all plans
        /// </summary>
        ...
        /// </exception>
        Task<HttpOperationResponse<ServiceResponsePlanSummaryModel>> AddWithHttpMessagesAsync(BoxPlanModel planSettings, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
