...
namespace AvePoint.PowerShell.FLYMigration.Models
{
    ...
    public partial class BoxPlanMappingModel
    {
        /// <summary>
        /// Initializes a new instance of the BoxPlanMappingModel class.
        /// </summary>
        public BoxPlanMappingModel()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the BoxPlanMappingModel class.
        /// </summary>
        public BoxPlanMappingModel(string sourceConnectionId, SharePointCredential destinationCredential, IList<BoxMappingContent> contents)
        {
        ...
        public IList<BoxMappingContent> Contents { get; set; }
