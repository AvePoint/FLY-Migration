...
namespace AvePoint.PowerShell.FLYMigration.Models
{
    ...
    public partial class SharePointPlanSettingsModel
    {
        ...
        /// <param name="policyName">the name of migration policy</param>
        /// <param name="databaseName">the name of migration database</param>
        /// <param name="databaseServer">migration database server, it is
        /// required if the database name is not unique in your
        /// environment.</param>
        ...
        public SharePointPlanSettingsModel(PlanNameLabel nameLabel, string migrationMode = default(string), string policyName = default(string), string databaseName = default(string), string databaseServer = default(string), string policyId = default(string), string databaseId = default(string), ScheduleModel schedule = default(ScheduleModel))
        {
        ...
        /// <summary>
        /// Gets or sets the name of migration policy
        /// </summary>
        [JsonProperty(PropertyName = "policyName")]
        public string PolicyName { get; set; }

        /// <summary>
        /// Gets or sets the name of migration database
        /// </summary>
        [JsonProperty(PropertyName = "databaseName")]
        public string DatabaseName { get; set; }

        /// <summary>
        /// Gets or sets migration database server, it is required if the
        /// database name is not unique in your environment.
        /// </summary>
