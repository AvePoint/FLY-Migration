...
namespace AvePoint.PowerShell.FLYMigration
{
    ...
    public static partial class FSJobExtensions
    {
            ...
            /// </param>
            public static ServiceResponseString Restart(this IFSJob operations, string id, JobExecutionModel setting)
            {
            ...
            /// </param>
            public static async Task<ServiceResponseString> RestartAsync(this IFSJob operations, string id, JobExecutionModel setting, CancellationToken cancellationToken = default(CancellationToken))
            {
