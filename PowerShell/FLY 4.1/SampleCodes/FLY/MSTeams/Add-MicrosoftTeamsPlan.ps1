...
$PlanSettings = New-MSTeamsPlanSettingsObject -NameLabel $PlanNameLabel -PolicyId '<migration policy id>' -DatabaseId '<migration database id>' -Schedule $Schedule -Duration 12 -DurationUnit Day -MigrateConversations -OnlyMigrateDocumentsLibrary
