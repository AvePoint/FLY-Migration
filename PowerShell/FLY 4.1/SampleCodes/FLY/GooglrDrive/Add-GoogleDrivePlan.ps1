...
$Source1 = New-GoogleDriveObject -Level Folder -Path '<Team Drive\Folder>'
...
$PlanSettings = New-GoogleDrivePlanSettingsObject -NameLabel $PlanNameLabel -Schedule $Schedule -DatabaseId '<migration database id>' -PolicyId '<policy id>' -MigrateVersions
