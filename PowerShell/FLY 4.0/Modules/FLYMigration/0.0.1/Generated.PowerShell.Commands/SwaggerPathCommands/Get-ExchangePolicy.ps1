...
'@ 
    ...
    if ('ExchangePolicies_Get' -eq $PsCmdlet.ParameterSetName) {
        Write-Verbose -Message 'Performing operation GetWithHttpMessagesAsync on $APElementsFLYAPI.'
        $taskResult = $APElementsFLYAPI.ExchangePolicies.GetWithHttpMessagesAsync()
    } else {
