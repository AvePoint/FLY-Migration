...
function Find-ExchangeJobsByPlan
{
    ...
    $NewServiceClient_params = @{
        FullClientTypeName = 'AvePoint.PowerShell.FLYMigration.APElementsFLYAPI'
    }
...
'@ 
    ...
    if ('ExchangeJobsByPlan_Find' -eq $PsCmdlet.ParameterSetName) {
        ...
        $taskResult = $APElementsFLYAPI.ExchangeJobsByPlan.FindWithHttpMessagesAsync($Id, $PageNumber, $PageSize)
    } else {
