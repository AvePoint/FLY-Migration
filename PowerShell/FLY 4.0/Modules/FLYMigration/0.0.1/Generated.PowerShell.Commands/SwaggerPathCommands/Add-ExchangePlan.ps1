...
'@ 
    ...
    if ('ExchangePlan_Add' -eq $PsCmdlet.ParameterSetName) {
        Write-Verbose -Message 'Performing operation AddWithHttpMessagesAsync on $APElementsFLYAPI.'
        $taskResult = $APElementsFLYAPI.ExchangePlan.AddWithHttpMessagesAsync($Plan)
    } else {
