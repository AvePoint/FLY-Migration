...
$ApiKey = 'rK1F+geUc3S5WjNBrff8y1qJXIigr9su1udF1qyQsFA16qtfOJsVUbGq28qe3/ZO'
$BaseUri = 'https://10.2.77.92:20100/'
...
try{
    ...
    foreach($connection in $connections)
    {
	    ...
	    try{
		    ...
		    $PlanSettings = New-MSTeamsPlanSettingsObject -DisplayName $PlanNameLabel -PolicyId $Policy -DatabaseId $Database -PlanGroups $PlanGroups -OnlyMigrateDocumentsLibrary -MigrateAsHTML -ConversationsMigrationAsHTML $ConversationsAsHTMLObject -MigrateAsMessage  -ConversationsMigrationAsMessages $ConversationASMessageObject  -MigrateGroupPlanner -PlanMode $PlanMode -MultigeoTenant $MultigeoTenant -Migrate365GroupMailbox
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU+vi10yvwPkG1UEmvl9qfPG7q
# uGaggiLOMIIFLTCCBBWgAwIBAgIQAybM8QJy2GqRSHGucYhV3TANBgkqhkiG9w0B
...
# FANmaScLO80EADaBt1UPJZ+9uArHMA0GCSqGSIb3DQEBAQUABIIBAFTjtUBTL6yJ
# Hxn5W8wrlrlGDB56KUX3T4CkWBl7HBrHv+4+5y9A2VE9Cf7cfcfEKPJYDAZxCU1f
# Usj44ukgNnBxiDUfKd3WqPlCZbGYTGWIGv7KsAc/h/LIlEWFKsaxi6XH8oji9EeU
# A4HMnXtAsnfERiZVxHj9HEX/DpcXOUSTaxpR0b3h7NReGXjFanXDjbYEIIIChO2c
# DSaInJqfNBIoHqQyTQTKDa+njgvcXz0/jVgLx4u7Uekpv2YO0tNJHh1KeGgOJtdC
# +pAHVmFi56b6fHBov3eluRbiSU5CVav7UlpWyKfZ/6wf8fC10cxmwr7sNvRw9A87
# FVKUxM2oodKhggMgMIIDHAYJKoZIhvcNAQkGMYIDDTCCAwkCAQEwdzBjMQswCQYD
...
# CSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjIwNzE1MTQzNDEzWjAvBgkqhkiG
# 9w0BCQQxIgQgTQjz7dgMhK9CASbHxapw8nHj1o8R21Ldnci4QZctpxMwDQYJKoZI
# hvcNAQEBBQAEggIAPqNTCB3okADrO12X2ctcC88yguD7V51vQglZT29JWjnaGYvf
# aLPwu/pY4BjnS6Sx+IwyUclW+JezSyqk4do1SwSTf+Ye9BDfgwX6XUhxBR53L+u/
# maZGsXz/pQ0zgct7uttbNo+oRlxWwSibh5kwhhptSC+5V5GzK8iRsDCTOaxab8ai
# 4wW9Xv919eC5dgwnlnknDC+t1qjsnJlLJw3wzw2iEsg42ct/uUibtW0uPnYHUmgh
# WQaHAjQeF125o/LYimo4p3TpnrvLrMaUiFDLnjOu9cLLcZrPtkmnrAJN+0Lo1F2Z
# pF7pd/w2ZcUVKO8KUkZbiZWcYH9y4YLdu3Hj8kKPzM1QV/kBUU5Qn//kvyIYxuW3
# jCO2M2ocLK+be0h+6uKvyo0j9t8ny0//O19K4dIyLfzBDRXjIkX4vtlnQvfN+wNV
# jyC/W9NPsKYKSzpMsA5ds+VjIJZGUWiyeKsr0QuvF9GK/DSx1G0ft9RJSw0FbnY+
# C1+sEihuHQYr8XXlWuXpegrBPqvg2A1TIhPUIXZKoyM/de7MJNKd3pfTTvTdrBzd
# t1hBM6xZvddezMjoMKlGukYQwgmJD73tJZVxYv3r835T6ORptdVTBO00+ZxS2jZ7
# /VL7p2SmlRUsNwl/GfhqWNrrXZkXdsPi5BbAMpKaly1oH4suUNKLkhW3v7I=
