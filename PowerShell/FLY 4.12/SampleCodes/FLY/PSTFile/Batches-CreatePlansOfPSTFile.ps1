			...
			try{
			   ...
			   foreach($csv in $Csvs)
			   {
				...
				foreach($mapping in $mappings)
				{
					...
					$Destination = New-ExchangeMailboxObject -Mailbox $mapping."Destination Mailbox" -MailboxType $mapping."Destination Type"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUWXCEDy1pDeOn1M50CIDRplAE
# mQOggiKmMIIFLTCCBBWgAwIBAgIQAybM8QJy2GqRSHGucYhV3TANBgkqhkiG9w0B
...
# 9w0BCQQxFgQUO4FiSOlqK9X9o0Q+GG+NHekAzSwwDQYJKoZIhvcNAQEBBQAEggEA
# k3xjsQepFFjj6EXtuaRm9CcHp8Vz5Zo7k6DGAUD376yf80Kv0D2QXUrYLmWOkC6n
# T6PUdfY2BkkvVwlOBXj70nbXHK5QG56x55Nsf0zXAZ3RlEiJLjoKdSIjmU+PzOj4
# V2+vrCwhNMaCBqpGyit8UIAqjdGo4EXF0JwvBANcbulEj/hsJDDPpG2kIghLyjEP
# SfG2Wh9vLvg3/ht6ironhgL0b9p3tOPnjn7yrsKNwD1XCtF0BOtRlFDMI/JMbxOS
# PWFnLIcz5Vq+cvOrtSlOqAmcMmgFEvfHcmA2Egoj4Vcxr+W6ygSOGa+ditO+M/kg
# 2VVi+mUcko7TbogWXS+NsKGCAyAwggMcBgkqhkiG9w0BCQYxggMNMIIDCQIBATB3
# MGMxCzAJBgNVBAYTAlVTMRcwFQYDVQQKEw5EaWdpQ2VydCwgSW5jLjE7MDkGA1UE
# AxMyRGlnaUNlcnQgVHJ1c3RlZCBHNCBSU0E0MDk2IFNIQTI1NiBUaW1lU3RhbXBp
# bmcgQ0ECEAVEr/OUnQg5pr/bP1/lYRYwDQYJYIZIAWUDBAIBBQCgaTAYBgkqhkiG
# 9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzEwMTkxNTEzNTRa
# MC8GCSqGSIb3DQEJBDEiBCBBjNmg+9Tn3Gv57j0E3CRvh7WaSA3HKdrZ+wQ+Z/Wz
# cDANBgkqhkiG9w0BAQEFAASCAgANPgxwWKFqZbIojLw6k/zL8oMsOf41T4vn7EMt
# 01uS3v+XuxsTBSkmo4wzZXvoa9rhgoR/RVGvGGNYHek7Yomk8/OZnsEG1jdK7ped
# POyd1Rrsykq98CzK50CG9aGsux+J/lAuFfNB/P2qqwNA8+7Ziyhczpu090fE8IqH
# vZsDtIhttoRa5L5gCwZHsE6hCh2TNOS7ORnNLE0LpfmQOQwLWiQdT0fAXMiO+ktB
# k9vP2Jgpvh6DJvkf23Aw/q1w4tGywHbnisZbyNFyM5VatIgXtcUT7sy8Gu2aq9aT
# 90mnY15gzUhbYLs1kPgUtF1PxLuV+kytE80O7bpgKE2LrSJtVNSGdtXediye/v9v
# vVLwNwlHpySYyq+5SKuY5EMT83BrZgE88Dmi/K4JnkO05xnCWtiCCaJUKynm8GVG
# XJF0doSUbsVFkVfMMELrIQHr1Yi4pXSCCpt1fQ0GIgW0Lbc/WscbVV66RYoLEPip
# OfDV6aLbJpXgXyVDg+75G7XgXyACFXS0XaPGXipz7m5uhduGUcK6WiZVIu1vwbim
# 4ePnDsaK1hQSqeCrut2TUiWdP3aJbyr7ZnUBrr/gHbq8XCAq17bVgIBbH+4xG1pK
# EftBHF90DRz+dwtB44/vBNA10yjObFsgPTRQHeAJLNEomA3C1IRUsG3aQb5/9MAq
# almtsg==
