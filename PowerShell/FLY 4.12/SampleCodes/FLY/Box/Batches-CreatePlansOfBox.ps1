...
try{
	...
	foreach($connection in $connections)
	{
		...
		foreach($csv in $Csvs)
		{
			...
			$Mappings = New-BoxPlanMappingObject -Contents $mappingList -SourceConnectionId $connection."Source Connection" -DestinationConnectionId $connection."Destination Connection"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUZcrsigCpQtc6/KxTqvojjlga
# rNCggiKmMIIFLTCCBBWgAwIBAgIQAybM8QJy2GqRSHGucYhV3TANBgkqhkiG9w0B
...
# 9w0BCQQxFgQUwOXesPzjcxirr1s6qOyWdmDTtqgwDQYJKoZIhvcNAQEBBQAEggEA
# jMROtzZlth2wKtDznw4BVD14Ms4rtBNMUAkH5eHJqnOZfxuDo30AC/2TCYMwQJTu
# iS0AUbNE62rgPbUxCOcxYwSQ0ojkB5MEXoe88LgnHU5Yh+hBUMhwF3YUKMqFM5Js
# rEkL2hw7fpQcE1r7pwr81adb97qsZPBlrkXDmv226nvORW5mKpFnRgSgXxhHD7zv
# WqvS983IY4R2QoeiBrMkE+imW/jC941EcEuyaLhx6wa4aBVCUDGmhy9K4WHdKpH0
# 4nz72F9bF0S+/Zx8DJs162zOGOR7uizs+W+r1RsLao3VqgFUdEF1kyDEkDg/DmNy
# Q+6MEwihIvf2qfRdkwMSuqGCAyAwggMcBgkqhkiG9w0BCQYxggMNMIIDCQIBATB3
...
# MC8GCSqGSIb3DQEJBDEiBCCcoO+JuYx3kFfskKY5DSWh6BQwi7sinUYprdozjJvN
# lTANBgkqhkiG9w0BAQEFAASCAgA2ucjNl0PD3YDPiWu0Pb80a56hwpiUjgkF9JwC
# vW1GuCETZILa1D0muPy3kVTyaiKJSflnh+InxaAhe/TZ4o3Sw/szYEbs2e2qbOB8
# eewRHPHpC0Y6kNUaC1cvJ6LqgtDsOk+k/GEkWYjUuJvMtfg2mTFk44yqxSMRT25L
# 48YmMo4IpIIfBZGeHRjMLnICpoDY7WzfmSxEL5rhglZfrLGaN2TzeyNCuQJSvaNt
# k7j6UtXq1fZON+cmUDs3t3iMPblxAeoLGu0sZ9DhrNkT4KVuVd/jZ60gKdH+3DFD
# QmqjdksDQnG8VJMYjoDcYOQbgo93VIYWEZpIvz5wQksLi6I/cRGvImoGzFWNar0B
# A4YoQULM8QJ8yTvfWNbSuk9CIenV4rimMLAW/lC0OKaKiSyF+X/yam2/8zPHaSIP
# Iohi+uco6Jvr6kZg3iWh+uutnuruCnSqUUqfdGo7QC1hkjdbDoq4TxzcAHH9sMf1
# aB79yseF9fmidxiKfjOwVr8mYH3T+Il9XUWvIsJk57mZZH4y/qTYd/AVDwCgU5lA
# FHGqxMOA9VkM0OTZLcUoVPh1dbx4mYl4m1pG9/JbmURyQku+PWlhCPeJvKvkB7kq
# 9epbAIOVOrCCLUU6OZ/pt1l4m4pGm00lotSIUR4G//ahsj2yW6pOQ+aZWzpKqDQq
# sCWZSg==
