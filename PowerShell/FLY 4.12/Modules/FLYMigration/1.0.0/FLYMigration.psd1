...
GUID = '7fe93c64-3363-4632-ac8d-8131a638b672'
...
FormatsToProcess = 
               ...
               '.\Generated.PowerShell.Commands\FormatFiles\OneDrivePlanSummaryModel.ps1xml', 
               ...
               '.\Generated.PowerShell.Commands\FormatFiles\PageResultViewModelListOneDrivePlanSummaryModel.ps1xml', 
               '.\Generated.PowerShell.Commands\FormatFiles\PageResultViewModelListPlanSummaryModel.ps1xml', 
...
FunctionsToExport = 'Start-GoogleDriveJobByPlan', 'Add-ExchangeDistributionGroupPlan', 
               'Get-PublicFolder', 'Update-SPPlan', 'Add-FileSystemPreMigration', 
               'Stop-PSTFileJob', 'Find-PSTFileJobsByPlan', 
               'Get-PublicFolderConnection', 'Remove-SlackPlan', 
               'Add-MicrosoftTeamsChatPlan', 'Get-GoogleDriveJob', 
               'Update-ExchangeDistributionGroupPlan', 'Stop-IMAPPOP3Job', 
               'Get-BoxConnection', 'Add-GoogleDrivePlan', 'Remove-SPJob', 
               'Get-ExchangeServiceProvider', 'Add-DropboxPreMigration', 
               'Get-SlackDirectJob', 'Update-OneDrivePlan', 
               ...
               'Find-SlackDirectJobsByPlan', 'Get-SPConnection', 
               ...
               'Stop-DropboxJob', 'Get-ExchangePlan', 'Remove-SlackJob', 
               'Restart-PSTFileJob', 'Add-Database', 'Get-Office365GroupPolicy', 
               'Find-MicrosoftTeamsChatJobsByPlan', 'Start-FSJobByPlan', 
               'Remove-ExchangePlan', 'Get-SlackDirectConnection', 
               'Get-PublicFolderPolicy', 'Start-SPJobByPlan', 
               'Get-MicrosoftTeamsPolicy', 'Add-SharePointPreMigration', 
               'Get-SlackDirectPolicy', 'Add-IMAPPOP3Plan', 'Find-DropboxJobsByPlan', 
               'Get-Office365GroupPlan', 'Stop-SPJob', 'Start-SlackDirectJobByPlan', 
               'Find-SPJobsByPlan', 'Get-PSTFilePolicy', 'Update-PublicFolderPlan', 
               ...
               'Remove-GoogleDrivePlan', 'Get-SlackConnection', 'Stop-OneDriveJob', 
               ...
               'Remove-SlackDirectPlan', 'Get-DropboxJob', 
               'Start-Office365GroupJobByPlan', 'Start-IMAPPOP3JobByPlan', 
               ...
               'Remove-PublicFolderJob', 'Get-SPPlan', 'Get-SlackJob', 'Add-FSPlan', 
               ...
               'Get-MicrosoftTeamsConnection', 'Search-ExchangeServiceProvider', 
               'Add-MicrosoftTeamsPlan', 'Get-PSTFileJob', 'Restart-SPJob', 
               'Get-OneDriveConnection', 'Get-MicrosoftTeamsChatPlan', 
               'Update-DropboxPlan', 'Stop-SlackDirectJob', 
               'Get-Office365GroupConnection', 'Get-GmailJob', 
               'Restart-Office365GroupJob', 'Restart-DropboxJob', 'Get-OneDriveJob', 
               'Get-GmailConnection', 'Remove-BoxJob', 'Find-GmailJobsByPlan', 
               'Restart-IMAPPOP3Job', 'Update-SlackDirectPlan', 
               'Restart-PublicFolder', 'Find-MicrosoftTeamsJobsByPlan', 'Add-SPPlan', 
               'Remove-PSTFilePlan', 'Update-ExchangePlan', 
               'Get-MicrosoftTeamsChatPolicy', 'Get-SlackPolicy', 
               ...
               'Add-OneDriveConnection', 'Add-PlanGroup', 'Stop-PlanGroup', 
               'Get-ExchangePolicy', 'Restart-SlackJob', 'Start-JobsByPlanGroup', 
               'Remove-FSPlan', 'Stop-MicrosoftTeamsChatJob', 'Get-SlackDirectPlan', 
               'Add-Office365GroupPlan', 'Add-TeamsChatPreMigration', 'Get-FSPlan', 
               'Add-PSTFilePlan', 'Stop-MicrosoftTeamsJob', 'Add-PublicFolderPlan', 
               'Update-FSPlan', 'Stop-ExchangeJob', 'Find-IMAPPOP3JobsByPlan', 
               'Find-OneDriveJobsByPlan', 'Remove-GmailPlan', 'Stop-SlackJob', 
               'Get-PublicFolderPlan', 'Add-ConnectionSite', 
               'Get-Office365GroupJobs', 'Update-BoxPlan', 'Restart-GmailJob', 
               'Start-ExchangeJobByPlan', 'Get-MicrosoftTeamsChatJob', 
               'Get-OneDrivePlan', 'Add-ExchangePreMigration', 'Remove-DropboxPlan', 
               'Remove-OneDrivePlan', 'Remove-FSJob', 'Remove-MicrosoftTeamsJob', 
               ...
               'Get-GoogleDrivePolicy', 'Remove-ExchangeJob', 'Restart-OneDriveJob', 
               'Remove-IMAPPOP3Job', 'Get-IMAPPOP3Policy', 'Start-PreMigration', 
               'Stop-GoogleDriveJob', 'Restart-ExchangeJob', 'Stop-PublicFolderJob', 
               'Get-SPJob', 'Add-OneDrivePlan', 'Get-Database', 'Get-IMAPPOP3Plan', 
               'Update-Office365GroupPlan', 'Get-PlanGroupById', 
               'Remove-MicrosoftTeamsChatPlan', 'Get-GmailPlan', 
               'Update-GoogleGroupPlan', 'Get-SPPolicy', 'New-DatabaseObject', 
               'New-SlackPlanSettingsObject', 'New-IMAPPOP3PlanSettingsObject', 
               ...
               'New-OneDriveObject', 'New-UpdateSlackDirectPlanObject', 
               'New-UpdatePublicFoldersPlanObject', 'New-FSMappingObject', 
               ...
               'New-FSMigrationSharePointObject', 'New-MSTeamsChatPlanObject', 
               'New-PostMigrationOptionsObject', 'New-DropboxPlanObject', 
               'New-SlackDirectMappingObject', 'New-MSTeamsJobExecutionObject', 
               'New-SlackDirectPlanSettingsObject', 'New-GmailPlanSettingsObject', 
               'New-SharePointConnectionSiteObject', 'New-IMAPPOP3MappingObject', 
               ...
               'New-UpdateIMAPPOP3PlanObject', 'New-SlackDirectPlanObject', 
               ...
               'New-OneDriveJobExecutionObject', 'New-SlackPreMappingObject', 
               'New-Office365GroupPlanExecutionObject', 
               'New-GoogleDriveMigrationSharePointObject', 'New-SharePointObject', 
               'New-MSTeamsChatPlanExecutionObject', 'New-DropboxObject', 
               'New-GroupsPreMappingObject', 'New-SharePointJobExecutionObject', 
               'New-MSTeamsChatMappingObject', 'New-OneDriveMappingObject', 
               ...
               'New-PSTFileMappingContentObject', 'New-OneDrivePlanObject', 
               ...
               'New-PublicFolderObject', 
               'New-UpdateSharePointConnectionCollectionObject', 
               'New-GoogleDriveAdvancedSettingsObject', 
               'New-TeamsChatPreMappingObject', 'New-OneDriveMappingContentObject', 
               'New-FSPathObject', 'New-SharePointMappingContentObject', 
               'New-UpdateFSPlanObject', 'New-PublicFolderMappingContentObject', 
               ...
               'New-MSTeamsPlanSettingsObject', 'New-OneDriveUpdateObject', 
               'New-PlanExecutionObject', 'New-PlanNameLabelObject', 
               'New-GoogleGroupPlanObject', 'New-PublicFolderMappingObject', 
               'New-UpdateMSTeamsChatPlanObject', 'New-SlackMappingContentObject', 
               'New-IMAPPOP3JobExecutionObject', 'New-ExchangePreMigrationObject', 
               ...
               'New-GroupsPreMigrationObject', 
               'New-OneDriveConnectionOnlineObject', 'New-BasicCredentialObject', 
               ...
               'New-MSTeamsPlanExecutionObject', 'New-ExchangeMappingObject', 
               'New-BoxJobExecutionObject', 'New-OneDrivePreMigrationObject', 
               ...
               'New-PlanGroupExecutionObject', 'New-MSTeamsMappingObject', 
