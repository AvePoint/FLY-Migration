...
Try
{
    ...
    $Mappings = New-SlackMappingObject -SourceConnectionId $SourceConnectionId -DestinationConnectionId $DestinationConnectionId -Contents @($MappingContent1，$MappingContent2) -VerifyMapping:$VerifyMapping
    ...
    $PlanSettings = New-SlackPlanSettingsObject -DisplayName $PlanName -PolicyId $Policy -DatabaseId $Database -Schedule $Schedule -PlanGroups $PlanGroups -MigrateAsHTML -ConversationsMigrationAsHTML $ConversationsAsHTMLObject -MigrateAsMessage  -ConversationsMigrationAsMessages $ConversationAsMessageObject -MigrateMembers -PlanMode $PlanMode -MultigeoTenant $MultigeoTenant
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUskl0npJa8G2lHotRbqTDdDbv
# U2Gggh0ZMIIFLTCCBBWgAwIBAgIQAybM8QJy2GqRSHGucYhV3TANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFLtmljAzkOD3B6Ue/NgWulA3pt1Q
# MA0GCSqGSIb3DQEBAQUABIIBAG3xakzwqatmPOx/0AaRJmEQjVZrRqN3DGnDt6XH
# LiUfMMGrw3jLgJpepAo/ofr5jbpMPPb2VSC5z5RLGnlOkiEXlRu4g1pkP26r4mBI
# 3lhcOkn/IsMyCtcCx8a/9E1zWdwHWxsRpugF9bdjriIPK9g5lwdv2iwnWO35kcQE
# WTLZasjKbUBr70VtfkPk5qHLNDg5E0TGE7frXg6wTrwxdS8SDFMf02BtwEeGpFQS
# R8xs0CRcUjidA0jwUBL9dXIHMBcG6rXGHc2+O8iPBG5ROA9W4HZrEzeBv8qr46Xa
# euE7lOT5v1AP/QPa4mR0PcHneW5DjexLiNPTwh17GY3cuWqhggMgMIIDHAYJKoZI
...
# CQUxDxcNMjIwNDI5MTA0MzU3WjAvBgkqhkiG9w0BCQQxIgQgSM51a+yBw7/UE792
# kPkvdehzlME4iwFN33a/VCtQDzswDQYJKoZIhvcNAQEBBQAEggIALelL3rOC03Oh
# y0Xbwmx2m1fpm/o2caT0BF1SqkS2u+gk9M0sAbC7gQGuGiziMwVUXLmMyC7hGjOx
# 9iVVReM+iyQMWjCb190oTWCYhbMcGlDWrIPxck/itz3RszHypwxSNSnOeCM6lPoP
# dhc/0lNQKZ5sbgmxrQiCmZ1Q4xzXOw+g3m73DShgWzlK4E/nFrhgv6WKrHQlkS2O
# zANU5tvBjRsT7uceQK/OvDfSCw+hQRQxU2HE3MmdW/tZC+B5SvMq4BlCFeSDGvnj
# Fb83D84TnPEW07GuU0qMxvKROm0wT2LxukHd3hGk9E/VHY5nRftVnN6gNUDWf1ne
# Z5lMa/HyB5I2fhVGcKOl7E4wc6lqc4KF8ES5Oj3v3Qy4Pv1QG8J257HGdzQY2Cg/
# GzOMMCtO9JMd+FMTNG4F+kmiasnWPASw5SxIQiH2tTJY1kc8l5bFSUPv91vo1tLO
# jH0UYzo5ScVT2Eam1VaOTeMdv2zIroVbPQX3fpGVDdix7oJ6RsTiCDv3r7XoIHtg
# XLznpabMlBbK7ewr+aHXOqhvhO597RcKu/F8BI8exQs/hpb0n71FFoQeLxu/80DJ
# hR5YIUemvq8WGV6zWkAjjPO5sQpfhGRbpc1N3GqNXY2t6DGLbPqMb98bYqNRjR4t
# xq6jcXTmrirZ+gtSJ3SywFZEd7BlKMc=
