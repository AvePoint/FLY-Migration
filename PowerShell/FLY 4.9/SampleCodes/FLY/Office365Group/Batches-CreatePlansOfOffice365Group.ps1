...
try{
	...
	foreach($connection in $connections)
	{
		try{
			...
			$PlanSettings = New-Office365GroupPlanSettingsObject -DisplayName $PlanNameLabel -PolicyId $Policy -DatabaseId $Database  -PlanGroups $PlanGroups -MigrateMembers -OnlyMigrateDocumentsLibrary -MigrateGroupPlanner -Schedule $Schedule -MultigeoTenant $MultigeoTenant -Migrate365GroupMailbox
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUph8Cc2mexkYPBRbEYZl41YJd
# kleggh0ZMIIFLTCCBBWgAwIBAgIQAybM8QJy2GqRSHGucYhV3TANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFCwPbHYUOf5+swLeW2kaAqhaB7K4
# MA0GCSqGSIb3DQEBAQUABIIBACOMqf+GBxwgar0a/61QiltRh/dLLRgmggo7ap+K
# sZSuUZ1PHJtS2jUOC9x5WNH13VNuKfplp23qhMgMM1rTKFVWMyTWeuaiIS8rQb7M
# ABXJcG1jWGlDXzhdcRwARin6yeEeLefC4E1U2jUfa/3S/VVsP58Ahq7EcdDvzBc7
# Pevw8wwFBh++qtog7b9nEAzFSn0LuOZ41md1zgBul4vd7oSlUPD+fH+EYaIoAy4k
# 2Fea6z22GvjvdjMwzcC+M0wRaEzKFtgtH2ZPNnfMIcFHzFAINEE1+A4Je18KzV00
# OiXNPuHlFpeytTDpX02wIGetEKGubMtHdDoKGRtkWQvzuD+hggMgMIIDHAYJKoZI
...
# CQUxDxcNMjIwNDI5MTA0MzM0WjAvBgkqhkiG9w0BCQQxIgQg/tT4qdOtybMbqTwQ
# aIqVIS3lX5M7Zic5X2wg9UwXNmswDQYJKoZIhvcNAQEBBQAEggIAgvl0IKOAYfWB
# /YQbR/qoOj3XLIiL7KI9Sr79ZKgdEZwBtNpnCrRMZjV0g+VaeL/yYfjlFl+ABokU
# WC/omzoZ2VNeZ2WjQeOZg+ShAOiLMY6PS63zukW5UDAl1l87DQn3/cd7L0vGFf1L
# 8Nf9q27FBqHaWo+dPO3ACuLBu1FSjyM4hz7D7bxf3ucnL6lq7yZFu7MV6A1t4q0f
# FQLM6Y2UjWuQTUcYOdS5Irj4uaxbv9p2g3ZiPEcApF8Pq5GKgl4hiyauM9JitrY+
# AzKBCBVYcchqo5TzQ6uVVSwVRV2S0ovm4CU/Q/1/pAG/VhacUQNebyX402oWRF74
# Iwl6V45/uGBjj2mb/oZKpCsu4MXbjK1c4YMqEsvxKLq7xbNN0z24CpnKYYGiB2Ph
# Nl6pBz7Joo5+qpXSjWTjiWvIhkbqYieJhwYUw5Sk0Ib9wtFk6RaZqm7RXOuWznSe
# SQU6WkW9lyl8EuX/RINUd40UF3jasf8mwcS0b2anWs8ATlkQBaa2G0oQ0RdAD+mw
# +kzVk7dgNS9bjNvtAW/4A3QAnEkI64JU79YrIPOFsfNo4HYbkwkL4D5A9DnCjb+z
# PVq2+MFLI3r6D4jdPmHpHjdWYivG6sN3PUrV8Fui0AOuH5OAts2Z8tGYdFk/y39/
# F6ktIJdjWhQsFSP4VsvTej7F1ohMKVM=
