...
$Destination = New-DistributionGroupMigrationExchangeMailboxObject -Mailbox '<mailbox address>' -MailboxType DistributionGroup

$MappingContent = New-ExchangeDistributionGroupMappingContentObject -Mailbox '<mailbox address>'  -Destination $Destination

$Mappings = New-ExchangeDistributionGroupMappingObject -SourceConnectionId $SourceConnectionId -DestinationConnectionId $DestinationConnectionId -Contents @($MappingContent)
...
$PlanSettings = New-ExchangeDistributionGroupPlanSettingsObject -NameLabel $PlanNameLabel -PolicyId '<migration policy id>' -DatabaseId '<migration database id>' -Schedule $Schedule
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQULmYLyzFkfdJUCs7TSRrqaGPH
# iXCgghlsMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# hkiG9w0BCQQxFgQU6lPO8ShFoz6XA9WDwQTy68tvch4wDQYJKoZIhvcNAQEBBQAE
# ggIARGUK+ebiYe0hV6Eu9jPbt2+9nVHn3ZqIGy4PXiwMLYApe//y0WeqIYU6PTQI
# 91McP88wUx+R9yoStfKXqkCv1TOGJE+cQgC4v4u/EE0VX6AWwWeaY1f5DGSCBGcl
# IzFIjWsJ7ea5Ov+uXJn7KaZ44mUKmHw0Ga9WHPC9oUevA4ahyzR5MVTXIoVNrf0J
# u82bfwCwbClfLBovY+/iKR+bC4avsElb+eCJVOJKhf4hNkRa2Orpi2eZ+wuvcwuV
# gx1o/LFaIJZmV1dPTK2bsb48CDNTiW/v+oql7ebk91hAotqTFAOWauEy0kBMFooB
# CTXmsL395fySnWAuaoqSHf4JIuIlpSkyoFOSJbhaedGNRk5OEx8I8HWjryrp4wRE
# vv5oLSFQt38cNpnxf+J5qmJWfBEhDa/9xHJ+VzEswSKQsoMG3gIwEnFaAb0Lu/s8
# s9UYTLX0rF4IACZwdu5Me2/NFfOG7tNfZI0eiUgHFSAa2puuOFE9tcYI/34stwR7
# 7qklcbHksscrXtgA8LNfKQp3ULMFF1SuF6fBeuW44dWTrU24yL2wfItMAJiXKwKY
# odOPwD8z2gr0BSQEqCvBMKM+2Xi2zayXIsOHvnQKhMLFIwMA2/i6rXJHSu9kI8TF
# XY4hmRlbTBbY/miaBU7VCjYFP7sZ3LEp8Zt/ucvX8tmlJS2hggILMIICBwYJKoZI
...
# MTE3MDQzNzAzWjAjBgkqhkiG9w0BCQQxFgQUT7xznaic32juuyzjqda7VG4tjw8w
# DQYJKoZIhvcNAQEBBQAEggEAlzuTxotWp7XyI4zJgZd2arHghYX7VW/R2zt/1NML
# MC06gb/8LRPm+tDnlMxaAfRTW3rvPKDUk7yM283dzZ7ENt6wx+sfkzWe3KQfU0Az
# ABI397fSL+qAzSPEtQs4XkBvs/hsS9O6tFjtF/Z7jHIySzsmL0cdBcyqx+fplbmx
# pJffDav1+PqRCvOdYET8UIYm5rZAGv8dPWgK/UMM4b6CUnpHO0a5XZHX1n39qLWI
# Qo16RvVo7/BOmWev6f5vY8rDnjTmQA0NiNQxjIPOEpZQuXv20mtap79yBm7fW2bO
# t1Mb8K3yuGGBprHv9qw87ZtQQXooiRNfITYWiob+TTuVEg==
