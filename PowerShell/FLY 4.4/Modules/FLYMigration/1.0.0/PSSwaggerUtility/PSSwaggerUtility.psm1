...
function Get-PSSwaggerDependency {
    ...
    $FLYMigrationPath = (Get-Item $PSScriptRoot).Parent.FullName | Join-Path -ChildPath 'ref\fullclr'
    $MicrosoftRestClientRuntimePath = Join-Path -Path $FLYMigrationPath -ChildPath "Microsoft.Rest.ClientRuntime.dll"
    $NewtonsoftJsonPath = Join-Path -Path $FLYMigrationPath -ChildPath "Newtonsoft.Json.dll"
    Write-Verbose "MicrosoftRestClientRuntimePath: $MicrosoftRestClientRuntimePath"
    Write-Verbose "NewtonsoftJsonPath: $NewtonsoftJsonPath"
    return @($MicrosoftRestClientRuntimePath, $NewtonsoftJsonPath)
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUy2Xmepeij4/Cqf7QoqOdNfvo
# e26gghWAMIIEwjCCA6qgAwIBAgITMwAAALu2dyRxSiAAIAAAAAAAuzANBgkqhkiG
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQav2/o
# tqewZac0PZXZFzhHkTJ8gDBQBgorBgEEAYI3AgEMMUIwQKAWgBQAUABvAHcAZQBy
# AFMAaABlAGwAbKEmgCRodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20vUG93ZXJTaGVs
# bCAwDQYJKoZIhvcNAQEBBQAEggEAOWb1Mm1LNDxFSj95UYojiFtha9KyiB02e9iH
# a6VBg5dwI0GW9vFk0SW2iEKFSMsLcD6gjTGox9LDbI7852Uk3hJQ+08QbY6+dxSt
# 0xsj51R6B0KleoyLaK30zPoQ+0qUZyBBnnmXQyEEZTzbJsZfaFA1+NRPIhIaxfc0
# 8cWHDoN23oC2PH5FQho/MSJrt344fMZuG/FnQECVaqcUEs9mRG7KJf1vkMxNlkzD
# 2bGaYUqOYVbqxoNk65Skp/illWRseWUXALAfhTc2wOUhNt/e/HJeblOdoDw7TSaP
# DvPMvCVU1kVaKtog0cdIzmI5+oT5GQR0WpECZHrCClbn6tLbQqGCAigwggIkBgkq
...
# BgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE3MTAwOTIzMTAzNlowIwYJKoZI
# hvcNAQkEMRYEFNrs1yXNRykZqPsPEPw8CfEs5ztzMA0GCSqGSIb3DQEBBQUABIIB
# ABVlp5ddJxRlOwRZaqanEEq+FZ/l4wvICRVQFy49ESrCRhDqMz1/ISMp10L76ECV
# wdigfK+pA7GvQPwvGrsCjnotBCxc38rKY4VGn3N5hHo+I+GDwu4QgHIkf3IzigLN
# HoSKN3Ngyy6ukRWjF6C1I9sS/sRP5kJ7xwEWR3QC5Gb3AuB9CfPp92GqnslBBxSl
# MDchGfQeNIDacNwEyXAhYkO/HfjMsSiq5jvod+zO6LdTguZuVWp8mXazvS/SE8UG
# Hs+phYtXqnQlIBpdgZWmRn/o52p0/0A9YlVJ/YbvCnm/2C+0z3Tmd6+tw/deob5Y
# 2fjoDEQcGbsXoNoa9V2I+mo=
