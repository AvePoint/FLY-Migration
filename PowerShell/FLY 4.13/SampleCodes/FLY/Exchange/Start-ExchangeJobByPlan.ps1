...
try
{
    ...
    # For example: $PlanType = 'Online/OnPremises'
    $PlanType = ''

    # For example: 
    # Full/Incremental/FailedObjectsOnly job:
    #   $Settings = New-ExchangePlanExecutionObject -MigrationType Incremental
    # Post Migration job:
    #   $PostMigration = New-PostMigrationOptionsObject -SharedCalendarPermission:$true -EnableForward:$true -ForwardAndCopy:$true -DisableForwarding:$false -DnsToSMTP:$false  
    #   $Settings = New-ExchangePlanExecutionObject -MigrationType PostMigration -PostMigrationOptions $PostMigration
    $Settings = New-ExchangePlanExecutionObject -MigrationType Full 

    $Response = Start-ExchangeJobByPlan -BaseUri $BaseUri -APIKey $ApiKey -Id $PlanId -Settings $Settings -Type $PlanType
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC8AJ3zlslAzfdq
# ozngP9Sg1rMdfgT71syIReE0q/OrJqCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCAtVEYAzxh+tahkDVl+WecySyFaIOwgs1ffJ7bh/1juiTANBgkq
# hkiG9w0BAQEFAASCAYDEjrLnWKl7Nj/GrHM4muCf1up4XIQCT0qFKsvNVnAIdadp
# YqDMlLJIyaHNgG5JD3z2Yo1nOOg2+FKhIiL3yRBklvHoJAfYbdMSHPIDUaOTaaf5
# h1/kQHuRpWPT8VKI4vWSp6NP718znOTFlHGGvALiB/Bo+SGwpUC8JZsmmicg032R
# Rxd9qERP74Sur5gto6wEV3h0r/ue7NPu5HNcHvz0Dkfhx/5dOV1hlw4gshv6XNki
# 5/uNB5KZBg81sE2RfsllIcHfiPLGDvXXG12R+bJMuWMhw9oit/Owk62NqkxaxjuZ
# EKjT/ZinD9RBnCKzf/kPrmVtqqibdB1Lu4uVfWlAii7X7K/VXZcMnm3AdAoyD5zP
# Dx6YpTDAzNDPj8JrTi3jaaGOk/ZumFrqsWEGPs+NEhIINAMq+LEamzozZGl6YKFV
# otwH/5vdlZ/oyuena/Vffinvjli1DMID+ko7CfiqtNDBEaVGh92kF+WXOKSShp1E
# Hqi81NMxlxnbZ257HZqhghcqMIIXJgYKKwYBBAGCNwMDATGCFxYwghcSBgkqhkiG
# 9w0BBwKgghcDMIIW/wIBAzEPMA0GCWCGSAFlAwQCAQUAMGgGCyqGSIb3DQEJEAEE
# oFkEVzBVAgEBBglghkgBhv1sBwEwITAJBgUrDgMCGgUABBQZN4QL/eCB1uaLKdBY
# JOxt7ttB9wIRAPjQ6jmquDLOaHnvH1vU7LEYDzIwMjQxMjA0MDQzODAyWqCCEwMw
...
# CRABBDAcBgkqhkiG9w0BCQUxDxcNMjQxMjA0MDQzODAyWjArBgsqhkiG9w0BCRAC
# DDEcMBowGDAWBBTb04XuYtvSPnvk9nFIUIck1YZbRTAvBgkqhkiG9w0BCQQxIgQg
# PnxJw00htLHOvY+90Ix0TzKflA2t8KWNvZG6b4ady0gwNwYLKoZIhvcNAQkQAi8x
# KDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZluQWTmEOPmtswDQYJKoZI
# hvcNAQEBBQAEggIASsEU6CIqCOsEbRXCMNQ0XSk8KppKsDjXxiFmgxfcePtCJ7ou
# HOhnTbWozOPIQ4sx8kqhETYmdAxi4JcUVUeJD6YdnjfbUhw9hijUEhvj0zUx6v3C
# 1eWw9EnU3a2bajvKVv6MCdhw1RfUqgqeAL8ip4bb72JQpWuiP3mhtB3ACX9LVf3K
# G+rMuhHpm29FiCHW+1Fu2bwwVLy7TIgZY6/S+atGqriqgsLOH+DUbJzizR56bb/q
# x4OjK0Kq1NjruqVHB0EoClQCNqVuxyfq6nOHGPss4P0Ata/ewJzNnlLsCfWsfwt/
# jfRr9W9b6erpAwtQ/j18UzZT5g4JPyX0HZkiqvOJkS1QzYoKz4nbLfQ+W/zMwGL9
# eeMnV1NbLwcI/xajnNI6t6CPnjTNUIjqB1VbmrQQIjJqKoQ9YAM2Jzk+HA8chtXF
# H/wQh8cvwlSsy3O58xE9tf5pLHntvdYlNo5ERkQVIanFRiPplPQG37hLm7ZjuaaM
# JZqGtWASAej72tt39jQsy0mKeAfpidg640NFahYzRj+ayif2DsXDta07fWVMjnux
# l15XMqmU6K0eGpqQo/K8fMrr44B26FdXPKmL/53+NbMfRret/WJH2u+76zuodeAB
# P1Q/VgwiDQm7gD/ciI3FGrRGflOE1wSDwdnr9D1v+vMhYcpADAjNv1ZEa6I=
