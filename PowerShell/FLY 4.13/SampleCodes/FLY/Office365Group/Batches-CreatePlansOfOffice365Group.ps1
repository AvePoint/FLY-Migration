...
try{
	...
	foreach($connection in $connections)
	{
		try{
			...
			{
				$Source = New-Office365GroupObject -Mailbox $mapping."Source Email Address" 
				$Destination = New-Office365GroupObject -Name $mapping."Destination Group Name"  -Mailbox $mapping."Destination Group Email Address"
					
				$MappingContent = New-Office365GroupMappingContentObject -Source $Source -Destination $Destination
				$mappingList += $MappingContent
			}
			$Mappings = New-Office365GroupMappingObject -SourceConnectionId $connection."Source Connection" -DestinationConnectionId $connection."Destination Connection" -Contents @($mappingList)
			...
			$PlanSettings = New-Office365GroupPlanSettingsObject -DisplayName $PlanNameLabel -PolicyId $Policy -DatabaseId $Database  -PlanGroups $PlanGroups  -OnlyMigrateDocumentsLibrary:$TeamSiteScope -MigrateGroupPlanner -Schedule $Schedule -MultigeoTenant $MultigeoTenant -Migrate365GroupMailbox
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAunCGJAfpjxpZC
# JfWxIT/eg1bYL1fQoGSiLMaoi0EHFKCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCB6ru+gUgmR1U843pidJG2A2baE+vThSnzpADk++o1g3TANBgkq
# hkiG9w0BAQEFAASCAYC/0Fe1sqq9fblZnsRKfgfjtJf2+gNdCkABGD2L/lNbfyUt
# aShBYzw2O3DWmuViP6Oux2qs7phton8RhcV6UM56Mq786tvRl7LIp+84Tl5yXMJI
# 2PCxcEHS+R1SvCd3xC+nXglpXVGBxS7JLLT42IOqrbJO8eWgM9NtEbWitlstDCzJ
# vlMFNhTURL/7ULebQE3Jj4MYYBQlJrdHLoagXDj1c7qof/M2PjT7+shlCUog1+FE
# lVJ30ejJUBKqfFxv2GC2a+w0qc7Vb3upWV8GzwOTEBVfM/SNDgoEoOeRfy7cJThf
# qTdD8chE9hG3AUO9yJ6cr2y6AYhvTGZ/wT6toRTYjM5kzUKkD4BSKl3pIgCXpg3a
# BL4O+18HrzGKjpDcbF7N63ZhvtYKeorpv4N2Gf395EY8rTyBPhroqLIAjldAUifs
# tiKM2aSafGG8J3cMWzU9gyL53qBut8UMtBesJ0eel5neCjXrn9FT+HCeFoY6cOjm
# O6jPXEVLe3Lrn4aqqRChghcpMIIXJQYKKwYBBAGCNwMDATGCFxUwghcRBgkqhkiG
# 9w0BBwKgghcCMIIW/gIBAzEPMA0GCWCGSAFlAwQCAQUAMGcGCyqGSIb3DQEJEAEE
# oFgEVjBUAgEBBglghkgBhv1sBwEwITAJBgUrDgMCGgUABBSGq02lY9AjM14iJZoF
# 6uG+1iukYAIQLnjoe1OBUHz6vcEDLmfkyxgPMjAyNDEyMDQwNDM4MTlaoIITAzCC
...
# MRwwGjAYMBYEFNvThe5i29I+e+T2cUhQhyTVhltFMC8GCSqGSIb3DQEJBDEiBCC5
# D9FawAj1Pr0vBgPjzutNxMI2rrWi6J4cttyJ2NFgdTA3BgsqhkiG9w0BCRACLzEo
# MCYwJDAiBCB2dp+o8mMvH0MLOiMwrtZWdf7Xc9sF1mW5BZOYQ4+a2zANBgkqhkiG
# 9w0BAQEFAASCAgAYim9W9HD9+qrfE3s09XJ2q3hhDysoc4oQ3/ecHdYiPi8+Mz8U
# n7vMO6t8YpwWq1AdzqCJzpHqvdwrIgsOtWDVNOs8h4y7FihHZ3Vxiy1Fxovcky1K
# gd8P1ldbWWkj0pUK9RgimgCd4P1HKYU+EPY/gPGaaaE4lmNZLsqVjC/r2ys8uW7h
# 3MeEbyNNsFznNG2Fci+6llRBEhUtuNhPpDt6HdK1wMjAWDYlP3SD7GqUK5+3OoOM
# 87bTdu1o9c+fDsyUbC29hl/+6hJv0i33BYInZPDKceUOKYG7wUClCSOq0BmeZDDU
# 4YBCcNETgVnhKyYarZOaI/FUYniHCGMEQTlZ7lBS7xtoVRPcmxZGjapo0rkLqs7i
# CM7HRb7AN2Wgq9Sgvg9iq+Yb29rA90FnoXiqx6GOnraCAsvmZxJ7xV1PVB3Wx3/a
# NM/Qd3PFRvz151hKK53yNrPnYtOmNHGFbxq/KtXgMU7baCvvfw6ghdTbQXX3eGaY
# +y4+b80xO9Asbto2FYnfySETT77O5+sXNwYSwmEKaCA2nftRj6shP6HUkGfsYcL5
# y98LaoidotXZYuy6hbtdkw7MUgf7P7zdzYTnVl/OlHk/3VkJrwChJEPKhoE7UKwf
# kPTjRtZyBCMwUxpna6YLF2h/RvTsUZTi9SZHsj0+9sf58MF+jMNAlOqCrg==
