...
$ImportPlanTemplate = 'ImportPlanTemplate-OD.csv'
...
try{
	...
	foreach($connection in $connections)
	{
		...
		foreach($csv in $Csvs)
		{
			...
			{
				$Source = New-BoxObject -Level Folder -Path $mapping."Source Url"

				$Destination = New-BoxMigrationSharePointObject -Level $mapping."Dest Level" -Url $mapping."Dest Url"

				$MappingContent = New-BoxMappingContentObject -Source $Source -Destination $Destination -Method $mapping."Mapping Method"

				$mappingList += $MappingContent
			}
		   
			$Mappings = New-BoxPlanMappingObject -Contents $mappingList -SourceConnectionId $connection."Source Connection" -DestinationConnectionId $connection."Destination Connection" -DestinationType $DestinationType
			...
			$PlanSettings = New-BoxPlanSettingsObject -DatabaseId $Database -PolicyId $Policy -DisplayName $PlanNameLabel -Schedule $Schedule -PlanGroups $PlanGroups  -MigrateVersions:$MigrateVersions -MigrateLastVersion $MigrateLastVersion
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBmjkxDMZP0689q
# HmP6ZqOCeLlU8Edw4jiO3KvzL0YBFaCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCC3atoriDVg+Jq5LrCb/BbyT+kUzAVfHUNjVAM3p2Q/7jANBgkq
# hkiG9w0BAQEFAASCAYCaso4sdIr66HKhmjVFcmyxU/c/R644N550rruot1JJi2l4
# XzXNsVkrNik/vk2ZWX4FHeXIhC341CDLkAJw0NQCA1/8/s3JgRHvjYQ/s61Y2bZB
# a7TadaLu7UWLkNmyoZbxeYpfLVPQ1vdo3FYDPLuAu9kWHtXSk8nHE6vikwSuerNd
# /pUrsOuOvnAWvpIv2DLF7JPoQ2lgD/xL5JTXUCcANxSQCocSiU3OvAYHWs62qIq+
# loI/lLVNxUVqp5Hx4e/CzaKeLWKXrPQNMWKgssUdKonIPxdPNvCFDf+uW3WOHTrG
# kbI4TEfP75sTPPVjZCq862Wm1mLo3EmcjMggFTR3Iw1whcVpQFL5jMezKUD+gHbE
# 66/blbUHa6yoBIHo+fov1DkkFQ7nPIOSF8L+Z8AONydEhGfxE8O210IcRO9pvI09
# 2uFBHwDktYPVjBbGnCRXZ8P8QXZyyrdfhiS7GeJPvnVjzV3wj07158OIuX4MMgHT
# vFlbKss/TEEKhIAT9M+hghcpMIIXJQYKKwYBBAGCNwMDATGCFxUwghcRBgkqhkiG
# 9w0BBwKgghcCMIIW/gIBAzEPMA0GCWCGSAFlAwQCAQUAMGcGCyqGSIb3DQEJEAEE
# oFgEVjBUAgEBBglghkgBhv1sBwEwITAJBgUrDgMCGgUABBThy38vrz/drUrAA8rM
# nWO4e5PQeQIQCzat9as3JLYtNArARTlRbhgPMjAyNDEyMDQwNDM3NTBaoIITAzCC
...
# EAEEMBwGCSqGSIb3DQEJBTEPFw0yNDEyMDQwNDM3NTBaMCsGCyqGSIb3DQEJEAIM
# MRwwGjAYMBYEFNvThe5i29I+e+T2cUhQhyTVhltFMC8GCSqGSIb3DQEJBDEiBCCG
# t0iuHgU+nLhzxLtTKNdk3NrBKmNb3lcd7wfNbOFNSDA3BgsqhkiG9w0BCRACLzEo
# MCYwJDAiBCB2dp+o8mMvH0MLOiMwrtZWdf7Xc9sF1mW5BZOYQ4+a2zANBgkqhkiG
# 9w0BAQEFAASCAgBuUhCYCT+Rq+2ya6HOzolnHyr5GLnFDBoiOGmpwWRfHSzLTL8p
# kzJbLs7Bdi9N11R42jxllyVjwUEkmzJpu3kgPTazmzAL9w3bWm7iODmyWF52+dDI
# vgm7UU0OZYbifCOaiLfl300wDFgeL+UAsajtGfURhtdlMv/FQV3161fHJw3luYBq
# gcg5c1z74vPh81p+O58hEprd4VvYffxQb6Dulj7mzsQRYWvevT8oF0twJI43+Hmx
# cZkChq8flmRbZZUqOdiY+iephEswPttf+gpn5dd5Z8wllb95L7ZIM8xKh14qqu0e
# sSl+TxEn8mW6TsiVepFL3lpjdgG12p5pTanYZCXkj6VoDb0y6DVGNW3eLI25bcYA
# +6ETDKKESo92sYDVmCenaNGU3uJlIqhT1PABXSIIQnBKqYp0lTu+6CYOZ67HV//l
# Jk1+MgyHMfK2wKhbSS2vDcD4YhIYCwMmNu8letizORI77xMQGSf/c3lyH/D/FkEB
# ASw/k+Y1TuaVQJnJrm5ie3ABmifXwhhuSWZgcPBYBj/eYcV6usEwyZCDxxsgHM4x
# IrPcytzZAOaJIoX5DjdfcTsKQaJleZT9eMBDHAVZd/iKieb7bWnZgkJSoT1Qq0H6
# H+SB49qFAp9BaO7XOwiam/eLhUfREsuSiFk6wqyuJOYfnxd+voSa2TzKjg==
