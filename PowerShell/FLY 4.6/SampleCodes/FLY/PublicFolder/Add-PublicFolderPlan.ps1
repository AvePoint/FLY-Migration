...
$SourceConnection = '< connection name or id>'
$DestConnection ='<connection name or id >'


$SourceConnOption = New-PublicFolderConnectionOptionObject -ConnectionId $SourceConnection

$SourceConn = New-PublicFolderConnectionObject -ConnectionOption $SourceConnOption

$DestinationConnOption = New-PublicFolderConnectionOptionObject -ConnectionId $DestConnection

$DestinationConn = New-PublicFolderConnectionObject -ConnectionOption $DestinationConnOption

$Source = New-PublicFolderObject -PublicFolder 'Source Public Folder Name\Sub Folder Name' 

$Destination = New-PublicFolderObject -PublicFolder 'Destination Public Folder Name\Sub Folder Name' 

$MappingContent = New-PublicFolderMappingContentObject -Source $Source -Destination $Destination 

$Mappings = New-PublicFolderMappingObject -Source $SourceConn -Destination $DestinationConn -Contents @($MappingContent)

$PlanNameLabel = New-PlanNameLabelObject -BusinessUnit '<business unit name>' -Wave '<wave name>' -Name '<name>'

$Policy = '<Policy id or name>'

$Database='<migration database id or name>'
...
$PlanSettings = New-PublicFoldersSettingsObject -NameLabel $PlanNameLabel -PolicyId $Policy -DatabaseId $Database   -SynchronizeDeletion  -MigrateMailboxPermissions -Schedule $Schedule -PlanGroups $PlanGroups
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUP+AWaMhLyfKplebqbelI6zuf
# keegghL+MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUGcGHYTOrAxtf5Iceh4N5
# ubOonpUwDQYJKoZIhvcNAQEBBQAEggEAhIBPvvs1U+BEpjKry/8iRA/8rGeFMJRk
# mFu+Nfx3tlv+P4tiIoaJMd+6MJl1G081KjaNdNAHM8IruV0c778ZviISTZKV6LnH
# z6Qx1pINZav46az6NyzOnR30IDnmG1S3DC/MUVC3/NdaJMM6tCpMJXae0lVEsm9B
# XcUcU8gbJFbBu/mYmTJX3vUNeJRc9aVa5lhvWXrBRw4uYzfkEDEOLArtG3nuAB3o
# QUz4fH/ScfIEbrjNAKgF27Lig0hBI5IAtWzwZCIYXmcU/D3NUybDta/JMGv7u41d
# zZ3FhQo9fsNDpVq90ox51Pk8DyqPBY9gN4F8X4yvDnY5ifcYQXQE6aGCAgswggIH
...
# Fw0yMDEyMDkwNjU0NTJaMCMGCSqGSIb3DQEJBDEWBBQOMEnPk6OphZQtJX5ECk69
# rV95VDANBgkqhkiG9w0BAQEFAASCAQA/7Eh3lqnshKX8oJ4UyHOp1wgqDeRIwXma
# Qwf8Lb5o2XWLM2meuKk/r8kP3sdgb65JPnFB4zqXO24g8KeD01qptC35K5ykw8sQ
# QXTaeahLTQN2pHjN5IkQcPpbRoJj/UMdvHRVn9NQtjHng4uxz5/n1ZfxatOKO5ku
# t2NOfjI2uO9fFi4Lev8urtCgCZ9Gog+ZeSaF64ZGeDl6ELsnXHvWU80vVbFo3gyJ
# Ue8yYvmNnqu5YmS8Mzttj9at5XEVR2TD3vmSjqzUYfBaV1b4tbzaFBGtCQU/lhQS
# 0r019N89qRSsaWKsgE6WJ4H2Nqbvm2+9VN2R7cd0P4ZeBn2dSP0Q
