...
foreach($connection in $connctions)
{
    ...
    foreach($csv in $Csvs)
    {
        ...
        $mappings = New-PublicFolderMappingObject -Source $sourceConnectionObject -Destination $destConnectionObject -Contents $mappngList
        ...
        $PlanSettings = New-PublicFoldersSettingsObject -NameLabel $PlanNameLabel -PolicyId $Policy -DatabaseId $Database -Schedule $Schedule -PlanGroups $PlanGroups  -SynchronizeDeletion  -MigrateMailboxPermissions 
        ...
        Catch
           {
            $Error[1].Exception.Response.Content
           }
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUQGmUNpxuE2ME6m2laMqxHjMi
# tbugghL+MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUB4BKMaIVFrspjFGZx9dL
# cmuVXnAwDQYJKoZIhvcNAQEBBQAEggEAr0/SC/laEgUIQ64QqHIV2Dg33Fmhkk8s
# aDBwIBojIO362m9mVl5jPYoVMMa/rtyqmFTM/WWxXAZlayv0kuOp4at5gNjqlxOT
# fa/Mi6KTJWH459bfc5TNghduyYDT9rIS9Y6Iiik/6mVaQlYi535yijDmm81NnRCT
# 2ehLHjLbqmJHow9yH3zJpdHrupGopZmahnef+9G/SFuhXix7pH2zqOXs3iWw3v1E
# verMaoH1u7nYeQ6Awun0b9D3HCPRT6u3yHB/iElNKdzu1e2hzFyWnkxtAIFWns8W
# B+rfTkFT4XrYPJCcM38uKRBVvuj3Gt4eHKq73iGfVquEEMt9vPupQaGCAgswggIH
...
# Fw0yMDEyMDkwNjU0NTJaMCMGCSqGSIb3DQEJBDEWBBSVCJi5fw5Yc8lOEi4F7HlP
# zmT5cDANBgkqhkiG9w0BAQEFAASCAQAtK0/wZmzQieOT2lNk1DNmKgretNw4qN1t
# 1LYzma49nlxpGsDk+h3Wyxx6nOJf8XCCimLamEIfm+kU946sDH6mVGkHFxEr/Pzh
# ZuAdm1cL5086t5k7mfPAPXDjlk7Y7m3NHwbe7o4KAkikhIKa/SnF1WnzkI8wEfr6
# dedxr83hh9JAXa8Qw64Yoh3tiluFSoxZVDAWGvGhU8bMdEpLzck4ptkXiJFgVi3M
# iADFGdPKIAcvZ//uYcKmVkVLHnwtGgwG37x5hLcXQ1Zb6YQqOcJ1LB/a7ZSxpvRD
# +pU+aL+CpKclC0tjUVLHzEtEoSNur0pWMn3jGqsLwgVeZ2n910Y+
