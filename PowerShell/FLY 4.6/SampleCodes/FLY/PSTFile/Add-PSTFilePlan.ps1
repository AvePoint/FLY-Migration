...
# $DestinationConnOption = New-ExchangeOnPremisesConnectionOptionObject -ConnectionId '<exchange migration connection id or name>'
...
# $Credential =  New-BasicCredentialObject -Username '<service account >' -Password 'service password' 
# $VersionOption = New-ExchangeServerOptionObject -Version Exchange2010 -Host '<exchange server host>'
...
$DestinationConnOption = New-ExchangeOnlineConnectionOptionObject -ConnectionId '<exchange migration connection id or name>'
...
$Mappings = New-PSTFileMappingObject -PstFileConnection $SourceConnection  -Destination $DestinationConn -Contents @($MappingObject)
...
$PlanSettings = New-PSTFilePlanSettingObject -NameLabel $PlanNameLabel -PolicyId '<migration policy id or name>' -DatabaseId '<migration database id or name>' -Schedule $Schedule
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUYHazSA84stnzlAXxJMB/zAm1
# 2mCgghL+MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUToRdULiOdSVb6YVXGOT8
# nCPVpH4wDQYJKoZIhvcNAQEBBQAEggEABpSqsP/l/IIWEyVt/nHpXP0GECunq4Uw
# MnQAGfO/hk2ZYJ8/Sz6X2GEkWTcGdKvgc1m5MR3krtoKClV5TuPYEx7Q9rcDcAWD
# b/zAeaEc2HtMUdMF49KGJeFFICWaEXUiGUTlsL3c8VlINPUmdTLwHI6YHjJW4DNy
# NkI8UedKtN5o7xmmF72WADsmAL/H+7uNz7cnZhVX7RG7mpb/NE0UlLqYmR1EXP9i
# 3ALTUqcpem3tQC7L/qRxPGzG5sU5OsSnsWuoTwhnklHkldxWKmm+pzi672mq6xXl
# JptAAnNWyWrHVyqOK3mBbEKmH4t2eTITyIiC+cOGACNzGfMKJuc48aGCAgswggIH
...
# Fw0yMDEyMDkwNjU0NTFaMCMGCSqGSIb3DQEJBDEWBBRXe26z2RasjaGQuAj89a1d
# JaIbHDANBgkqhkiG9w0BAQEFAASCAQCRgp6c5yaruiM5Ar+7GpIN8ykajqZDEbFU
# n5o9FyRpCu3KHRGyEEl6nxEQMDrWKjcZm5wXVWKNeG9tXxdvgdK1U3jP/oqw4IFQ
# 556PqSCbkLGABLw9hjg2yEpdoXtPH61Zw5DvcyUIorQtZVjzR90WmJw0xFNOzpqL
# gfJ4s1uxazHdebmaWFlyN0zYnW37MALh6ii8ZdYLq1n+pBAB6qdzUcqzXy0xRBE2
# hj9DQDim4WysxvJcItBd7q8QWZZ2uvmqv18J2J2JMI+6305XVlIm5CtYTWzt+1DU
# gw42Esb/hy9hNJ9qS7NpmQKbRVpw0rlnQAfQedip/vY0KMLtEGoI
