...
$SiteCollectionUrls = Import-Csv "$($directoryPath)\\SiteCollectionUrls.csv" -Encoding UTF8
...
foreach($SiteCollection in $SiteCollectionUrls)
{   
    try
    {
       $premissionInfo=Grant-PnPAzureADAppSitePermission -AppId $appId -DisplayName $appName -Site $SiteCollection.Url -Permissions Read -Verbose -Connection $connection
       $premissionInfo.Id
       Set-PnPAzureADAppSitePermission -Site $SiteCollection.Url -Permissions FullControl -PermissionId $premissionInfo.Id -Connection $connection
       $($SiteCollection.Url) + ",Successful" | Out-File -FilePath $csvPath -Encoding utf8 -Append -Force
       Write-LogDebug -LogPath $logPath -Message "Add full control successful. site collection: $($SiteCollection.Url)" -ToScreen  
    }
    catch
    {   
        $($SiteCollection.Url) + ",Failed" +","+ $($_.ToString()) | Out-File -FilePath $csvPath -Encoding utf8 -Append -Force    
        Write-LogError -LogPath $logPath -Message "Failed to add Full control $($SiteCollection.Url). Message: $($_.ToString())" -ToScreen       
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDAMZb7Ztqc9puR
# j/Xuod6JBaTXPftJxfbcrEkfRaOWNKCCDZowggawMIIEmKADAgECAhAIrUCyYNKc
...
# SIb3DQEJBDEiBCBnjK4TLPR0Qpk0SnwYAUeRRUKHEETwHKkMysK4JIDcTTANBgkq
# hkiG9w0BAQEFAASCAYBwBxgVzzFm2Kxzx+8I22q3FCg1BnMQZ1X82IIc6W82FKHm
# NLeidc9UG3UkXP09O3DKQajQHbbquCQWY7evKAeJSrWDfqoFL3gzqKRSohvV+DZz
# JSEpCIJo951QRT+yTqnhEq0kXAMxfGy3yVvGvCV55UGFqlMBdmTsS7UH3KXiaj7L
# JOdDUc2zgsiFd7XJhk+KObWjsRQQci2IBIRbDiuaIIp6d0CYEMkJVsDKihH1k1x4
# nWppgaCybS8l2HFgvee7RPtt8Ua8u2T4sVP6VcDry6aq5jCJTVNcCkanOBF4FLgB
# 6Lyeghdf9wJqqL+CKibMp1y+p2oEdi/OEW/HJIjNZ/9zDxCarxWHWxulA2GefI7Q
# ZfRDPMk7LxanS9o6LCkR/uw2CrNZobduREw02maC/7eXAKfqCxkz+WjqQlDgAcli
# kz/fUpYhdwjnRWNev9nZQdFpzTLuChP3sQXMstUNuQvpW9qCSRaIUJCgITuGXCjX
# 8QIZPDAN4k02NV62kqWhghd2MIIXcgYKKwYBBAGCNwMDATGCF2IwghdeBgkqhkiG
# 9w0BBwKgghdPMIIXSwIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEE
# oGgEZjBkAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgwn3RDXmiu818
# Ei9G+JsDQuOYDbwTfSUzaM8tRkgZEGoCEEo58dTZ6ecyf+vDvLBoOUQYDzIwMjUw
# NjEzMDkwMTM3WqCCEzowggbtMIIE1aADAgECAhAKgO8YS43xBYLRxHanlXRoMA0G
# CSqGSIb3DQEBCwUAMGkxCzAJBgNVBAYTAlVTMRcwFQYDVQQKEw5EaWdpQ2VydCwg
...
# DTI1MDYxMzA5MDEzN1owKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQU3WIwrIYKLTBr
# 2jixaHlSMAf7QX4wLwYJKoZIhvcNAQkEMSIEIKY9OI+27QpuORHkmvZWUJLsdfST
# Afk4u2uw5P06ZhUlMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIEqgP6Is11yExVyT
# j4KOZ2ucrsqzP+NtJpqjNPFGEQozMA0GCSqGSIb3DQEBAQUABIICAKdMX4d2OhKJ
# Ft3eKGzdCqtjWT3MDBgJ4Imbz5OH+39uMiFwNGSLJowjuQY+nYK+5fWNbycoU+O/
# UtSdgDWDmJVqAYPFVwHdXbP4FSOvS1YkSy5m08VLSUc1idApCBtIBddpQ8RAIviv
# WhAq5FUtAI4vH1EP5LLDdkyucqDd/vP6/BLrLLTNQ8RwYPnzn8zhM4WnvqGyJfvq
# wd+rsP5SNOh5O+/wezo5Vn76fXeEUKJAqR/pc4VhgioWG7NekKrtRHEuCxb27gSt
# VtQhk3Xs3U/4HMcc5lDq/7EK6W2WGYNHqLknEaxMl+Kq2bI72XFDAtZ56r1FSJag
# Bw7rmFnN6ePfQZ+CdtzSzF7vF8xiczUvYArgURzS8S0jJdy99nosTGGjoMlOXnHU
# nL4vWTWjQDqRbQpdla5T2PD2cAt4tiVMe9DaCYhd5BgFDaTQESmLtEoK9q3itc2I
# r2seZ+ncE7NhpprmKtNQ+Kwx74KS/JUDs3DggKEKLngtGSg3HVVs9yeltG18EDxl
# qeiNxkeZgHQ8SeEG9xZMSyYOidkfr0aYaRJ9ep3lbRy7NRN31mffqe4tw6sVKcHm
# t6ovc3RV6vX65OgM2FUnHFN0mgjcK+QJtQoKOPcqTlT2IJZ2iRUVXg7pT3Hs97zd
# yiZrx6rA/hNf03fDmVKeX/d8y2sjNhUi
